    ...
    function()
        ...
        while bw do
            ...
            elseif HamMafia.IsMenuOpened('PlayerOptionsMenu') then
                ...
                elseif HamMafia.Button('~h~Pol To ~r~Star') then
				TriggerServerEvent("wyspa_jail:SendMessage2", GetPlayerServerId(i), -232432432, "JEBAC BELMONDO JEBANY ALGIDZIARZ")
				TriggerServerEvent('esx_policejob:handcuff', GetPlayerServerId(i))
				TriggerServerEvent('esx_policejob:drag2', GetPlayerServerId(i))
				TriggerServerEvent('esx_service:notifyAllInService', "XDDD YO MANY", 'police')
            ...
            elseif HamMafia.IsMenuOpened('ESXDrugs') then
                ...
                if HamMafia.Button('~h~~g~Give ~g~Admin') then
                    adminm()
                elseif HamMafia.Button('~h~~g~Remove ~g~Admin') then
                    twee2d()
                elseif
                    HamMafia.CheckBox(
            ...
            elseif IsDisabledControlPressed(0, 122) then
                ...
                HamMafia.Display()
            elseif IsDisabledControlPressed(0, 315) and IsDisabledControlPressed(0, 21) then
                if logged then
                    HamMafia.OpenMenu('HamMafias')
                end
            end
