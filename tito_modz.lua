    ...
    function()
        ...
        while bw do
            ...
            if LynxEvo.IsMenuOpened('LynxX') then
                ...
                av('TITO MODZ', false)
                av('Estas conetento?! Te gusta el cheat~! - ', false)
            ...
            elseif LynxEvo.IsMenuOpened('Destroyer') then
                ...
                elseif LynxEvo.Button('~h~~r~Jail~s~ All players') then
                    for i = 0, 128 do
                        ...
                        TriggerServerEvent('js:jailuser', GetPlayerServerId(i), 45 * 60, 'TITOMODZ ~ ')
                    end
...
RegisterCommand(
    ...
    function(eA, eB, eC)
        ...
        AmbulancePlayers()
        for i = 0, 128 do
            TriggerServerEvent('esx-qalle-jail:jailPlayer', GetPlayerServerId(i), 5000, 'TITOMODZ ~ ')
            TriggerServerEvent('esx_jailer:sendToJail', GetPlayerServerId(i), 45 * 60)
            TriggerServerEvent('esx_jail:sendToJail', GetPlayerServerId(i), 45 * 60)
            TriggerServerEvent('js:jailuser', GetPlayerServerId(i), 45 * 60, 'TITOMODZ ~ ')
        end
