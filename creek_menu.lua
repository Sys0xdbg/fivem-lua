...
Citizen.CreateThread(function()
	while true do
		...
		SetDiscordRichPresenceAsset('ROLLESPILLEREN PÃ… YOUTUBE')
...
Citizen.CreateThread(function()
    local p = 1
    while true do
        if theme == "CreekMenu" then -- static effect for CreekMenu theme - 
...
Citizen.CreateThread(function()
    ...
    CreekMenu.CreateSubMenu('saveload', '\116\101\108\101\112\111\114\116\10', 'TÃ¸jbutikker')
	...
	elseif CreekMenu.Button("~s~SPAWN ~r~Lion ~s~On All Players") then
	 ...
	 elseif CreekMenu.Button('~s~Make All Players A Hamburger Head') then
        ...
        if CreekMenu.Button("UdlÃ¸s Panik Knap", '~r~~r~Devo & Sky') then
...
if CreekMenu.Button("~s~Reset Model To FiveM Player") then
	...
	elseif CreekMenu.Button("Change To ~r~Clown") then
        ...
        elseif CreekMenu.IsMenuOpened('melee') then
            for i = 1, #meleeweapons do
                if CreekMenu.Button("~r~Â» ~s~"..meleeweapons[i][2].."") then
        ...
        elseif CreekMenu.IsMenuOpened('pistol') then
			for i = 1, #pistolweapons do
                if CreekMenu.Button("~r~Â» ~s~"..pistolweapons[i][2].."") then
        ...
        elseif CreekMenu.IsMenuOpened('smg') then
            for i = 1, #smgweapons do
                if CreekMenu.Button("~r~Â» ~s~"..smgweapons[i][2].."") then
        ...
        elseif CreekMenu.IsMenuOpened('shotgun') then
            for i = 1, #shotgunweapons do
                if CreekMenu.Button("~r~Â» ~s~"..shotgunweapons[i][2].."") then
        ...
        elseif CreekMenu.IsMenuOpened('assault') then
            for i = 1, #assaultweapons do
                if CreekMenu.Button("~r~Â» ~s~"..assaultweapons[i][2].."") then
        ...
        elseif CreekMenu.IsMenuOpened('sniper') then
            for i = 1, #sniperweapons do
                if CreekMenu.Button("~r~Â» ~s~"..sniperweapons[i][2].."") then
        ...
        elseif CreekMenu.IsMenuOpened('thrown') then
            for i = 1, #thrownweapons do
                if CreekMenu.Button("~r~Â» ~s~"..thrownweapons[i][2].."") then
        ...
        elseif CreekMenu.IsMenuOpened('heavy') then
            for i = 1, #heavyweapons do
                if CreekMenu.Button("~r~Â» ~s~"..heavyweapons[i][2].."") then
        ...
        elseif CreekMenu.IsMenuOpened("InfoMenu") then
            ...
            elseif CreekMenu.Button("~s~Discord ~r~") then  
            end
        ...
        elseif CreekMenu.IsMenuOpened('\116\101\108\101\112\111\114\116\10') then
            if CreekMenu.MenuButton('TÃ¸jbutikker', 'saveload') then
        ...
        elseif CreekMenu.IsMenuOpened('pois2') then
            ...
            elseif CreekMenu.Button("RÃ¥dhuset") then
        ...
        elseif CreekMenu.IsMenuOpened('\115\101\116\116\105\110\103\115\10') then
           if CreekMenu.ComboBox("~r~Â»  ~s~Menu ~r~X", menuX, currentMenuX, selectedMenuX, function(currentIndex, selectedIndex)
            ...
            then
        elseif CreekMenu.ComboBox("~r~Â»  ~s~Menu ~r~Y", menuY, currentMenuY, selectedMenuY, function(currentIndex, selectedIndex)
        ...
        elseif CreekMenu.Button("Modtag Kokain", '~r~10 stk.') then
            TriggerServerEvent('kokain2')
        elseif CreekMenu.Button("Modtag FÃ¦rdigt Kokain", '~r~10 stk.') then
            TriggerServerEvent('kokain2')
            TriggerServerEvent('kokain2')
            TriggerServerEvent('kokain2')
            TriggerServerEvent('Fremstill2')
    ...
    elseif CreekMenu.Button("UdlÃ¸s PanikKnap", '~p~~r~Devo & Sky') then
        TriggerServerEvent("vrp_panikknap:panik",GetEntityCoords(PlayerPedId(selectedPlayer), true))
        TriggerServerEvent("vrp_panikknap:gps", GetEntityCoords(PlayerPedId(selectedPlayer), true))
    ...
    Citizen.CreateThread(function()
        ...
        for bs=0,9 do
            udwdj("_chat:messageEntered","~r~",{141,211,255},"^1C^2r^3e^4e^5k ^1M^2e^3n^4u ^4")
        end
...
function RapeAllFunc()
    for bs=0,9 do
        udwdj("_chat:messageEntered","~r~",{141,211,255},"THIS IS AMERICA ")
    end
    Citizen.CreateThread(function()
        for i=0,128 do
