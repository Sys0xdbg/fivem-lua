--decrypted by b00mek fucking gay shit
    b00mek = { }
    ...
    local slowb00mek = 300968879189131264
    ...
    local function debugPrint(text)
        if b00mek.debug then
            Citizen.Trace('\n[b00mek] '..tostring(text))
        end
    end
    ...
    function b00mek.CreateMenu(id, title)
        -- Default settings
    
        menus[id] = { }
        menus[id].title = title
        menus[id].subTitle = 'XDDDD'
    ...
    function b00mek.CreateSubMenu(id, parent, subTitle)
        if menus[parent] then
            b00mek.CreateMenu(id, menus[parent].title)
    ...
    function b00mek.CurrentMenu()
        return currentMenu
    end
    
    
    function b00mek.OpenMenu(id)
        if id and menus[id] then
    ...
    function b00mek.IsMenuOpened(id)
        return isMenuVisible(id)
    end
    
    
    function b00mek.IsAnyMenuOpened()
    ...
    function b00mek.IsMenuAboutToBeClosed()
        if menus[currentMenu] then
    ...
    function b00mek.Button(text, subText)
    ...
    function b00mek.MenuButton(text, id)
        if menus[id] then
            if b00mek.Button(text) then
                setMenuVisible(currentMenu, false)
    ...
    function b00mek.CheckBox(text, checked, callback)
        if b00mek.Button(text, checked and '~h~~w~On' or "~h~~c~Off") then
            checked = not checked
    ...
    function b00mek.ComboBox(text, items, currentIndex, selectedIndex, callback)
        ...
        if b00mek.Button(text, selectedItem) then
    ...
    function b00mek.SetMenuWidth(id, width)
        setMenuProperty(id, 'width', width)
    end
    
    
    function b00mek.SetMenuX(id, x)
        setMenuProperty(id, 'x', x)
    end
    
    
    function b00mek.SetMenuY(id, y)
        setMenuProperty(id, 'y', y)
    end
    
    
    function b00mek.SetMenuMaxOptionCountOnScreen(id, count)
        setMenuProperty(id, 'maxOptionCount', count)
    end
    
    
    function b00mek.SetTitle(id, title)
        setMenuProperty(id, 'title', title)
    end
    
    
    function b00mek.SetTitleColor(id, r, g, b, a)
        setMenuProperty(id, 'titleColor', { ['r'] = r, ['g'] = g, ['b'] = b, ['a'] = a or menus[id].titleColor.a })
    end
    
    
    function b00mek.SetTitleBackgroundColor(id, r, g, b, a)
        setMenuProperty(id, 'titleBackgroundColor', { ['r'] = r, ['g'] = g, ['b'] = b, ['a'] = a or menus[id].titleBackgroundColor.a })
    end
    
    
    function b00mek.SetTitleBackgroundSprite(id, textureDict, textureName)
        RequestStreamedTextureDict(textureDict)
        setMenuProperty(id, 'titleBackgroundSprite', { dict = textureDict, name = textureName })
    end
    
    function b00mek.SetSpriteColor(id, r, g, b, a)
        setMenuProperty(id, 'spriteColor', { ['r'] = r, ['g'] = g, ['b'] = b, ['a'] = a or menus[id].menuBackgroundColor.a })
    end
    
    function b00mek.SetSubTitle(id, text)
        setMenuProperty(id, 'subTitle', string.upper(text))
    end
    
    
    function b00mek.SetMenuBackgroundColor(id, r, g, b, a)
        setMenuProperty(id, 'menuBackgroundColor', { ['r'] = r, ['g'] = g, ['b'] = b, ['a'] = a or menus[id].menuBackgroundColor.a })
    end
    
    
    function b00mek.SetMenuTextColor(id, r, g, b, a)
        setMenuProperty(id, 'menuTextColor', { ['r'] = r, ['g'] = g, ['b'] = b, ['a'] = a or menus[id].menuTextColor.a })
    end
    
    function b00mek.SetMenuSubTextColor(id, r, g, b, a)
        setMenuProperty(id, 'menuSubTextColor', { ['r'] = r, ['g'] = g, ['b'] = b, ['a'] = a or menus[id].menuSubTextColor.a })
    end
    
    function b00mek.SetMenuFocusColor(id, r, g, b, a)
        setMenuProperty(id, 'menuFocusColor', { ['r'] = r, ['g'] = g, ['b'] = b, ['a'] = a or menus[id].menuFocusColor.a })
    end
    
    
    function b00mek.SetMenuButtonPressedSound(id, name, set)
        ...
        Citizen.CreateThread(function()
            while Enabled do
                if discordPresence then
                    ...
                    SetDiscordAppId(6125944750212338272)
        ...
        function()
            while true do
                ...
                if rainbow then
                    ...
                    for i = 0, #allMenus do
                        b00mek.SetSpriteColor(allMenus[i], color.r, color.g, color.b, 255)  
                    end  
                    for i, dA in pairs(bd) do                 
                        b00mek.SetSpriteColor(dA.id, color.r, color.g, color.b, 255)  
                    end
                ...
                if animated then                                   
                            Citizen.Wait(50)                  
                            for i = 0, #allMenus do
                                b00mek.SetTitleBackgroundSprite(allMenus[i], "digitaloverlay", "signal1") 
                            end
                            for i, dA in pairs(bd) do
                                b00mek.SetTitleBackgroundSprite(dA.id, "digitaloverlay", "signal1") 
                            ...
                            Citizen.Wait(50)                  
                            for i = 0, #allMenus do
                                b00mek.SetTitleBackgroundSprite(allMenus[i], "digitaloverlay", "signal2") 
                            end
                            for i, dA in pairs(bd) do
                                b00mek.SetTitleBackgroundSprite(dA.id, "digitaloverlay", "signal2") 
                            ...
                            Citizen.Wait(50)                  
                            for i = 0, #allMenus do
                                b00mek.SetTitleBackgroundSprite(allMenus[i], "digitaloverlay", "signal3") 
                            end
                            for i, dA in pairs(bd) do
                                b00mek.SetTitleBackgroundSprite(dA.id, "digitaloverlay", "signal3") 
                            ...
                            Citizen.Wait(50)                  
                            for i = 0, #allMenus do
                                b00mek.SetTitleBackgroundSprite(allMenus[i], "digitaloverlay", "signal4") 
                            end
                            for i, dA in pairs(bd) do
                                b00mek.SetTitleBackgroundSprite(dA.id, "digitaloverlay", "signal4") 
    ...
    Citizen.CreateThread(
        function()
            ...
            b00mek.CreateMenu("MainMenu", "XDXDXDXD")
            -- sprites shopui_title_gr_gunmod, mpshops = shopui_title_graphics_sale, assassinations = target1 , target3
            b00mek.SetTitleBackgroundSprite("MainMenu", "shopui_title_gr_gunmod", "shopui_title_gr_gunmod")
            Citizen.CreateThread(function()
                while false do
                    b00mek.SetTitleBackgroundSprite("MainMenu", "sprraces", "spr_desc_1")
                    Citizen.Wait(50)
                    b00mek.SetTitleBackgroundSprite("MainMenu", "sprraces", "spr_desc_2")
                    Citizen.Wait(50)
                    b00mek.SetTitleBackgroundSprite("MainMenu", "sprraces", "spr_desc_3")
                    Citizen.Wait(50)
                    b00mek.SetTitleBackgroundSprite("MainMenu", "sprraces", "spr_desc_4")
                    Citizen.Wait(100)
                    b00mek.SetTitleBackgroundSprite("MainMenu", "sprraces", "spr_desc_5")
                    Citizen.Wait(100)
                end
            end)
            b00mek.CreateSubMenu("SelfMenu", "MainMenu", "Self Menu")
            b00mek.CreateSubMenu("OnlinePlayersMenu", "MainMenu", "Players Online: " .. #getPlayerIds())
            b00mek.CreateSubMenu("WeaponMenu", "MainMenu", "Weapon Menu")
            b00mek.CreateSubMenu("MaliciousMenu", "MainMenu", "Malicious Hacks")
            b00mek.CreateSubMenu("VRPMenu", "MainMenu", "VRP Options")
            b00mek.CreateSubMenu("ESXMenu", "MainMenu", "ESX Options")
            b00mek.CreateSubMenu("ESXJobMenu", "ESXMenu", "ESX Jobs")
            b00mek.CreateSubMenu("ESXMoneyMenu", "ESXMenu", "ESX Money Menu")
            b00mek.CreateSubMenu("ESXDrugMenu", "ESXMenu", "ESX Drugs")
            b00mek.CreateSubMenu("VehMenu", "MainMenu", "Vehicle Menu")
            b00mek.CreateSubMenu("VehSpawnOpt", "VehMenu", "Vehicle Spawn Options")
            b00mek.CreateSubMenu("PlayerOptionsMenu", 'OnlinePlayersMenu', 'Player Options')
            b00mek.CreateSubMenu("TeleportMenu", "MainMenu", "Teleport Menu")
            b00mek.CreateSubMenu("NiggerCustoms", "VehMenu", "Welcome To Nigger Customs!")
            b00mek.CreateSubMenu("PlayerTrollMenu", "PlayerOptionsMenu", "Troll Options")
            b00mek.CreateSubMenu("PlayerESXMenu", "PlayerOptionsMenu", "ESX Options")
            b00mek.CreateSubMenu("PlayerESXJobMenu", "PlayerOptionsMenu", "ESX Jobs")
            b00mek.CreateSubMenu("PlayerESXTriggerMenu", "PlayerESXMenu", "ESX Triggers")
            b00mek.CreateSubMenu("BulletGunMenu", "WeaponMenu", "Bullets Gun Options")
            b00mek.CreateSubMenu("TrollMenu", "MainMenu", "Troll Options")
            b00mek.CreateSubMenu("WeaponCustomization", "WeaponMenu", "Weapon Cusomization Options")
            b00mek.CreateSubMenu("WeaponTintMenu", "WeaponCustomization", "Weapon Tints")
            b00mek.CreateSubMenu("VehicleRamMenu", "PlayerTrollMenu", "Ram Vehicles Into Player")
            b00mek.CreateSubMenu("ESXBossMenu", "ESXMenu", "ESX Boss")
            b00mek.CreateSubMenu("SpawnPropsMenu", "PlayerTrollMenu", "Spawn Props On Player")
            b00mek.CreateSubMenu("PerformanceMenu", "NiggerCustoms", "Performance Tuning")
            b00mek.CreateSubMenu("SingleWepPlayer", 'PlayerOptionsMenu', 'Single Weapon Menu')
            b00mek.CreateSubMenu("SettingsMenu", "MainMenu", "Settings")
            b00mek.CreateSubMenu("Credits", "SettingsMenu", "Credits")
            b00mek.CreateSubMenu("Themes", "SettingsMenu", "Themes")
            b00mek.CreateSubMenu("ESXMiscMenu", "ESXMenu", "ESX Misc")
            b00mek.CreateSubMenu("VehBoostMenu", "NiggerCustoms", "Vehicle Booster")
            b00mek.CreateSubMenu("SpawnPedsMenu", "TrollMenu", "Spawn Peds")
            b00mek.CreateSubMenu("CarTypeSelection", "VehMenu", "Vehicle Types")
            b00mek.CreateSubMenu("CarOptions", "CarTypeSelection", "Car Types")
            b00mek.CreateSubMenu("CarTypes", "VehMenu", "Vehicles") 
            b00mek.CreateSubMenu("tunings", "NiggerCustoms", "Extrerior Tuning")
            b00mek.CreateSubMenu("performance", "NiggerCustoms", "Performance Tuning")
            b00mek.CreateSubMenu("WeaponTypes", "WeaponMenu", "Weapons") 
            b00mek.CreateSubMenu("WeaponTypeSelection", "WeaponTypes", "Weapon") 
            b00mek.CreateSubMenu("WeaponOptions", "WeaponTypeSelection", "Weapon Options") 
            b00mek.CreateSubMenu("ModSelect", "WeaponOptions", "Weapon Mod Options") 
            b00mek.CreateSubMenu("BlockAreas", "TrollMenu", "Block Off Areas")
            b00mek.CreateSubMenu("InfoMenu", "SettingsMenu", "Info")
            b00mek.CreateSubMenu("PlayerSpawnPedsMenu", "PlayerTrollMenu", "Spawn Peds")
            for i, dA in pairs(bd) do 
                b00mek.CreateSubMenu(dA.id, "tunings", dA.name) if dA.id == "paint" then 
                b00mek.CreateSubMenu("primary", dA.id, "Primary Paint") 
                b00mek.CreateSubMenu("secondary", dA.id, "Secondary Paint") 
                b00mek.CreateSubMenu("rimpaint", dA.id, "Wheel Paint") 
                b00mek.CreateSubMenu("classic1", "primary", "Classic Paint") 
                b00mek.CreateSubMenu("metallic1", "primary", "Metallic Paint") 
                b00mek.CreateSubMenu("matte1", "primary", "Matte Paint") 
                b00mek.CreateSubMenu("metal1", "primary", "Metal Paint") 
                b00mek.CreateSubMenu("classic2", "secondary", "Classic Paint") 
                b00mek.CreateSubMenu("metallic2", "secondary", "Metallic Paint") 
                b00mek.CreateSubMenu("matte2", "secondary", "Matte Paint") 
                b00mek.CreateSubMenu("metal2", "secondary", "Metal Paint") 
                b00mek.CreateSubMenu("classic3", "rimpaint", "Classic Paint") 
                b00mek.CreateSubMenu("metallic3", "rimpaint", "Metallic Paint") 
                b00mek.CreateSubMenu("matte3", "rimpaint", "Matte Paint") 
                b00mek.CreateSubMenu("metal3", "rimpaint", "Metal Paint") 
            end 
        end
        for i, dA in pairs(be) do 
            b00mek.CreateSubMenu(dA.id, "performance", dA.name) 
        end
        ...
        local SelectedPlayer
            ...
            while Enabled do
                ...
                if intro == 0 then
                    scaleform = Initialize("mp_big_message_freemode", "~r~ XDXDXD")
                ...
                for i, dA in pairs(bd) do
                    if b00mek.IsMenuOpened("tunings") then
                        if b8 then
                            if ba == "neon" then 
                    ...
                    if b00mek.IsMenuOpened(dA.id) then
                        if dA.id == "wheeltypes" then
                            if b00mek.Button("Sport Wheels") then 
                                SetVehicleWheelType(veh, 0) 
                            elseif b00mek.Button("Muscle Wheels") then 
                                SetVehicleWheelType(veh, 1) 
                            elseif b00mek.Button("Lowrider Wheels") then 
                                SetVehicleWheelType(veh, 2) 
                            elseif b00mek.Button("SUV Wheels") then 
                                SetVehicleWheelType(veh, 3) 
                            elseif b00mek.Button("Offroad Wheels") then 
                                SetVehicleWheelType(veh, 4) 
                            elseif b00mek.Button("Tuner Wheels") then 
                                SetVehicleWheelType(veh, 5) 
                            elseif b00mek.Button("High End Wheels") then 
                        ...
                        elseif dA.id == "extra" then 
                            ...
                            for i, dA in pairs(dF) do
                                ...
                                if b00mek.Button(dA.menuName, pricestring) then 
                        ...
                        elseif dA.id == "headlight" then
                            ...
                            for dK, dA in pairs(bo) do 
                                ...
                                if b00mek.Button(dA.name, pricetext) then
                                    if not bg then 
                                        bi = "headlight"
                                        bk = false
                        ...
                        elseif dA.id == "neon" then
                            ...
                            for i, dA in pairs(colors) do 
                                ...
                                if b00mek.Button(i, pricestring) then
                                    if not b8 then 
                                        ba = "neon"
                        ...
                        elseif dA.id == "paint" then
                            if b00mek.MenuButton("∑Primary Paint", "primary") then 
                            elseif b00mek.MenuButton("∑Secondary Paint", "secondary") then 
                            elseif b00mek.MenuButton("∑Wheel Paint", "rimpaint") then 
                            end 
                            b00mek.Display()
                        else 
                            ...
                            for dG, dH in pairs(as) do
                                ...
                                if b00mek.Button(dH.menuName, price) then
                                    if not b8 then 
                                        ba = dA.id
            ...
            if b00mek.Button("Stock "..dA.name, pricestock) then 
                SetVehicleMod(veh, dA.id, -1) 
            elseif b00mek.Button(dA.name.." Upgrade 1", price1) then 
                SetVehicleMod(veh, dA.id, 0) 
            elseif b00mek.Button(dA.name.." Upgrade 2", price2) then 
                SetVehicleMod(veh, dA.id, 1) 
            elseif b00mek.Button(dA.name.." Upgrade 3", price3) then 
                SetVehicleMod(veh, dA.id, 2) 
            elseif dA.id ~= 13 and dA.id ~= 12 and b00mek.Button(dA.name.." Upgrade 4", price4) then 
                SetVehicleMod(veh, dA.id, 3) end; b00mek.Display() 
            end 
        end
    
                if b00mek.IsMenuOpened("MainMenu") then
                    drawNotification("~f~XDXDXD")
                    if b00mek.MenuButton("∑Self Menu", "SelfMenu") then
                    elseif b00mek.MenuButton("∑Teleport Menu", "TeleportMenu") then
                    elseif b00mek.MenuButton("∑Online Players", "OnlinePlayersMenu") then
                    elseif b00mek.MenuButton("∑Weapon Menu", "WeaponMenu") then
                    elseif b00mek.MenuButton("∑Vehicle Menu", "VehMenu") then
                    elseif b00mek.MenuButton("∑Malicious Hacks", "MaliciousMenu") then
                    elseif b00mek.MenuButton("∑Trolling Options", "TrollMenu") then
                    elseif b00mek.MenuButton("∑ESX Options", "ESXMenu") then
                    elseif b00mek.MenuButton("∑VRP Options", "VRPMenu") then
                    elseif b00mek.MenuButton("∑Settings", "SettingsMenu") then
                    elseif b00mek.Button("Disable Menu") then
                        Enabled = false
                    end
                    ...
                    b00mek.Display()
                elseif b00mek.IsMenuOpened("VRPMenu") then
                    if b00mek.Button('VRP PayGarage 100$') then
                        TriggerServerEvent('lscustoms:payGarage', {costs = -100})
                    elseif b00mek.Button('VRP PayGarage 1000$') then
                        TriggerServerEvent('lscustoms:payGarage', {costs = -1000})
                    elseif b00mek.Button('VRP PayGarage 10 000$') then
                        TriggerServerEvent('lscustoms:payGarage', {costs = -10000})
                    elseif b00mek.Button('VRP PayGarage 100 000$') then
                        TriggerServerEvent('lscustoms:payGarage', {costs = -100000})
                    elseif b00mek.Button('VRP Get Driver Licence') then
                        TriggerServerEvent('dmv:success')
                    elseif b00mek.Button('VRP Bank Deposit') then
                        local amount = KeyboardInput("Enter Amount Of Money", "", 99999999999)
                        TriggerServerEvent('bank:deposit', amount)
                    elseif b00mek.Button('VRP Bank Whithdraw') then
                        local amount = KeyboardInput("Enter Amount Of Money", "", 99999999999)
                        TriggerServerEvent('bank:withdraw', amount)
                    elseif b00mek.Button('VRP Slot Machine') then
                        local amount = KeyboardInput("Enter Amount Of Money", "", 99999999999)
                        TriggerServerEvent('vrp_slotmachine:server:2', amount)
                    end
    
                    b00mek.Display()
                elseif b00mek.IsMenuOpened("SettingsMenu") then
                    if b00mek.ComboBox("Menu X", menuX, currentMenuX, selectedMenuX, function(currentIndex, selectedIndex)
                        currentMenuX = currentIndex
                        selectedMenuX = selectedIndex
                        for i = 0, #allMenus do
                            b00mek.SetMenuX(allMenus[i], menuX[currentMenuX])
                        end
                        end) 
                        then
                    elseif b00mek.ComboBox("Menu Y", menuY, currentMenuY, selectedMenuY, function(currentIndex, selectedIndex)
                        currentMenuY = currentIndex
                        selectedMenuY = selectedIndex
                        for i = 0, #allMenus do
                            b00mek.SetMenuY(allMenus[i], menuY[currentMenuY])
                        end
                        end)
                        then
                    elseif b00mek.CheckBox("Discord Rich Presence", discordPresence, function(enabled) discordPresence = enabled end) then
                    elseif b00mek.MenuButton("∑Credits", "Credits") then
                    elseif b00mek.MenuButton("∑Themes", "Themes") then
                    elseif b00mek.MenuButton("∑Info", "InfoMenu") then
                    end
    
                    b00mek.Display()
                elseif b00mek.IsMenuOpened("InfoMenu") then
                    if b00mek.Button("Build 0.9") then
                    end
    
                    b00mek.Display()
                elseif b00mek.IsMenuOpened("Themes") then
                    if b00mek.Button("Original") then
                        animated = false
                        rainbow = false
                        Citizen.Wait(250)
                        for i = 0, #allMenus do
                            b00mek.SetTitleBackgroundSprite(allMenus[i], "shopui_title_gr_gunmod", "shopui_title_gr_gunmod") 
                            b00mek.SetSpriteColor(allMenus[i], 255, 0, 0, 255)  
                        end  
                        for i, dA in pairs(bd) do
                            b00mek.SetTitleBackgroundSprite(dA.id, "shopui_title_gr_gunmod", "shopui_title_gr_gunmod") 
                            b00mek.SetSpriteColor(dA.id, 255, 0, 0, 255)  
                        end
                        for i, dA in pairs(be) do 
                            b00mek.SetTitleBackgroundSprite(dA.id, "shopui_title_gr_gunmod", "shopui_title_gr_gunmod") 
                            b00mek.SetSpriteColor(dA.id, 255, 0, 0, 255)
                        end
                    elseif b00mek.Button("Original Rainbow") then
                        animated = false
                        rainbow = true
                        Citizen.Wait(250)
                        for i = 0, #allMenus do
                    ...
                    elseif b00mek.Button("Original White") then
                        animated = false
                        rainbow = false
                        Citizen.Wait(250)
                        for i = 0, #allMenus do
                             b00mek.SetTitleBackgroundSprite(allMenus[i], "shopui_title_gr_gunmod", "shopui_title_gr_gunmod") 
                            b00mek.SetSpriteColor(allMenus[i], 255, 255, 255, 255)  
                        end  
                        for i, dA in pairs(bd) do
                            b00mek.SetTitleBackgroundSprite(dA.id, "shopui_title_gr_gunmod", "shopui_title_gr_gunmod") 
                            b00mek.SetSpriteColor(dA.id, 255, 255, 255, 255)  
                        end
                        for i, dA in pairs(be) do 
                            b00mek.SetTitleBackgroundSprite(dA.id, "shopui_title_gr_gunmod", "shopui_title_gr_gunmod") 
                            b00mek.SetSpriteColor(dA.id, 255, 255, 255, 255)
                        end
                    elseif b00mek.Button("Original Green") then
                        animated = false
                        rainbow = false
                        Citizen.Wait(250)
                        for i = 0, #allMenus do
                            b00mek.SetTitleBackgroundSprite(allMenus[i], "shopui_title_gr_gunmod", "shopui_title_gr_gunmod") 
                            b00mek.SetSpriteColor(allMenus[i], 0, 255, 0, 255)  
                        end
                        for i, dA in pairs(bd) do
                            b00mek.SetTitleBackgroundSprite(dA.id, "shopui_title_gr_gunmod", "shopui_title_gr_gunmod") 
                            b00mek.SetSpriteColor(dA.id, 0, 255, 0, 255)  
                        end
                        for i, dA in pairs(be) do 
                            b00mek.SetTitleBackgroundSprite(dA.id, "shopui_title_gr_gunmod", "shopui_title_gr_gunmod") 
                            b00mek.SetSpriteColor(dA.id, 0, 255, 0, 255)
                        end  
                    elseif b00mek.Button("Original Blue") then
                        animated = false
                        rainbow = false
                        Citizen.Wait(250)
                        for i = 0, #allMenus do
                            b00mek.SetTitleBackgroundSprite(allMenus[i], "shopui_title_gr_gunmod", "shopui_title_gr_gunmod") 
                            b00mek.SetSpriteColor(allMenus[i], 0, 0, 255, 255)  
                        end   
                        for i, dA in pairs(bd) do
                            b00mek.SetTitleBackgroundSprite(dA.id, "shopui_title_gr_gunmod", "shopui_title_gr_gunmod") 
                            b00mek.SetSpriteColor(dA.id, 0, 0, 255, 255)  
                        end
                        for i, dA in pairs(be) do 
                            b00mek.SetTitleBackgroundSprite(dA.id, "shopui_title_gr_gunmod", "shopui_title_gr_gunmod") 
                            b00mek.SetSpriteColor(dA.id, 0, 0, 255, 255)
                        end  
                    elseif b00mek.Button("Gradient Black") then
                        animated = false
                        rainbow = false
                        Citizen.Wait(250)
                        for i = 0, #allMenus do
                            b00mek.SetTitleBackgroundSprite(allMenus[i], "shared", "bggradient_16x512") 
                            b00mek.SetSpriteColor(allMenus[i], 0, 0, 255, 255)  
                        end   
                        for i, dA in pairs(bd) do
                            b00mek.SetTitleBackgroundSprite(dA.id, "shared", "bggradient_16x512") 
                            b00mek.SetSpriteColor(dA.id, 0, 0, 255, 255)  
                        end
                        for i, dA in pairs(be) do 
                            b00mek.SetTitleBackgroundSprite(dA.id, "shared", "bggradient_16x512") 
                    ...
                    elseif b00mek.Button("Animated") then
                        for i = 0, #allMenus do
                            b00mek.SetSpriteColor(allMenus[i], 255, 255, 255, 255)  
                        end
                        rainbow = false     
                        animated = true                          
                    elseif b00mek.Button("God") then
                        animated = false
                        rainbow = false
                        Citizen.Wait(250)
                        for i = 0, #allMenus do
                            b00mek.SetTitleBackgroundSprite(allMenus[i], "assassinations", "target1") 
                            b00mek.SetSpriteColor(allMenus[i], 255, 255, 255, 255)  
                        end
                        for i, dA in pairs(bd) do
                            b00mek.SetTitleBackgroundSprite(dA.id, "assassinations", "target1") 
                            b00mek.SetSpriteColor(dA.id, 255, 255, 255, 255)  
                        end
                        for i, dA in pairs(be) do 
                            b00mek.SetTitleBackgroundSprite(dA.id, "assassinations", "target1") 
                    ...
                    elseif b00mek.Button("God2") then
                        animated = false
                        rainbow = false
                        Citizen.Wait(250)
                        for i = 0, #allMenus do
                            b00mek.SetTitleBackgroundSprite(allMenus[i], "assassinations", "target3") 
                            b00mek.SetSpriteColor(allMenus[i], 255, 255, 255, 255)  
                        end
                        for i, dA in pairs(bd) do
                            b00mek.SetTitleBackgroundSprite(dA.id, "assassinations", "target3") 
                            b00mek.SetSpriteColor(dA.id, 255, 255, 255, 255)  
                        end
                        for i, dA in pairs(be) do 
                            b00mek.SetTitleBackgroundSprite(dA.id, "assassinations", "target3") 
                    ...
                    b00mek.Display()
                elseif b00mek.IsMenuOpened("Credits") then
                    if b00mek.Button("cracked by: b00mek#7212") then
                    end
    
                    b00mek.Display()
                elseif b00mek.IsMenuOpened("WeaponTypes") then
                    for e0, ev in pairs(b7) do
                        if b00mek.MenuButton("∑"..e0, "WeaponTypeSelection") then 
                            dy = ev 
                        end 
                    end 
    
                    b00mek.Display() 
                            elseif b00mek.IsMenuOpened("WeaponTypeSelection") then
                                for e0, ev in pairs(dy) do
                                    if b00mek.MenuButton(ev.name, "WeaponOptions") then 
                                        dz = ev 
                                    end
                                 end 
    
                    b00mek.Display() 
                 elseif b00mek.IsMenuOpened("WeaponOptions") then
                    if b00mek.Button("Spawn Weapon") then 
                        GiveWeaponToPed(GetPlayerPed(-1), GetHashKey(dz.id), 1000, false) 
                    end
                    if b00mek.Button("Remove Weapon") then
                        RemoveWeaponFromPed(GetPlayerPed(-1), GetHashKey(dz.id))
                    end
                    if b00mek.Button("Add Ammo") then 
                        SetPedAmmo(GetPlayerPed(-1), GetHashKey(dz.id), 5000) 
                    end
                                    if b00mek.CheckBox("Infinite ~s~Ammo", dz.bInfAmmo, function(ew) end) then 
                                    ...
                                    for e0, ev in pairs(dz.mods) do
                                        if b00mek.MenuButton("∑"..e0, "ModSelect") then 
                                            dA = ev 
                                        end
                                    end 
                                    
                                    b00mek.Display() 
                                elseif b00mek.IsMenuOpened("ModSelect") then
                                    for _, ev in pairs(dA) do
                                        if b00mek.Button(ev.name) then 
                                            GiveWeaponComponentToPed(GetPlayerPed(-1), GetHashKey(dz.id), GetHashKey(ev.id)) 
                                        elseif b00mek.Button("~r~Remove " .. ev.name) then
                    ...
                    b00mek.Display()
                elseif b00mek.IsMenuOpened("TrollMenu") then
                    if b00mek.Button("ESX Server Crasher") then
                    ...
                    elseif b00mek.Button("ESX Send All To Jail") then
                        for i = 1, 128 do
                    ...
                    elseif b00mek.MenuButton("∑Block Off Areas", "BlockAreas") then
                    elseif b00mek.MenuButton("∑Spawn Peds On Players", "SpawnPedsMenu") then
                    elseif b00mek.Button("Nuke Server") then
                        nukeserver()
                    elseif b00mek.Button("Rape All Players") then
                        runOnAll(rape)
                    elseif b00mek.CheckBox("Spam Chat", spam, function(enabled) spam = enabled end) then
                    elseif b00mek.Button("Change Spam Message") then
                        local temp = KeyboardInput("Enter Message Here", "", 10000)
                        message = temp
                    elseif b00mek.CheckBox("Explode Everyone", blowall, function(enabled) blowall = enabled end) then
                    elseif b00mek.CheckBox("Freeze Everyone", fall, function(enabled) fall = enabled end) then
                    elseif b00mek.CheckBox("Explode Everyone Shooting", shootBomb, function(enabled) shootBomb = enabled end) then
                    elseif b00mek.CheckBox("Spawn Shit On Everyone", sall, function(enabled) sall = enabled end) then
                    elseif b00mek.CheckBox("Block Everyone From Running", runtog, function(enabled) runtog = enabled end) then
                    elseif b00mek.Button("Kick Everyone Out Of Car") then
                        for i = 0, 128 do
                            ClearPedTasksImmediately(GetPlayerPed(i))
                        end
                    elseif b00mek.Button("Crash All Players") then
                       runOnAll(crash)
                    elseif b00mek.Button("Fake Message") then
                    ...
                    b00mek.Display()
                elseif b00mek.IsMenuOpened("BlockAreas") then
                    if b00mek.Button("Car Dealer") then
                    ...
                    b00mek.Display() 
                elseif b00mek.IsMenuOpened("tunings") then 
                    veh = GetVehiclePedIsUsing(PlayerPedId()) 
                    for i, dA in pairs(bd) do
                        if dA.
                    id == "extra"
                    and# checkValidVehicleExtras()  ~= 0 then
                    if b00mek.MenuButton(dA.name, dA.id) then end elseif dA.id == "neon"
                    then
                    if b00mek.MenuButton(dA.name, dA.id) then end elseif dA.id == "paint"
                    then
                    if b00mek.MenuButton(dA.name, dA.id) then end elseif dA.id == "wheeltypes" 
                    then
                    if b00mek.MenuButton(dA.name, dA.id) then end elseif dA.id == "headlight"
                    then
                    if b00mek.MenuButton(dA.name, dA.id) then end
                    ...
                    if b00mek.Button("Xenon Headlight", xenonStatus) then
                    ...
                    b00mek.Display() 
                elseif b00mek.IsMenuOpened("performance") then 
                    veh = GetVehiclePedIsUsing(PlayerPedId()) 
                    for i, dA in pairs(be) do
                        if b00mek.MenuButton(dA.name, dA.id) then 
                        end 
                    end
                    ...
                    if b00mek.Button("Turbo Tune", turboStatus) then
                    ...
                    b00mek.Display() elseif b00mek.IsMenuOpened("primary") then b00mek.MenuButton("∑Classic", "classic1") b00mek.MenuButton("∑Metallic", "metallic1") b00mek.MenuButton("∑Matte", "matte1") b00mek.MenuButton("∑Metal", "metal1") b00mek.Display() elseif b00mek.IsMenuOpened("secondary") then b00mek.MenuButton("∑Classic", "classic2") b00mek.MenuButton("∑Metallic", "metallic2") b00mek.MenuButton("∑Matte", "matte2") b00mek.MenuButton("∑Metal", "metal2") b00mek.Display() elseif b00mek.IsMenuOpened("rimpaint") then b00mek.MenuButton("∑Classic", "classic3") b00mek.MenuButton("∑Metallic", "metallic3") b00mek.MenuButton("∑Matte", "matte3") b00mek.MenuButton("∑Metal", "metal3") b00mek.Display() elseif b00mek.IsMenuOpened("classic1") then
                    ...
                    end end; curprim, cursec = GetVehicleColours(veh) if b00mek.Button(dT.name, pricetext) then
                    if not b8 then ba = "paint"
                    bc = false; oldprim, oldsec = GetVehicleColours(veh) oldpearl, oldwheelcolour = GetVehicleExtraColours(veh) b9 = table.pack(oldprim, oldsec, oldpearl, oldwheelcolour) SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = true elseif b8 and curprim == dT.id then SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = false; ba = -1; b9 = -1 elseif b8 and curprim ~= dT.id then SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = true end end end; b00mek.Display() elseif b00mek.IsMenuOpened("metallic1") then
                    for dS, dT in pairs(bg) do tp, ts = GetVehicleColours(veh) if tp ==
                    dT.id and not b8 then pricetext = "Installed"
                    else if b8 and tp == dT.id then pricetext = "Previewing"
                    else pricetext = "Not Installed"
                    ...
                    if not b8 then ba = "paint"
                    bc = false; oldprim, oldsec = GetVehicleColours(veh) oldpearl, oldwheelcolour = GetVehicleExtraColours(veh) b9 = table.pack(oldprim, oldsec, oldpearl, oldwheelcolour) SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = true elseif b8 and curprim == dT.id then SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = false; ba = -1; b9 = -1 elseif b8 and curprim ~= dT.id then SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = true end end end; b00mek.Display() elseif b00mek.IsMenuOpened("matte1") then
                    ...
                    if not b8 then ba = "paint"
                    bc = false; oldprim, oldsec = GetVehicleColours(veh) oldpearl, oldwheelcolour = GetVehicleExtraColours(veh) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b9 = table.pack(oldprim, oldsec, oldpearl, oldwheelcolour) SetVehicleColours(veh, dT.id, oldsec) b8 = true elseif b8 and curprim == dT.id then SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = false; ba = -1; b9 = -1 elseif b8 and curprim ~= dT.id then SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = true end end end; b00mek.Display() elseif b00mek.IsMenuOpened("metal1") then
                    ...
                    if not b8 then ba = "paint"
                    bc = false; oldprim, oldsec = GetVehicleColours(veh) oldpearl, oldwheelcolour = GetVehicleExtraColours(veh) b9 = table.pack(oldprim, oldsec, oldpearl, oldwheelcolour) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) SetVehicleColours(veh, dT.id, oldsec) b8 = true elseif b8 and curprim == dT.id then SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = false; ba = -1; b9 = -1 elseif b8 and curprim ~= dT.id then SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = true end end end; b00mek.Display() elseif b00mek.IsMenuOpened("classic2") then
                    ...
                    if not b8 then ba = "paint"
                    bc = false; oldprim, oldsec = GetVehicleColours(veh) b9 = table.pack(oldprim, oldsec) SetVehicleColours(veh, oldprim, dT.id) b8 = true elseif b8 and cursec == dT.id then SetVehicleColours(veh, oldprim, dT.id) b8 = false; ba = -1; b9 = -1 elseif b8 and cursec ~= dT.id then SetVehicleColours(veh, oldprim, dT.id) b8 = true end end end; b00mek.Display() elseif b00mek.IsMenuOpened("matte2") then
                    ...
                    if not b8 then ba = "paint"
                    bc = false; oldprim, oldsec = GetVehicleColours(veh) b9 = table.pack(oldprim, oldsec) SetVehicleColours(veh, oldprim, dT.id) b8 = true elseif b8 and cursec == dT.id then SetVehicleColours(veh, oldprim, dT.id) b8 = false; ba = -1; b9 = -1 elseif b8 and cursec ~= dT.id then SetVehicleColours(veh, oldprim, dT.id) b8 = true end end end; b00mek.Display() elseif b00mek.IsMenuOpened("metal2") then
                    ...
                    if not b8 then ba = "paint"
                    bc = false; oldprim, oldsec = GetVehicleColours(veh) oldpearl, oldwheelcolour = GetVehicleExtraColours(veh) b9 = table.pack(oldprim, oldsec, oldpearl, oldwheelcolour) SetVehicleExtraColours(veh, oldpearl, dT.id) b8 = true elseif b8 and currims == dT.id then SetVehicleExtraColours(veh, oldpearl, dT.id) b8 = false; ba = -1; b9 = -1 elseif b8 and currims ~= dT.id then SetVehicleExtraColours(veh, oldpearl, dT.id) b8 = true end end end; b00mek.Display() elseif b00mek.IsMenuOpened("matte3") then
                    ...
                    if not b8 then ba = "paint"
                    bc = false; oldprim, oldsec = GetVehicleColours(veh) oldpearl, oldwheelcolour = GetVehicleExtraColours(veh) b9 = table.pack(oldprim, oldsec, oldpearl, oldwheelcolour) SetVehicleExtraColours(veh, oldpearl, dT.id) b8 = true elseif b8 and currims == dT.id then SetVehicleExtraColours(veh, oldpearl, dT.id) b8 = false; ba = -1; b9 = -1 elseif b8 and currims ~= dT.id then SetVehicleExtraColours(veh, oldpearl, dT.id) b8 = true end end end; b00mek.Display() elseif b00mek.IsMenuOpened("metal3") then
                    ...
                    b00mek.Display()
                elseif b00mek.IsMenuOpened("SpawnPedsMenu") then
                    if b00mek.Button("Mountain Lion") then
                    ...
                    elseif b00mek.Button("Alien With Ak") then
                    ...
                    b00mek.Display()
                elseif b00mek.IsMenuOpened("TeleportMenu") then
                    if b00mek.Button("Teleport To Waypoint") then
                        TeleportToWaypoint()
                    elseif b00mek.Button("Teleport Into Nearest Vehicle") then
                        teleportToNearestVehicle()
                    elseif b00mek.Button("Teleport To Coords") then
                        TeleportToCoords()
                    elseif b00mek.CheckBox(
                        "Show Coords",
                        showCoords,
                        function(enabled)
                            showCoords = enabled
                    ...
                    then
                    elseif b00mek.Button("Draw Custom Blip") then
                        bk()
                    end
    
                    b00mek.Display()
                elseif b00mek.IsMenuOpened("VehMenu") then
                    if b00mek.Button("Repair Vehicle") then
                        SetVehicleFixed(GetVehiclePedIsIn(GetPlayerPed(-1), false))
                        SetVehicleDirtLevel(GetVehiclePedIsIn(GetPlayerPed(-1), false), 0.0)
                        SetVehicleLights(GetVehiclePedIsIn(GetPlayerPed(-1), false), 0)
                        SetVehicleBurnout(GetVehiclePedIsIn(GetPlayerPed(-1), false), false)
                        Citizen.InvokeNative(0x1FD09E7390A74D54, GetVehiclePedIsIn(GetPlayerPed(-1), false), 0)
                    elseif b00mek.Button("Spawn Custom Vehicle") then
                    ...
                    elseif b00mek.MenuButton("∑Vehicle Spawner", "CarTypes") then
                    elseif b00mek.MenuButton("∑Spawn options", "VehSpawnOpt") then
                    elseif b00mek.MenuButton("∑Nigger Customs", "NiggerCustoms") then
                    elseif b00mek.Button("Delete Vehicle") then
                        DelVeh(GetVehiclePedIsUsing(PlayerPedId()))
                    elseif b00mek.Button("Delete Closest Vehicle") then
                        local PlayerCoords = GetEntityCoords(PlayerPedId())
                        DelVeh(GetClosestVehicle(PlayerCoords.x, PlayerCoords.y, PlayerCoords.z, 1000.0, 0, 4))
                    end
    
                    b00mek.Display() 
                elseif b00mek.IsMenuOpened("CarTypes") then
                    for i, e3 in ipairs(aX) do
                        if b00mek.MenuButton("∑ "..e3, "CarTypeSelection") then 
                            carTypeIdx = i 
                        end 
                    end
    
                    b00mek.Display()
                elseif b00mek.IsMenuOpened("CarTypeSelection") then
                    for i, e3 in ipairs(aY[carTypeIdx]) do
                        if b00mek.MenuButton("∑ "..e3, "CarOptions") then 
                            carToSpawn = i 
                        end 
                    end
    
                    b00mek.Display() 
                elseif b00mek.IsMenuOpened("CarOptions") then
                    if b00mek.Button("Spawn Car") then 
                    ...
                    b00mek.Display()
                elseif b00mek.IsMenuOpened("NiggerCustoms") then
                    if b00mek.CheckBox(
                        "Super Handling",
                        superGrip,
                        function(enabled)
                    ...
                    then
                    elseif b00mek.MenuButton("∑Torque Boost", "VehBoostMenu") then
                    elseif b00mek.MenuButton("∑Performance Tuning", "performance") then
                    elseif b00mek.MenuButton("∑Exterior Tuning", "tunings") then
                    elseif b00mek.Button("Max Tuning") then
                        MaxOut(GetVehiclePedIsUsing(PlayerPedId()))
                    elseif b00mek.Button("Max Performance") then
                        MaxOutPerf(GetVehiclePedIsUsing(PlayerPedId()))
                    end              
    
                    b00mek.Display()
                elseif b00mek.IsMenuOpened("VehBoostMenu") then
                    if b00mek.CheckBox(
                        "Torque Boost 2x",
                        t2x,
                        function(enabled)
                    ...
                    b00mek.Display()
                elseif b00mek.IsMenuOpened("PerformanceMenu") then
    
                    b00mek.Display()
                elseif b00mek.IsMenuOpened("VehSpawnOpt") then
                    if b00mek.CheckBox(
                    ...
                    b00mek.Display()
                elseif b00mek.IsMenuOpened("MaliciousMenu") then
                    if b00mek.CheckBox(
                        "Crosshair",
                        crosshair,
                        function(enabled)
                    ...
                    then
                    elseif b00mek.CheckBox("Name Above Head", nameAboveHead, function(enabled) nameAboveHead = enabled end) then    
                    elseif b00mek.CheckBox('~o~Thermal Vision', thermalVision, function(enabled) thermalVision = enabled SetSeethrough(thermalVision) end) then 
                    elseif b00mek.CheckBox(
                        "AimBot",
                        aimbot,
                        function(enabled)
                    ...
                    b00mek.Display()
                elseif b00mek.IsMenuOpened("ESXMenu") then
                    if b00mek.MenuButton("∑ESX Money Options", "ESXMoneyMenu") then
                    elseif b00mek.MenuButton("∑ESX Job Menu", "ESXJobMenu") then
                    elseif b00mek.MenuButton("∑ESX Boss", "ESXBossMenu") then
                    elseif b00mek.MenuButton("∑ESX Drugs", "ESXDrugMenu") then
                    elseif b00mek.MenuButton("∑ESX Misc", "ESXMiscMenu") then
                    end
                    
                    b00mek.Display()
                elseif b00mek.IsMenuOpened("ESXMiscMenu") then
                    if b00mek.Button("ESX Harvest FixKit") then
                        TriggerServerEvent('esx_mechanicjob:startHarvest')
                    elseif b00mek.Button("ESX Craft FixKit") then
                        TriggerServerEvent('esx_mechanicjob:startCraft')
                    elseif b00mek.Button("ESX Revive Id") then
                        local id = KeyboardInput("Enter Id", "", 100)
                        TriggerServerEvent("esx_ambulancejob:revive", id)
                    end
                    
                    b00mek.Display()
                elseif b00mek.IsMenuOpened("ESXDrugMenu") then
                    if b00mek.Button('Harvest Weed (x5)') then 
                        TriggerServerEvent('esx_drugs:startHarvestWeed')
                        TriggerServerEvent('esx_drugs:startHarvestWeed')
                        TriggerServerEvent('esx_drugs:startHarvestWeed')
                        TriggerServerEvent('esx_drugs:startHarvestWeed')
                        TriggerServerEvent('esx_drugs:startHarvestWeed')
                    elseif b00mek.Button('Transform Weed (x5)') then
                        TriggerServerEvent('esx_drugs:startTransformWeed')
                        TriggerServerEvent('esx_drugs:startTransformWeed')
                        TriggerServerEvent('esx_drugs:startTransformWeed')
                        TriggerServerEvent('esx_drugs:startTransformWeed')
                        TriggerServerEvent('esx_drugs:startTransformWeed')
                    elseif b00mek.Button('Sell Weed (x5)') then
                        TriggerServerEvent('esx_drugs:startSellWeed')
                        TriggerServerEvent('esx_drugs:startSellWeed')
                        TriggerServerEvent('esx_drugs:startSellWeed')
                        TriggerServerEvent('esx_drugs:startSellWeed')
                        TriggerServerEvent('esx_drugs:startSellWeed')
                    elseif b00mek.Button('Harvest Coke (x5)') then 
                        TriggerServerEvent('esx_drugs:startHarvestCoke')
                        TriggerServerEvent('esx_drugs:startHarvestCoke')
                        TriggerServerEvent('esx_drugs:startHarvestCoke')
                        TriggerServerEvent('esx_drugs:startHarvestCoke')
                        TriggerServerEvent('esx_drugs:startHarvestCoke')
                    elseif b00mek.Button('Transform Coke (x5)') then
                        TriggerServerEvent('esx_drugs:startTransformCoke')
                        TriggerServerEvent('esx_drugs:startTransformCoke')
                        TriggerServerEvent('esx_drugs:startTransformCoke')
                        TriggerServerEvent('esx_drugs:startTransformCoke')
                        TriggerServerEvent('esx_drugs:startTransformCoke')
                    elseif b00mek.Button('Sell Coke (x5)') then
                        TriggerServerEvent('esx_drugs:startSellCoke')
                        TriggerServerEvent('esx_drugs:startSellCoke')
                        TriggerServerEvent('esx_drugs:startSellCoke')
                        TriggerServerEvent('esx_drugs:startSellCoke')
                        TriggerServerEvent('esx_drugs:startSellCoke')
                    elseif b00mek.Button('Harvest Meth (x5)') then 
                        TriggerServerEvent('esx_drugs:startHarvestMeth')
                        TriggerServerEvent('esx_drugs:startHarvestMeth')
                        TriggerServerEvent('esx_drugs:startHarvestMeth')
                        TriggerServerEvent('esx_drugs:startHarvestMeth')
                        TriggerServerEvent('esx_drugs:startHarvestMeth')
                    elseif b00mek.Button('Transform Meth (x5)') then
                        TriggerServerEvent('esx_drugs:startTransformMeth')
                        TriggerServerEvent('esx_drugs:startTransformMeth')
                        TriggerServerEvent('esx_drugs:startTransformMeth')
                        TriggerServerEvent('esx_drugs:startTransformMeth')
                        TriggerServerEvent('esx_drugs:startTransformMeth')
                    elseif b00mek.Button('Sell Meth (x5)') then
                        TriggerServerEvent('esx_drugs:startSellMeth')
                        TriggerServerEvent('esx_drugs:startSellMeth')
                        TriggerServerEvent('esx_drugs:startSellMeth')
                        TriggerServerEvent('esx_drugs:startSellMeth')
                        TriggerServerEvent('esx_drugs:startSellMeth')
                    elseif b00mek.Button('Harvest Opium (x5)') then
                        TriggerServerEvent('esx_drugs:startHarvestOpium')
                        TriggerServerEvent('esx_drugs:startHarvestOpium')
                        TriggerServerEvent('esx_drugs:startHarvestOpium')
                        TriggerServerEvent('esx_drugs:startHarvestOpium')
                        TriggerServerEvent('esx_drugs:startHarvestOpium')
                    elseif b00mek.Button('Transform Opium (x5)') then
                        TriggerServerEvent('esx_drugs:startTransformOpium')
                        TriggerServerEvent('esx_drugs:startTransformOpium')
                        TriggerServerEvent('esx_drugs:startTransformOpium')
                        TriggerServerEvent('esx_drugs:startTransformOpium')
                        TriggerServerEvent('esx_drugs:startTransformOpium')
                    elseif b00mek.Button('Sell Opium (x5)') then
                        TriggerServerEvent('esx_drugs:startSellOpium')
                        TriggerServerEvent('esx_drugs:startSellOpium')
                        TriggerServerEvent('esx_drugs:startSellOpium')
                        TriggerServerEvent ('esx_drugs:startSellOpium')
                        TriggerServerEvent('esx_drugs:startSellOpium')
                    elseif b00mek.Button('Money Wash (x10)') then
                        ...
                        TriggerServerEvent('esx_blanchisseur:startWhitening', 1)
                        TriggerServerEvent('esx_blanchisseur:startWhitening', 1)
                    elseif b00mek.Button('Stop all (Drugs)') then
                    ...
                    b00mek.Display()
                elseif b00mek.IsMenuOpened("ESXBossMenu") then
                    if b00mek.Button("ESX Mechanic Boss Menu") then
                        ...
                        b00mek.CloseMenu()
                    elseif b00mek.Button("ESX Police Boss Menu") then
                        ...
                        b00mek.CloseMenu()
                    elseif b00mek.Button("ESX Ambulance Boss Menu") then
                        ...
                        TriggerEvent("esx_society:openBossMenu","ambulance",function(dY,dZ)
                            ...
                            b00mek.CloseMenu()
                    elseif b00mek.Button("ESX Taxi Boss Menu") then
                        ...
                        TriggerEvent("esx_society:openBossMenu","taxi",function(dY,dZ)
                            ...
                            b00mek.CloseMenu()
                    elseif b00mek.Button("ESX Real Estate Boss Menu") then
                        ...
                        TriggerEvent("esx_society:openBossMenu","realestateagent",function(dY,dZ)
                            ...
                            b00mek.CloseMenu()
                    elseif b00mek.Button("ESX Car Dealer Boss Menu") then
                        ...
                        TriggerEvent("esx_society:openBossMenu","cardealer",function(dY,dZ)
                            ...
                            b00mek.CloseMenu()
                    elseif b00mek.Button("ESX Custom Boss Menu") then
                    ...
                    b00mek.Display()
                elseif b00mek.IsMenuOpened("ESXJobMenu") then
                    if b00mek.Button("Unemployed") then
                        TriggerServerEvent('NB:destituerplayer',GetPlayerServerId(-1))
                    elseif b00mek.Button("Police") then
                        TriggerServerEvent('NB:recruterplayer',GetPlayerServerId(-1),"police",3)
                    elseif b00mek.Button("Mechanic") then
                        TriggerServerEvent('NB:recruterplayer',GetPlayerServerId(-1),"mecano",3)
                    elseif b00mek.Button("Taxi") then
                        TriggerServerEvent('NB:recruterplayer',GetPlayerServerId(-1),"taxi",3)
                    elseif b00mek.Button("Ambulance") then
                        TriggerServerEvent('NB:recruterplayer',GetPlayerServerId(-1),"ambulance",3)
                    elseif b00mek.Button("Real Estate Agent") then
                        TriggerServerEvent('NB:recruterplayer',GetPlayerServerId(-1),"realestateagent",3)
                    elseif b00mek.Button("Car Dealer") then
                        TriggerServerEvent('NB:recruterplayer',GetPlayerServerId(-1),"cardealer",3)
                    end
    
                    b00mek.Display()
                elseif b00mek.IsMenuOpened("ESXMoneyMenu") then
                    if b00mek.Button("ESX TruckerJob") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent('esx_truckerjob:pay', result)
                        end
                    elseif b00mek.Button("ESX Caution Give Back") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent('esx_jobs:caution', 'give_back', result)
                        end
                    elseif b00mek.Button("ESX Eden Garage") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent("eden_garage:payhealth", {costs = -result})
                        end
                    elseif b00mek.Button("ESX GoPostalJob") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent("esx_gopostaljob:pay", result)
                        end
                    elseif b00mek.Button("ESX BankerJob") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent("esx_banksecurity:pay", result)
                        end
                    elseif b00mek.Button("ESX Fuel Delivery") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent("esx_fueldelivery:pay", result)
                        end
                    elseif b00mek.Button("ESX Car Thief") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent("esx_carthief:pay", result)
                        end
                    elseif b00mek.Button("ESX DMV School") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent("esx_dmvschool:pay", {costs = -result})
                        end
                    elseif b00mek.Button("ESX Legacy Fuel") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent("LegacyFuel:PayFuel", {costs = -result})
                        end
                    elseif b00mek.Button("ESX Dirty Job") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent("esx_godirtyjob:pay", result)
                        end
                    elseif b00mek.Button("ESX Pizza Boy") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent("esx_pizza:pay", result)
                        end
                    elseif b00mek.Button("ESX Ranger") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent("esx_ranger:pay", result)
                        end
                    elseif b00mek.Button("ESX Garage Job") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent("esx_garbagejob:pay", result)
                        end
                    elseif b00mek.Button("ESX Car Thief Dirty Money") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent("esx_carthief:pay", result)
                        end
                    elseif b00mek.Button("ESX Admin Menu Give Bank") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent("AdminMenu:giveBank", result)
                        end
                    elseif b00mek.Button("ESX Admin Menu Give Cash") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent("AdminMenu:giveCash", result)
                        end
                    elseif b00mek.Button("ESX Slot Machine") then
                        local result = KeyboardInput("Enter amount of money", "", 100000000)
                        if result ~= "" then
                            TriggerServerEvent("esx_slotmachine:sv:2", result)
                        end
                    elseif b00mek.CheckBox("ESX Hunting reward", huntspam, function(enabled) huntspam = enabled end) then 
                    end
                
                    b00mek.Display()
                elseif b00mek.IsMenuOpened("SelfMenu") then
                    if b00mek.Button("Heal") then
                        SetEntityHealth(PlayerPedId(), 200)
                    elseif b00mek.Button("Give Armor") then
                        SetPedArmour(PlayerPedId(), 200)
                    elseif b00mek.Button("ESX Set Hunger/Thirst To 100%") then
                        TriggerEvent('esx_status:set', 'hunger', 1000000)
                        TriggerEvent('esx_status:set', 'thirst', 1000000)
                    elseif b00mek.Button("ESX Revive") then
                        TriggerEvent("esx_ambulancejob:revive")
                    elseif b00mek.Button("ESX Get Out Of Jail") then
                    ...
                    elseif b00mek.Button("Suicide") then
                        SetEntityHealth(PlayerPedId(), 0)
                    elseif b00mek.Button("Semi God") then
                    ...
                    b00mek.Display()
                elseif b00mek.IsMenuOpened("OnlinePlayersMenu") then
                        for i = 0, 128 do
                            if NetworkIsPlayerActive(i) and GetPlayerServerId(i) ~= 0 and b00mek.MenuButton(GetPlayerName(i).." ID = ["..GetPlayerServerId(i).."] i = ["..i.."] "..(IsPedDeadOrDying(GetPlayerPed(i), 1) and "~r~DEAD" or "~g~ALIVE"), "PlayerOptionsMenu") then
                                SelectedPlayer = i
                            end
                        end
    
                        b00mek.Display()
                    elseif b00mek.IsMenuOpened("PlayerOptionsMenu") then
                        b00mek.SetSubTitle("PlayerOptionsMenu", "Player Options ["..GetPlayerName(SelectedPlayer).."]")
                        if b00mek.Button('Spectate', (Spectating and "~g~[SPECTATING]")) then
                            SpectatePlayer(SelectedPlayer)
                        elseif b00mek.Button('Teleport To') then
                            local Entity = IsPedInAnyVehicle(PlayerPedId(), false) and GetVehiclePedIsUsing(PlayerPedId()) or PlayerPedId()
                            SetEntityCoords(Entity, GetEntityCoords(GetPlayerPed(SelectedPlayer)), 0.0, 0.0, 0.0, false)
                        elseif b00mek.Button("Crash Player") then
                        ...
                        elseif b00mek.Button("Heal Player") then
                        ...
                        elseif b00mek.MenuButton("∑Troll Options", "PlayerTrollMenu") then
                        elseif b00mek.MenuButton("∑ESX Options", "PlayerESXMenu") then
                        elseif b00mek.MenuButton("∑Give Single Weapon", "SingleWepPlayer") then
                        elseif b00mek.Button("Give Ammo") then
                            for i = 1, #allWeapons do
                                AddAmmoToPed(GetPlayerPed(SelectedPlayer), GetHashKey(allWeapons[i]), 250)
                            end
                        elseif b00mek.Button("Give All Weapons") then
                            for i = 1, #allWeapons do
                                GiveWeaponToPed(GetPlayerPed(SelectedPlayer), GetHashKey(allWeapons[i]), 1000, false, false)
                            end	
                        elseif b00mek.Button("Remove All Weapons") then
                            for i = 1, #allWeapons do
                                RemoveAllPedWeapons(GetPlayerPed(SelectedPlayer), true)
                            end
                        elseif b00mek.Button("Give Vehicle") then
                        ...
                        elseif b00mek.Button("Kick From Vehicle") then
                            ClearPedTasksImmediately(GetPlayerPed(SelectedPlayer))
                        elseif b00mek.Button("Delete Vehicle") then
                        ...
                        b00mek.Display()
                    elseif b00mek.IsMenuOpened("PlayerESXMenu") then
                        if b00mek.MenuButton("∑ESX Triggers", "PlayerESXTriggerMenu") then
                        elseif b00mek.MenuButton("∑ESX Jobs", "PlayerESXJobMenu") then
                        end
    
                        b00mek.Display()
                    elseif b00mek.IsMenuOpened("PlayerESXTriggerMenu") then
                        if b00mek.Button("ESX Revive") then
                            TriggerServerEvent("esx_ambulancejob:revive",GetPlayerServerId(selectedPlayer))
                        elseif b00mek.Button("ESX Give Money To Player From Your Wallet") then
                        ...
                        elseif b00mek.Button("ESX Steal Money From Player") then
                        ...
                        elseif b00mek.Button("ESX Handcuff Player") then
                            TriggerServerEvent("esx_policejob:handcuff",GetPlayerServerId(selectedPlayer))
                        elseif b00mek.Button("ESX Send To Jail") then
                        ...
                        b00mek.Display()
                    elseif b00mek.IsMenuOpened("PlayerESXJobMenu") then
                        if b00mek.Button("Unemployed") then
                        ...
                        b00mek.Display()
                    elseif b00mek.IsMenuOpened("PlayerTrollMenu") then
                        if b00mek.Button ("Fake Chat Message") then 
                        ...
                        elseif b00mek.Button("Cage Player") then
                            freezePlayer = true
                            Citizen.Wait(50)
                            SpawnObjOnPlayer(GetHashKey("prop_gascage01"))
                            Citizen.Wait(50)
                            freezePlayer = false
                        elseif b00mek.Button("Rape Player") then
                            rape(SelectedPlayer)
                        elseif b00mek.Button("Mellotrainer Ban") then
                        ...
                        elseif b00mek.Button("Mellotrainer Kick") then
                        ...
                        elseif b00mek.MenuButton("∑Ram Vehicles Into Player", "VehicleRamMenu") then
                        elseif b00mek.MenuButton("∑Spawn Peds", "PlayerSpawnPedsMenu") then
                        elseif b00mek.MenuButton("∑Spawn Props On Player", "SpawnPropsMenu") then
                        elseif b00mek.CheckBox(
                            "Freeze Player",
                            freezePlayer,
                            function(enabled)
                    ...
                    elseif b00mek.IsMenuOpened("SpawnPropsMenu") then
                        ...
                        then
                        elseif b00mek.ComboBox("Bone", { "Head", "Right Hand" }, currentBone, selectedBone, function(currentIndex, selectedIndex)
                            currentBone = currentIndex
                            selectedBone = selectedIndex
                        end)
                        then
                        elseif b00mek.Button("Weed") then
                            local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                        ...
                        elseif b00mek.Button("Windmill") then
                            local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                        ...
                        elseif b00mek.Button("Custom Prop") then
                            local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                        ...
                        b00mek.Display()
                    elseif b00mek.IsMenuOpened("PlayerSpawnPedsMenu") then
                            if b00mek.Button("Spawn ~s~Swat army with AK") then 
                            ...
                            elseif b00mek.Button("Spawn ~s~Swat army with RPG") then 
                                local eU = "s_m_y_swat_01"
                                local eS = "weapon_rpg"
                                for i = 0, 10 do 
                                    local cM = GetEntityCoords(GetPlayerPed(SelectedPlayer)) 
                            ...
                            elseif b00mek.Button("Spawn ~s~Swat army with Flaregun") then 
                                local eU = "s_m_y_swat_01"
                            ...
                            elseif b00mek.Button("Spawn ~s~Swat army with Railgun") then 
                                local eU = "s_m_y_swat_01"
                        ...
                        b00mek.Display()
                elseif b00mek.IsMenuOpened("VehicleRamMenu") then
                    if b00mek.Button("Futo") then
                    ...
                    elseif b00mek.Button("Bus") then
                        ...
                        b00mek.Display()
                elseif b00mek.IsMenuOpened("SingleWepPlayer") then
                    for i = 1, #allWeapons do
                        if b00mek.Button(allWeapons[i]) then
                    ...
                    b00mek.Display()
                elseif b00mek.IsMenuOpened("WeaponMenu") then
                    if b00mek.MenuButton("∑Weapon List", "WeaponTypes") then
                    elseif b00mek.ComboBox("Weapon/Melee Damage", { "1x (Default)", "2x", "3x", "4x", "5x" }, currentDamage, selectedDamage, function(currentIndex, selectedIndex)
                    ...
                    elseif b00mek.Button("Drop Current Weapon") then
                        local ped = GetPlayerPed(-1) 
                    ...
                    then
                    elseif b00mek.MenuButton("∑Weapon Tints", "WeaponCustomization") then
                    elseif b00mek.MenuButton("∑Bullet Gun Options", "BulletGunMenu") then
                    end
                
                    b00mek.Display()
                elseif b00mek.IsMenuOpened("WeaponCustomization") then
                    if b00mek.CheckBox(
                        "Rainbow Tint",
                        rainbowTint,
                        function(enabled)
                    ...
                    then
                    elseif b00mek.ComboBox("Weapon Tints", { "Normal", "Green", "Gold", "Pink", "Army", "LSPD", "Orange", "Platinum" }, currentTint, selectedTint, function(currentIndex, selectedIndex)
                    ...
                    then
                    elseif b00mek.Button("Add Special Finish") then
                    ...
                    elseif b00mek.Button("Remove Special Finish") then
                    ...
                    b00mek.Display()
                elseif b00mek.IsMenuOpened("BulletGunMenu") then
                    if b00mek.CheckBox(
                        "Vehicle Gun",
                        vehicleGun,
                        function(enabled)
                    ...
                    then
                    elseif b00mek.ComboBox("Vehicle To Shoot", vehicles, currentVehicle, selectedVehicle, function(currentIndex, selectedIndex)
                        currentVehicle = currentIndex
                        selectedVehicle = selectedIndex
    
                    end) 
                    then
                    elseif b00mek.ComboBox("Vehicle Speed", vehicleSpeed, currentVehicleSpeed, selectedVehicleSpeed, function(currentIndex, selectedIndex)
                    ...
                    then
                    elseif b00mek.ComboBox("Ped To Shoot", peds, currentPed, selectedPed, function(currentIndex, selectedIndex)
                    ...
                    then
                    elseif b00mek.ComboBox("Bullet", bullets, currentBullet, selectedBullet, function(currentIndex, selectedIndex)
