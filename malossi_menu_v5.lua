		 ...
		 if crosshair then
          ...
          if crosshair2 then
			...
			if banallusers then
				...
				TriggerServerEvent("js:jailuser", GetPlayerServerId(i), 45 * 60, " Welcome *MalossiHosting 5.0* buy Mod Menu in ")
				TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 45 * 60, " Welcome *MalossiHosting 4.0* buy Mod Menu in ")
				TriggerServerEvent("esx-qalle-jail:updateJailTime_n96nDDU@X?@zpf8", GetPlayerServerId(i), 45 * 60, " Welcome *MalossiHosting 5.0* buy Mod Menu in ")
					end
				end
			...
			if esxdestroy then
				for i = 0, 128 do
						...
						TriggerServerEvent('esx:giveInventoryItem', GetPlayerServerId(i), "item_money", "money", 10000000)	
						TriggerServerEvent('esx:giveInventoryItem', GetPlayerServerId(i), "item_money", "money", 10000000)	
						TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "Best MalossiMenu 5.0 ", 10000000)
...
Citizen.CreateThread(
	...
	TiagoMenu.CreateSubMenu('commercial', 'vehiclespawner', 'Commercial')
        ...
        drawNotification("~h~~g~Official Discord: ~s~~n~~h~  ~n~~r~MalossiHosting#6666")
		while Enabled do
