...
developers = {
    "MalossiHosting - MalossiHosting#6666", -- Main Developer
    "SHBypass - ScripthookBypass#3643", -- Secondary Developer
    "" -- Tertiary Developer and GitHub Maintenance
}

menuName = "MalossiMenu" -- The name of the menu
version = "6.0" -- Keep it simple
...
menuKeybind = "DELETE" -- Key to open the menu. Supported ones are shown below (line 1287) - Find new ones at 
        ...
        elseif WarMenu.IsMenuOpened('vehiclemenu') then
            if WarMenu.CheckBox("Save Personal Vehicle", SavedVehicle, "None", "Saved Vehicle: "..pvehicleText) then
                if IsPedInAnyVehicle(PlayerPedId(), 0) and not SavedVehicle then
					...
					SetBlipColour(pvblip, 69) -- Full list of the available blips colors https://i.imgur.com/Hvyx6cE.png
