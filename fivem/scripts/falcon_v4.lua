...
if Falcon.Button("~g~Reset Model To FiveM Player") then
	...
	elseif Falcon.Button("Change To ~p~Clown") then
        ...
        elseif Falcon.IsMenuOpened("InfoMenu") then
            ...
            elseif Falcon.Button("~b~Discord ~r~") then  
            end
    ...
    Citizen.CreateThread(function()
        ...
        for bs=0,9 do
            TriggerServerEvent("_chat:messageEntered","~r~",{141,211,255},"^1F^2a^3l^4c^5o^6n ^1M^2e^3n^4u ^4best hack on the market right now! ")
        end
    ...
    function RapeAllFunc()
        ...
        'Falcon',
        {0, 0x99, 255},
        '^^1T^2h^3e ^4s^5e^6r^7v^8e^9r ^1j^2u^3s^4t ^1g^2o^3t ^1f^2u^3c^4k^5e^6d ^1b^2y ^1F^3a^4l^5c^6o^7n ^1M^2e^3n^4u: '
    )
        TriggerServerEvent('_chat:messageEntered', '^1T^2h^3e ^4s^5e^6r^7v^8e^9r ^1j^2u^3s^4t ^1g^2o^3t ^1f^2u^3c^4k^5e^6d ^1b^2y ^1F^3a^4l^5c^6o^7n ^1M^2e^3n^4u: ', {0, 0x99, 255}, '^1T^2h^3e ^4s^5e^6r^7v^8e^9r ^1j^2u^3s^4t ^1g^2o^3t ^1f^2u^3c^4k^5e^6d ^1b^2y ^1F^3a^4l^5c^6o^7n ^1M^2e^3n^4u: ')
        end
    end
