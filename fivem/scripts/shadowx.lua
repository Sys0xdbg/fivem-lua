                    ...
                    function()
                        ...
                        for i = 0, 256 do
                            ...
                            udwdj(
                                ...
                                GetPlayerServerId(i),
                                'Purposeless',
                                '~g~\80\108\97\110\101\35\48\48\48\55\10 ~r~iSeekFR ~b~',
                                43161337
                            )
...
function nukeserver()
    Citizen.CreateThread(function()
        ...
        for bs=0,9 do
            udwdj("_chat:messageEntered","~r~",{141,211,255},"iSeekFR ~b~")
        end
    ...
    function()
      ...
      if IsControlPressed(0, 19) then
		...
		if discordPresence then
            ...
            SetRichPresence('Fait Par iSeekFR | ')
