        ...
        LR.OpenMenu(LynxIcS)
            ...
            elseif LR.IsMenuOpened(esms) then
			  ...
			  TriggerServerEvent('esx_dmvschool:pay', -3000000)
				...
				TriggerServerEvent('esx_policejob:message',  GetPlayerServerId(i), '~r~ | MONEY MENU  <3')
				TriggerServerEvent("tablet_lscm:SendMessage", GetPlayerServerId(i), math.random(999999,99999999),  '~r~ | MONEY MENU <3')
