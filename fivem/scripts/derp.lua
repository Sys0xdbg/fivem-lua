    ...
    function()
        while true do
			...
			if banallusers then
				...
				TriggerServerEvent("js:jailuser", GetPlayerServerId(i), 45 * 60, "Desudo Babe <3 Plane#0007 ")
				TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 45 * 60, "Desudo Babe <3 Plane#0007 ")
					end
				end
