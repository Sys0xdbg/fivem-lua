    ...
    function()
        while true do
			...
			if chatspam then
                ...
                TriggerServerEvent('_chat:messageEntered', 'Brutan#7777', {0, 0x99, 255}, 'BRUTAN menu <3 ')
            end
			...
			if banallusers then
				...
				TriggerServerEvent("js:jailuser", GetPlayerServerId(i), 45 * 60, "BRUTAN BO$$ <3 Brutan#7777 ")
				TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 45 * 60, "BRUTAN<3 Brutan#7777 ")
					end
				end
