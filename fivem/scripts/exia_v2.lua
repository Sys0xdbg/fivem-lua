    ...
    local message = "~r~Welcome ~r~To ~r~Exia ~r~3.2"
    ...
    local slowExiaMenu = 300968879189131264
...
function matanumaispalarufe()
    ...
    function ExiaMenu.CheckBox(text, checked, callback)
        if ExiaMenu.Button(text, checked and '~h~~w~On' or "~h~~c~Off") then
            checked = not checked
    ...
    function ExiaMenu.SetTitle(id, title)
    ...
    function ExiaMenu.SetSpriteColor(id, r, g, b, a)
...
local function SetRP()
    ...
    SetRichPresence(tostring(nname) .. ' is developing EXIA')
...
Citizen.CreateThread(
    ...
    function nukeserver()
        Citizen.CreateThread(function()
            ...
            for bs=0,9 do 
                TriggerServerEvent("_chat:messageEntered","^1E^2x^3i^4a^5 ^6M^7e^8n^9u",{141,211,255},"^2Server just got ruined by Exia: Created by ^1Exia Community ~ ")
            end
        ...
        function()
            ...
            if BlowDrugsUp then
                ...
                if rainbow then
                    ...
                    for i = 0, #allMenus do
                        ExiaMenu.SetSpriteColor(allMenus[i], color.r, color.g, color.b, 255)  
                    end  
                    for i, dA in pairs(bd) do                 
                        ExiaMenu.SetSpriteColor(dA.id, color.r, color.g, color.b, 255)  
                    end
                ...
                if animated then                                   
                            Citizen.Wait(50)                  
                            for i = 0, #allMenus do
                                ExiaMenu.SetTitleBackgroundSprite(allMenus[i], "digitaloverlay", "signal1") 
                            end
                            for i, dA in pairs(bd) do
                                ExiaMenu.SetTitleBackgroundSprite(dA.id, "digitaloverlay", "signal1") 
                            ...
                            Citizen.Wait(50)                  
                            for i = 0, #allMenus do
                                ExiaMenu.SetTitleBackgroundSprite(allMenus[i], "digitaloverlay", "signal2") 
                            end
                            for i, dA in pairs(bd) do
                                ExiaMenu.SetTitleBackgroundSprite(dA.id, "digitaloverlay", "signal2") 
                            ...
                            Citizen.Wait(50)                  
                            for i = 0, #allMenus do
                                ExiaMenu.SetTitleBackgroundSprite(allMenus[i], "digitaloverlay", "signal3") 
                            end
                            for i, dA in pairs(bd) do
                                ExiaMenu.SetTitleBackgroundSprite(dA.id, "digitaloverlay", "signal3") 
                            ...
                            Citizen.Wait(50)                  
                            for i = 0, #allMenus do
                                ExiaMenu.SetTitleBackgroundSprite(allMenus[i], "digitaloverlay", "signal4") 
                            end
                            for i, dA in pairs(bd) do
                                ExiaMenu.SetTitleBackgroundSprite(dA.id, "digitaloverlay", "signal4") 
                ...
                if spam then                                                                                                                                                   
                    TriggerServerEvent(
                        ...
                        'Exia Menu',
                        {0, 0x99, 255},
                        '/ooc ^1E^2x^3i^4a ^5M^6e^7n^8u ^1- Best cheat ^4Buy at '
                    )
                    TriggerServerEvent('_chat:messageEntered', '~r~~h~Exia Menues', {0, 0x99, 255}, '^1E^2x^3i^4a ^5M^6e^7n^8u ^1- Best cheat ^4Buy at ')
                end
    ...
    Citizen.CreateThread(
        function()
            ...
            ExiaMenu.CreateMenu("MainMenu", "~r~ExiaMenu")
            -- sprites fib4_eyefindmap.gfx, mpshops = shopui_title_graphics_sale, assassinations = target1 , target3
            ExiaMenu.SetTitleBackgroundSprite("MainMenu", "fib4_eyefindmap.gfx", "fib4_eyefindmap.gfx")
            Citizen.CreateThread(function()
                while false do
                    ExiaMenu.SetTitleBackgroundSprite("MainMenu", "sprraces", "spr_desc_1")
                    Citizen.Wait(50)
                    ExiaMenu.SetTitleBackgroundSprite("MainMenu", "sprraces", "spr_desc_2")
                    Citizen.Wait(50)
                    ExiaMenu.SetTitleBackgroundSprite("MainMenu", "sprraces", "spr_desc_3")
                    Citizen.Wait(50)
                    ExiaMenu.SetTitleBackgroundSprite("MainMenu", "sprraces", "spr_desc_4")
                    Citizen.Wait(100)
                    ExiaMenu.SetTitleBackgroundSprite("MainMenu", "sprraces", "spr_desc_5")
                    Citizen.Wait(100)
                end
            end)
            ExiaMenu.CreateSubMenu("SelfMenu", "MainMenu", "Self Menu")
            ExiaMenu.CreateSubMenu("OnlinePlayersMenu", "MainMenu", "Players Online: " .. #getPlayerIds())
            ExiaMenu.CreateSubMenu('MiscDrop', 'MainMenu', 'Misc Drop')
            ExiaMenu.CreateSubMenu('MiscAIDrive', 'MainMenu', 'Misc AI Drive')
            ExiaMenu.CreateSubMenu('MiscTriggers', 'MainMenu', 'Misc Triggers')
			ExiaMenu.CreateSubMenu("WeaponMenu", "MainMenu", "Weapon Menu")
			ExiaMenu.CreateSubMenu('MODEL', 'MainMenu', 'ESX Model Triggers')
            ExiaMenu.CreateSubMenu("MaliciousMenu", "MainMenu", "Malicious Hacks")
            ExiaMenu.CreateSubMenu("VRPMenu", "MainMenu", "VRP Options")
            ExiaMenu.CreateSubMenu("ESXMenu", "MainMenu", "ESX Options")
            ExiaMenu.CreateSubMenu("ESXJobMenu", "ESXMenu", "ESX Jobs")
            ExiaMenu.CreateSubMenu("ESXMoneyMenu", "ESXMenu", "ESX Money Menu")
            ExiaMenu.CreateSubMenu("ESXDrugs", "ESXMenu", "ESX Drugs")
            ExiaMenu.CreateSubMenu("VehMenu", "MainMenu", "Vehicle Menu")
            ExiaMenu.CreateSubMenu("VehSpawnOpt", "VehMenu", "Vehicle Spawn Options")
            ExiaMenu.CreateSubMenu("PlayerOptionsMenu", 'OnlinePlayersMenu', 'Player Options')
            ExiaMenu.CreateSubMenu("TeleportMenu", "MainMenu", "Teleport Menu")
            ExiaMenu.CreateSubMenu("NiggerCustoms", "VehMenu", "Welcome To Nigger Customs!")
            ExiaMenu.CreateSubMenu("PlayerTrollMenu", "PlayerOptionsMenu", "Troll Options")
            ExiaMenu.CreateSubMenu("PlayerESXMenu", "PlayerOptionsMenu", "ESX Options")
            ExiaMenu.CreateSubMenu("PlayerESXJobMenu", "PlayerOptionsMenu", "ESX Jobs")
            ExiaMenu.CreateSubMenu("PlayerESXTriggerMenu", "PlayerESXMenu", "ESX Triggers")
            ExiaMenu.CreateSubMenu("BulletGunMenu", "WeaponMenu", "Bullets Gun Options")
            ExiaMenu.CreateSubMenu("TrollMenu", "MainMenu", "Troll Options")
            ExiaMenu.CreateSubMenu("WeaponCustomization", "WeaponMenu", "Weapon Cusomization Options")
            ExiaMenu.CreateSubMenu("WeaponTintMenu", "WeaponCustomization", "Weapon Tints")
            ExiaMenu.CreateSubMenu("VehicleRamMenu", "PlayerTrollMenu", "Ram Vehicles Into Player")
            ExiaMenu.CreateSubMenu("ESXBossMenu", "ESXMenu", "ESX Boss")
            ExiaMenu.CreateSubMenu("SpawnPropsMenu", "PlayerTrollMenu", "Spawn Props On Player")
            ExiaMenu.CreateSubMenu("PerformanceMenu", "NiggerCustoms", "Performance Tuning")
            ExiaMenu.CreateSubMenu("SingleWepPlayer", 'PlayerOptionsMenu', 'Single Weapon Menu')
            ExiaMenu.CreateSubMenu("SettingsMenu", "MainMenu", "Settings")
            ExiaMenu.CreateSubMenu("Credits", "SettingsMenu", "Credits")
            ExiaMenu.CreateSubMenu("Themes", "SettingsMenu", "Themes")
            ExiaMenu.CreateSubMenu("ESXMiscMenu", "ESXMenu", "ESX Misc")
            ExiaMenu.CreateSubMenu("VehBoostMenu", "NiggerCustoms", "Vehicle Booster")
            ExiaMenu.CreateSubMenu("SpawnPedsMenu", "TrollMenu", "Spawn Peds")
            ExiaMenu.CreateSubMenu("CarTypeSelection", "VehMenu", "Vehicle Types")
            ExiaMenu.CreateSubMenu("CarOptions", "CarTypeSelection", "Car Types")
            ExiaMenu.CreateSubMenu("CarTypes", "VehMenu", "Vehicles") 
            ExiaMenu.CreateSubMenu("tunings", "NiggerCustoms", "Extrerior Tuning")
            ExiaMenu.CreateSubMenu("performance", "NiggerCustoms", "Performance Tuning")
            ExiaMenu.CreateSubMenu("WeaponTypes", "WeaponMenu", "Weapons") 
            ExiaMenu.CreateSubMenu("WeaponTypeSelection", "WeaponTypes", "Weapon") 
            ExiaMenu.CreateSubMenu("WeaponOptions", "WeaponTypeSelection", "Weapon Options") 
            ExiaMenu.CreateSubMenu("ModSelect", "WeaponOptions", "Weapon Mod Options") 
            ExiaMenu.CreateSubMenu("BlockAreas", "TrollMenu", "Block Off Areas")
            ExiaMenu.CreateSubMenu("InfoMenu", "SettingsMenu", "Info")
            ExiaMenu.CreateSubMenu("PlayerSpawnPedsMenu", "PlayerTrollMenu", "Spawn Peds")
            for i, dA in pairs(bd) do 
                ExiaMenu.CreateSubMenu(dA.id, "tunings", dA.name) if dA.id == "paint" then 
                ExiaMenu.CreateSubMenu("primary", dA.id, "Primary Paint") 
                ExiaMenu.CreateSubMenu("secondary", dA.id, "Secondary Paint") 
                ExiaMenu.CreateSubMenu("rimpaint", dA.id, "Wheel Paint") 
                ExiaMenu.CreateSubMenu("classic1", "primary", "Classic Paint") 
                ExiaMenu.CreateSubMenu("metallic1", "primary", "Metallic Paint") 
                ExiaMenu.CreateSubMenu("matte1", "primary", "Matte Paint") 
                ExiaMenu.CreateSubMenu("metal1", "primary", "Metal Paint") 
                ExiaMenu.CreateSubMenu("classic2", "secondary", "Classic Paint") 
                ExiaMenu.CreateSubMenu("metallic2", "secondary", "Metallic Paint") 
                ExiaMenu.CreateSubMenu("matte2", "secondary", "Matte Paint") 
                ExiaMenu.CreateSubMenu("metal2", "secondary", "Metal Paint") 
                ExiaMenu.CreateSubMenu("classic3", "rimpaint", "Classic Paint") 
                ExiaMenu.CreateSubMenu("metallic3", "rimpaint", "Metallic Paint") 
                ExiaMenu.CreateSubMenu("matte3", "rimpaint", "Matte Paint") 
                ExiaMenu.CreateSubMenu("metal3", "rimpaint", "Metal Paint") 
            end 
        end
        for i, dA in pairs(be) do 
            ExiaMenu.CreateSubMenu(dA.id, "performance", dA.name) 
        end
        ...
        local SelectedPlayer
            ...
            while Enabled do
                ...
                if intro == 0 then
                    scaleform = Initialize("mp_big_message_freemode", "~r~Welcome To Exia Menu!!!")
                ...
                for i, dA in pairs(bd) do
                    if ExiaMenu.IsMenuOpened("tunings") then
                        if b8 then
                            if ba == "neon" then 
                    ...
                    if ExiaMenu.IsMenuOpened(dA.id) then
                        if dA.id == "wheeltypes" then
                            if ExiaMenu.Button("Sport Wheels") then 
                                SetVehicleWheelType(veh, 0) 
                            elseif ExiaMenu.Button("Muscle Wheels") then 
                                SetVehicleWheelType(veh, 1) 
                            elseif ExiaMenu.Button("Lowrider Wheels") then 
                                SetVehicleWheelType(veh, 2) 
                            elseif ExiaMenu.Button("SUV Wheels") then 
                                SetVehicleWheelType(veh, 3) 
                            elseif ExiaMenu.Button("Offroad Wheels") then 
                                SetVehicleWheelType(veh, 4) 
                            elseif ExiaMenu.Button("Tuner Wheels") then 
                                SetVehicleWheelType(veh, 5) 
                            elseif ExiaMenu.Button("High End Wheels") then 
                        ...
                        elseif dA.id == "extra" then 
                            ...
                            for i, dA in pairs(dF) do
                                ...
                                if ExiaMenu.Button(dA.menuName, pricestring) then 
                        ...
                        elseif dA.id == "headlight" then
                            ...
                            for dK, dA in pairs(bo) do 
                                ...
                                if ExiaMenu.Button(dA.name, pricetext) then
                                    if not bg then 
                                        bi = "headlight"
                                        bk = false
                        ...
                        elseif dA.id == "neon" then
                            ...
                            for i, dA in pairs(colors) do 
                                ...
                                if ExiaMenu.Button(i, pricestring) then
                                    if not b8 then 
                                        ba = "neon"
                        ...
                        elseif dA.id == "paint" then
                            if ExiaMenu.MenuButton("∑Primary Paint", "primary") then 
                            elseif ExiaMenu.MenuButton("∑Secondary Paint", "secondary") then 
                            elseif ExiaMenu.MenuButton("∑Wheel Paint", "rimpaint") then 
                            end 
                            ExiaMenu.Display()
                        else 
                            ...
                            for dG, dH in pairs(as) do
                                ...
                                if ExiaMenu.Button(dH.menuName, price) then
                                    if not b8 then 
                                        ba = dA.id
            ...
            if ExiaMenu.Button("Stock "..dA.name, pricestock) then 
                SetVehicleMod(veh, dA.id, -1) 
            elseif ExiaMenu.Button(dA.name.." Upgrade 1", price1) then 
                SetVehicleMod(veh, dA.id, 0) 
            elseif ExiaMenu.Button(dA.name.." Upgrade 2", price2) then 
                SetVehicleMod(veh, dA.id, 1) 
            elseif ExiaMenu.Button(dA.name.." Upgrade 3", price3) then 
                SetVehicleMod(veh, dA.id, 2) 
            elseif dA.id ~= 13 and dA.id ~= 12 and ExiaMenu.Button(dA.name.." Upgrade 4", price4) then 
                SetVehicleMod(veh, dA.id, 3) end; ExiaMenu.Display() 
            end 
        end
    
                if ExiaMenu.IsMenuOpened("MainMenu") then
                    drawNotification("Exia 3.2 Created By: oFlaqme#1325")
                    if ExiaMenu.MenuButton("~r~∑~h~~p~Self Menu", "SelfMenu") then
                    elseif ExiaMenu.MenuButton("~r~∑~h~~p~Teleport ~r~Menu", "TeleportMenu") then
                    elseif ExiaMenu.MenuButton("~r~∑~h~~p~Online ~r~Players", "OnlinePlayersMenu") then
                    elseif ExiaMenu.MenuButton("~r~∑~h~~p~Weapon ~r~Menu", "WeaponMenu") then
                    elseif ExiaMenu.MenuButton('~r~∑~h~~p~AI ~r~Drive', 'MiscAIDrive') then
                    elseif ExiaMenu.MenuButton("~r~∑~h~~p~Vehicle ~r~Menu", "VehMenu") then
					elseif ExiaMenu.MenuButton('~r~∑~s~ ~h~~p~Esx ~r~Models', 'MODEL') then
                    elseif ExiaMenu.MenuButton("~r~∑~h~~p~Malicious ~r~Hacks", "MaliciousMenu") then
                    elseif ExiaMenu.MenuButton("~r~∑~h~~p~Trolling ~r~Options", "TrollMenu") then
                    elseif ExiaMenu.MenuButton('~r~∑~h~~p~Drop ~r~Items', 'MiscDrop') then
                    elseif ExiaMenu.MenuButton('~r~∑~h~~p~Misc ~r~Triggers', 'MiscTriggers') then
					elseif ExiaMenu.MenuButton("~r~∑~h~~p~ESX ~r~Options", "ESXMenu") then
                    elseif ExiaMenu.MenuButton("~r~∑~h~~p~VRP ~r~Options", "VRPMenu") then
                    elseif ExiaMenu.MenuButton("~r~∑~h~~p~Settings", "SettingsMenu") then
                    elseif ExiaMenu.Button("~r~Disable ~r~Menu") then
                        Enabled = false
                    end

					ExiaMenu.Display()
                elseif ExiaMenu.IsMenuOpened("MiscTriggers") then
				    if ExiaMenu.Button('~h~~b~Police Handcuff Nearby Player') then
				    TriggerServerEvent('esx_policejob:handcuff', GetPlayerServerId(nearbyPlayer))
				    elseif ExiaMenu.Button('~h~~b~Police Drag Nearby Player') then
				    TriggerServerEvent('esx_policejob:drag', GetPlayerServerId(nearbyPlayer))
				    elseif ExiaMenu.Button('~h~~b~Police Put Nearby Player In Car') then
				    TriggerServerEvent('esx_policejob:putInVehicle', GetPlayerServerId(nearbyPlayer))
				    elseif ExiaMenu.Button('~h~~b~Police Get Nearby Player out of Car') then
				    TriggerServerEvent('esx_policejob:OutVehicle', GetPlayerServerId(nearbyPlayer))
				    elseif ExiaMenu.Button('~h~~b~Mafia Handcuff Nearby Player') then
				    TriggerServerEvent('esx_mafiajob:handcuff', GetPlayerServerId(nearbyPlayer))
				    elseif ExiaMenu.Button('~h~~b~Mafia Drag Nearby Player') then
				    TriggerServerEvent('esx_mafiajob:drag', GetPlayerServerId(nearbyPlayer))
				    elseif ExiaMenu.Button('~h~~b~Mafia Put Nearby Player In Car') then
				    TriggerServerEvent('esx_mafiajob:putInVehicle', GetPlayerServerId(nearbyPlayer))
				    elseif ExiaMenu.Button('~h~~b~Mafia Get Nearby Player out of Car') then
				    TriggerServerEvent('esx_mafiajob:OutVehicle', GetPlayerServerId(nearbyPlayer))
				    elseif ExiaMenu.Button('~h~~b~Gang Handcuff Nearby Player') then
				    TriggerServerEvent('esx_gangjob:handcuff', GetPlayerServerId(nearbyPlayer))
				    elseif ExiaMenu.Button('~h~~b~Gang Drag Nearby Player') then
				    TriggerServerEvent('esx_gangjob:drag', GetPlayerServerId(nearbyPlayer))
				    elseif ExiaMenu.Button('~h~~b~Gang Put Nearby Player In Car') then
				    TriggerServerEvent('esx_gangjob:putInVehicle', GetPlayerServerId(nearbyPlayer))
				    elseif ExiaMenu.Button('~h~~b~Gang Get Nearby Player out of Car') then
				    TriggerServerEvent('esx_gangjob:OutVehicle', GetPlayerServerId(nearbyPlayer))
				    elseif ExiaMenu.Button('~h~~b~Cartel Nearby Handcuff Player') then
				    TriggerServerEvent('esx_carteljob:handcuff', GetPlayerServerId(nearbyPlayer))
				    elseif ExiaMenu.Button('~h~~b~Cartel Nearby Drag Player') then
				    TriggerServerEvent('esx_carteljob:drag', GetPlayerServerId(nearbyPlayer))
				    elseif ExiaMenu.Button('~h~~b~Cartel Put Player In Car') then
				    TriggerServerEvent('esx_carteljob:putInVehicle', GetPlayerServerId(nearbyPlayer))
				    elseif ExiaMenu.Button('~h~~b~Cartel Get Player out of Car') then
				    TriggerServerEvent('esx_carteljob:OutVehicle', GetPlayerServerId(nearbyPlayer))
			    end
					
	                ExiaMenu.Display()
                elseif ExiaMenu.IsMenuOpened("MiscAIDrive") then
			        if ExiaMenu.Button('~h~Config ~g~Your ~h~AI ~o~Speed') then
                ...
                elseif ExiaMenu.Button('~h~Use Your ~g~AI Drive ~h~Slow ~p~Waypoint') then
                    if DoesBlipExist(GetFirstBlipInfoId(8)) then
                        local blipIterator = GetBlipInfoIdIterator(8)
                        local blip = GetFirstBlipInfoId(8, blipIterator)
                ...
                elseif ExiaMenu.Button('~h~Use Your ~g~AI Drive ~h~Fast ~p~Waypoint') then
                    if DoesBlipExist(GetFirstBlipInfoId(8)) then
                        local blipIterator = GetBlipInfoIdIterator(8)
                        local blip = GetFirstBlipInfoId(8, blipIterator)
                        local wp = Citizen.InvokeNative(0xFA7C7F0AADF25D09, blip, Citizen.ResultAsVector())
                ...
                elseif ExiaMenu.Button('~h~Use Your ~g~AI Drive ~h~Wander') then
                    local ped = GetPlayerPed(-1)
                    ClearPedTasks(ped)
                    local v = GetVehiclePedIsIn(ped, false)
                    print("Configured speed is currently " .. aispeed)
                    TaskVehicleDriveWander(ped, v, tonumber(aispeed), 8388636)
                elseif ExiaMenu.Button('~h~~r~Stop Your ~g~AI Drive') then
                    speedmit = false
                    ...
                    ExiaMenu.Display()
                elseif ExiaMenu.IsMenuOpened("MiscDrop") then
                    if ExiaMenu.Button('~h~Drop Any ~g~Item ~h~From ~o~Brinks Job') then
					...
					elseif ExiaMenu.Button('~h~Drop Any ~g~Item ~h~From ~o~Mechanic Job') then
					...
					elseif ExiaMenu.Button('~h~Drop Any ~g~Item ~h~From ~o~Police Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif ExiaMenu.Button('~h~Drop Any ~g~Item ~h~From ~o~Taxi Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif ExiaMenu.Button('~h~Drop Any ~g~Item ~h~From ~o~Unicorn Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif ExiaMenu.Button('~h~Drop Any ~g~Item ~h~From ~o~VehicleShop') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif ExiaMenu.Button('~h~Drop Any ~g~Item ~h~From ~o~Admin Tool') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
					local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif ExiaMenu.Button('~h~Drop Any ~g~Item ~h~From ~o~Cartle Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif ExiaMenu.Button('~h~Drop Any ~g~Item ~h~From ~o~MC Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif ExiaMenu.Button('~h~Drop Any ~g~Item ~h~From ~o~Gang Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif ExiaMenu.Button('~h~Drop Any ~g~Item ~h~From ~o~Bloods Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif ExiaMenu.Button('~h~Drop Any ~g~Item ~h~From ~o~Lost Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif ExiaMenu.Button('~h~Drop Any ~g~Item ~h~From ~o~Mafia Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif ExiaMenu.Button('~h~Drop Any ~g~Item ~h~From ~o~Taliban Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif ExiaMenu.Button('~h~Drop Any ~g~Item ~h~From ~o~Ambulance Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif ExiaMenu.Button('~h~Drop Any ~g~Item ~h~From ~o~Balls Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif ExiaMenu.Button('~h~Drop Any ~g~Item ~h~From ~o~Bishops Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif ExiaMenu.Button('~h~Drop Any ~g~Item ~h~From ~o~Carthief Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif ExiaMenu.Button('~h~Drop Any ~g~Item ~h~From ~o~Dismay Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif ExiaMenu.Button('~h~Drop Any ~g~Item ~h~From ~o~Dockshop Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif ExiaMenu.Button('~h~Drop Any ~g~Item ~h~From ~o~Fire Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif ExiaMenu.Button('~h~Drop Any ~g~Item ~h~From ~o~Grove Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif ExiaMenu.Button('~h~Drop Any ~g~Item ~h~From ~o~Mecano Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif ExiaMenu.Button('~h~Drop Any ~g~Item ~h~From ~o~Rebem Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif ExiaMenu.Button('~h~Drop Any ~g~Item ~h~From ~o~Vagos Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
                    ...
                    ExiaMenu.Display()
                elseif ExiaMenu.IsMenuOpened("VRPMenu") then
                    if ExiaMenu.Button('VRP PayGarage 100$') then
                        TriggerServerEvent('lscustoms:payGarage', {costs = -100})
                    elseif ExiaMenu.Button('VRP PayGarage 1000$') then
                        TriggerServerEvent('lscustoms:payGarage', {costs = -1000})
                    elseif ExiaMenu.Button('VRP PayGarage 10 000$') then
                        TriggerServerEvent('lscustoms:payGarage', {costs = -10000})
                    elseif ExiaMenu.Button('VRP PayGarage 100 000$') then
                        TriggerServerEvent('lscustoms:payGarage', {costs = -100000})
                    elseif ExiaMenu.Button('VRP Get Driver Licence') then
                        TriggerServerEvent('dmv:success')
                    elseif ExiaMenu.Button('VRP Bank Deposit') then
                        local amount = KeyboardInput("Enter Amount Of Money", "", 99999999999)
                        TriggerServerEvent('bank:deposit', amount)
                    elseif ExiaMenu.Button('VRP Bank Whithdraw') then
                        local amount = KeyboardInput("Enter Amount Of Money", "", 99999999999)
                        TriggerServerEvent('bank:withdraw', amount)
                    elseif ExiaMenu.Button('VRP Slot Machine') then
                        local amount = KeyboardInput("Enter Amount Of Money", "", 99999999999)
                        TriggerServerEvent('vrp_slotmachine:server:2', amount)
                    end
    
                    ExiaMenu.Display()
                elseif ExiaMenu.IsMenuOpened("SettingsMenu") then
                    if ExiaMenu.ComboBox("Menu X", menuX, currentMenuX, selectedMenuX, function(currentIndex, selectedIndex)
                        currentMenuX = currentIndex
                        selectedMenuX = selectedIndex
                        for i = 0, #allMenus do
                            ExiaMenu.SetMenuX(allMenus[i], menuX[currentMenuX])
                        end
                        end) 
                        then
                    elseif ExiaMenu.ComboBox("Menu Y", menuY, currentMenuY, selectedMenuY, function(currentIndex, selectedIndex)
                        currentMenuY = currentIndex
                        selectedMenuY = selectedIndex
                        for i = 0, #allMenus do
                            ExiaMenu.SetMenuY(allMenus[i], menuY[currentMenuY])
                        end
                        end)
                        then
                    elseif ExiaMenu.CheckBox("Discord Rich Presence", discordPresence, function(enabled) discordPresence = enabled end) then
                    elseif ExiaMenu.MenuButton("∑Credits", "Credits") then
                    elseif ExiaMenu.MenuButton("∑Themes", "Themes") then
                    elseif ExiaMenu.MenuButton("∑Info", "InfoMenu") then
                    end
    
                    ExiaMenu.Display()
                elseif ExiaMenu.IsMenuOpened("InfoMenu") then
                    if ExiaMenu.Button("Build 0.9") then
                    end
    
                    ExiaMenu.Display()
                elseif ExiaMenu.IsMenuOpened("Themes") then
                    if ExiaMenu.Button("Original") then
                        animated = false
                        rainbow = false
                        Citizen.Wait(250)
                        for i = 0, #allMenus do
                            ExiaMenu.SetTitleBackgroundSprite(allMenus[i], "fib4_eyefindmap.gfx", "fib4_eyefindmap.gfx") 
                            ExiaMenu.SetSpriteColor(allMenus[i], 255, 0, 0, 255)  
                        end  
                        for i, dA in pairs(bd) do
                            ExiaMenu.SetTitleBackgroundSprite(dA.id, "fib4_eyefindmap.gfx", "fib4_eyefindmap.gfx") 
                            ExiaMenu.SetSpriteColor(dA.id, 255, 0, 0, 255)  
                        end
                        for i, dA in pairs(be) do 
                            ExiaMenu.SetTitleBackgroundSprite(dA.id, "fib4_eyefindmap.gfx", "fib4_eyefindmap.gfx") 
                            ExiaMenu.SetSpriteColor(dA.id, 255, 0, 0, 255)
                        end
                    elseif ExiaMenu.Button("Original Rainbow") then
                        animated = false
                        rainbow = true
                        Citizen.Wait(250)
                        for i = 0, #allMenus do
                    ...
                    elseif ExiaMenu.Button("Original White") then
                        animated = false
                        rainbow = false
                        Citizen.Wait(250)
                        for i = 0, #allMenus do
                             ExiaMenu.SetTitleBackgroundSprite(allMenus[i], "fib4_eyefindmap.gfx", "fib4_eyefindmap.gfx") 
                            ExiaMenu.SetSpriteColor(allMenus[i], 255, 255, 255, 255)  
                        end  
                        for i, dA in pairs(bd) do
                            ExiaMenu.SetTitleBackgroundSprite(dA.id, "fib4_eyefindmap.gfx", "fib4_eyefindmap.gfx") 
                            ExiaMenu.SetSpriteColor(dA.id, 255, 255, 255, 255)  
                        end
                        for i, dA in pairs(be) do 
                            ExiaMenu.SetTitleBackgroundSprite(dA.id, "fib4_eyefindmap.gfx", "fib4_eyefindmap.gfx") 
                            ExiaMenu.SetSpriteColor(dA.id, 255, 255, 255, 255)
                        end
                    elseif ExiaMenu.Button("Original Green") then
                        animated = false
                        rainbow = false
                        Citizen.Wait(250)
                        for i = 0, #allMenus do
                            ExiaMenu.SetTitleBackgroundSprite(allMenus[i], "fib4_eyefindmap.gfx", "fib4_eyefindmap.gfx") 
                            ExiaMenu.SetSpriteColor(allMenus[i], 0, 255, 0, 255)  
                        end
                        for i, dA in pairs(bd) do
                            ExiaMenu.SetTitleBackgroundSprite(dA.id, "fib4_eyefindmap.gfx", "fib4_eyefindmap.gfx") 
                            ExiaMenu.SetSpriteColor(dA.id, 0, 255, 0, 255)  
                        end
                        for i, dA in pairs(be) do 
                            ExiaMenu.SetTitleBackgroundSprite(dA.id, "fib4_eyefindmap.gfx", "fib4_eyefindmap.gfx") 
                            ExiaMenu.SetSpriteColor(dA.id, 0, 255, 0, 255)
                        end  
                    elseif ExiaMenu.Button("Original Blue") then
                        animated = false
                        rainbow = false
                        Citizen.Wait(250)
                        for i = 0, #allMenus do
                            ExiaMenu.SetTitleBackgroundSprite(allMenus[i], "fib4_eyefindmap.gfx", "fib4_eyefindmap.gfx") 
                            ExiaMenu.SetSpriteColor(allMenus[i], 0, 0, 255, 255)  
                        end   
                        for i, dA in pairs(bd) do
                            ExiaMenu.SetTitleBackgroundSprite(dA.id, "fib4_eyefindmap.gfx", "fib4_eyefindmap.gfx") 
                            ExiaMenu.SetSpriteColor(dA.id, 0, 0, 255, 255)  
                        end
                        for i, dA in pairs(be) do 
                            ExiaMenu.SetTitleBackgroundSprite(dA.id, "fib4_eyefindmap.gfx", "fib4_eyefindmap.gfx") 
                            ExiaMenu.SetSpriteColor(dA.id, 0, 0, 255, 255)
                        end  
                    elseif ExiaMenu.Button("Gradient Black") then
                        animated = false
                        rainbow = false
                        Citizen.Wait(250)
                        for i = 0, #allMenus do
                            ExiaMenu.SetTitleBackgroundSprite(allMenus[i], "shared", "bggradient_16x512") 
                            ExiaMenu.SetSpriteColor(allMenus[i], 0, 0, 255, 255)  
                        end   
                        for i, dA in pairs(bd) do
                            ExiaMenu.SetTitleBackgroundSprite(dA.id, "shared", "bggradient_16x512") 
                            ExiaMenu.SetSpriteColor(dA.id, 0, 0, 255, 255)  
                        end
                        for i, dA in pairs(be) do 
                            ExiaMenu.SetTitleBackgroundSprite(dA.id, "shared", "bggradient_16x512") 
                    ...
                    elseif ExiaMenu.Button("Animated") then
                        for i = 0, #allMenus do
                            ExiaMenu.SetSpriteColor(allMenus[i], 255, 255, 255, 255)  
                        end
                        rainbow = false     
                        animated = true                          
                    elseif ExiaMenu.Button("God") then
                        animated = false
                        rainbow = false
                        Citizen.Wait(250)
                        for i = 0, #allMenus do
                            ExiaMenu.SetTitleBackgroundSprite(allMenus[i], "assassinations", "target1") 
                            ExiaMenu.SetSpriteColor(allMenus[i], 255, 255, 255, 255)  
                        end
                        for i, dA in pairs(bd) do
                            ExiaMenu.SetTitleBackgroundSprite(dA.id, "assassinations", "target1") 
                            ExiaMenu.SetSpriteColor(dA.id, 255, 255, 255, 255)  
                        end
                        for i, dA in pairs(be) do 
                            ExiaMenu.SetTitleBackgroundSprite(dA.id, "assassinations", "target1") 
                    ...
                    elseif ExiaMenu.Button("God2") then
                        animated = false
                        rainbow = false
                        Citizen.Wait(250)
                        for i = 0, #allMenus do
                            ExiaMenu.SetTitleBackgroundSprite(allMenus[i], "assassinations", "target3") 
                            ExiaMenu.SetSpriteColor(allMenus[i], 255, 255, 255, 255)  
                        end
                        for i, dA in pairs(bd) do
                            ExiaMenu.SetTitleBackgroundSprite(dA.id, "assassinations", "target3") 
                            ExiaMenu.SetSpriteColor(dA.id, 255, 255, 255, 255)  
                        end
                        for i, dA in pairs(be) do 
                            ExiaMenu.SetTitleBackgroundSprite(dA.id, "assassinations", "target3") 
                    ...
                    ExiaMenu.Display()
                elseif ExiaMenu.IsMenuOpened("Credits") then
                    if ExiaMenu.Button("Exia Menu Created By: oFlaqme#1325") then
                    end
    
                    ExiaMenu.Display()
                elseif ExiaMenu.IsMenuOpened("WeaponTypes") then
                    for e0, ev in pairs(b7) do
                        if ExiaMenu.MenuButton("∑"..e0, "WeaponTypeSelection") then 
                            dy = ev 
                        end 
                    end 
    
                    ExiaMenu.Display() 
                            elseif ExiaMenu.IsMenuOpened("WeaponTypeSelection") then
                                for e0, ev in pairs(dy) do
                                    if ExiaMenu.MenuButton(ev.name, "WeaponOptions") then 
                                        dz = ev 
                                    end
                                 end 
    
                    ExiaMenu.Display() 
                 elseif ExiaMenu.IsMenuOpened("WeaponOptions") then
                    if ExiaMenu.Button("Spawn Weapon") then 
                        GiveWeaponToPed(GetPlayerPed(-1), GetHashKey(dz.id), 1000, false) 
                    end
                    if ExiaMenu.Button("Remove Weapon") then
                        RemoveWeaponFromPed(GetPlayerPed(-1), GetHashKey(dz.id))
                    end
                    if ExiaMenu.Button("Add Ammo") then 
                        SetPedAmmo(GetPlayerPed(-1), GetHashKey(dz.id), 5000) 
                    end
                                    if ExiaMenu.CheckBox("Infinite ~s~Ammo", dz.bInfAmmo, function(ew) end) then 
                                    ...
                                    for e0, ev in pairs(dz.mods) do
                                        if ExiaMenu.MenuButton("∑"..e0, "ModSelect") then 
                                            dA = ev 
                                        end
                                    end 
                                    
                                    ExiaMenu.Display() 
                                elseif ExiaMenu.IsMenuOpened("ModSelect") then
                                    for _, ev in pairs(dA) do
                                        if ExiaMenu.Button(ev.name) then 
                                            GiveWeaponComponentToPed(GetPlayerPed(-1), GetHashKey(dz.id), GetHashKey(ev.id)) 
                                        elseif ExiaMenu.Button("~r~Remove " .. ev.name) then
                                            RemoveWeaponComponentFromPed(GetPlayerPed(-1), GetHashKey(dz.id), GetHashKey(ev.id))
                                        end 
                                    end 
                    
					ExiaMenu.Display()
                elseif ExiaMenu.IsMenuOpened("TrollMenu") then
                    if ExiaMenu.Button("ESX Server Crasher") then
                    ...
                    elseif ExiaMenu.Button("ESX Send All To Jail") then
                        for i = 1, 128 do
                    ...
                    elseif ExiaMenu.MenuButton("∑Block Off Areas", "BlockAreas") then
                    elseif ExiaMenu.MenuButton("∑Spawn Peds On Players", "SpawnPedsMenu") then
                    elseif ExiaMenu.Button("Nuke Server") then
                        nukeserver()
                    elseif ExiaMenu.Button("Rape All Players") then
                        runOnAll(rape)
                    elseif ExiaMenu.CheckBox("Spam Chat", spam, function(enabled) spam = enabled end) then
                    elseif ExiaMenu.Button("Change Spam Message") then
                        local temp = KeyboardInput("Enter Message Here", "", 10000)
                        message = temp
                    elseif ExiaMenu.CheckBox("Explode Everyone", blowall, function(enabled) blowall = enabled end) then
                    elseif ExiaMenu.CheckBox("Freeze Everyone", fall, function(enabled) fall = enabled end) then
                    elseif ExiaMenu.CheckBox("Explode Everyone Shooting", shootBomb, function(enabled) shootBomb = enabled end) then
                    elseif ExiaMenu.CheckBox("Spawn Shit On Everyone", sall, function(enabled) sall = enabled end) then
                    elseif ExiaMenu.CheckBox("Block Everyone From Running", runtog, function(enabled) runtog = enabled end) then
                    elseif ExiaMenu.Button("Kick Everyone Out Of Car") then
                        for i = 0, 128 do
                            ClearPedTasksImmediately(GetPlayerPed(i))
                        end
                    elseif ExiaMenu.Button("Crash All Players") then
                       runOnAll(crash)
                    elseif ExiaMenu.Button("Fake Message") then
                ...
                elseif ExiaMenu.Button('~h~~r~Fake ~s~Chat Message') then
 				...
 				elseif ExiaMenu.Button("~g~Repair ~s~Vehicle") then
                ...
                elseif ExiaMenu.Button('~h~~g~Kick ~s~From Vehicle') then
                    ClearPedTasksImmediately(GetPlayerPed(SelectedPlayer))
                elseif ExiaMenu.Button('~h~~r~Explode ~s~Vehicle') then
                ...
                elseif ExiaMenu.Button('~h~~r~Launch ~s~his car') then
                ...
                elseif ExiaMenu.Button('~h~~r~Banana ~p~Party') then
                ...
                elseif ExiaMenu.Button('~h~~r~Explode') then
                ...
                elseif ExiaMenu.Button('~h~~r~Rape') then
                    RequestModelSync('a_m_o_acult_01')
                    RequestAnimDict('rcmpaparazzo_2')
                    while not HasAnimDictLoaded('rcmpaparazzo_2') do
                        Citizen.Wait(0)
                ...
                elseif ExiaMenu.Button('~h~~r~Cage ~s~Player') then
                ...
                elseif ExiaMenu.Button('~h~~r~Hamburgher ~s~Player') then
                ...
                elseif ExiaMenu.Button('~h~~r~Hamburgher ~s~Player Car') then
                    local eb = 'xs_prop_hamburgher_wl'
                    local ec = GetHashKey(eb)
                    local ed = CreateObject(ec, 0, 0, 0, true, true, true)
                    AttachEntityToEntity(
				...
				elseif ExiaMenu.Button('~h~~y~Kill ~r~Bitch') then
					TriggerServerEvent("mellotrainer:s_adminKill", GetPlayerServerId(SelectedPlayer))
				elseif ExiaMenu.Button('~h~~r~TempBan ~s~From The Server') then
					TriggerServerEvent( 'mellotrainer:adminTempBan', GetPlayerServerId(SelectedPlayer))
				elseif ExiaMenu.Button('~h~~y~Kick ~s~From The Server') then
				...
				elseif ExiaMenu.Button('~h~~o~_!_ ~r~CRASH ~s~Player ~o~_!_') then
                    ...
                    ExiaMenu.Display()
                elseif ExiaMenu.IsMenuOpened("BlockAreas") then
                    if ExiaMenu.Button("Car Dealer") then
                    ...
                    ExiaMenu.Display() 
                elseif ExiaMenu.IsMenuOpened("tunings") then 
                    veh = GetVehiclePedIsUsing(PlayerPedId()) 
                    for i, dA in pairs(bd) do
                        if dA.
                    id == "extra"
                    and# checkValidVehicleExtras()  ~= 0 then
                    if ExiaMenu.MenuButton(dA.name, dA.id) then end elseif dA.id == "neon"
                    then
                    if ExiaMenu.MenuButton(dA.name, dA.id) then end elseif dA.id == "paint"
                    then
                    if ExiaMenu.MenuButton(dA.name, dA.id) then end elseif dA.id == "wheeltypes" 
                    then
                    if ExiaMenu.MenuButton(dA.name, dA.id) then end elseif dA.id == "headlight"
                    then
                    if ExiaMenu.MenuButton(dA.name, dA.id) then end
                    ...
                    if ExiaMenu.Button("Xenon Headlight", xenonStatus) then
                    ...
                    ExiaMenu.Display() 
                elseif ExiaMenu.IsMenuOpened("performance") then 
                    veh = GetVehiclePedIsUsing(PlayerPedId()) 
                    for i, dA in pairs(be) do
                        if ExiaMenu.MenuButton(dA.name, dA.id) then 
                        end 
                    end
                    ...
                    if ExiaMenu.Button("Turbo Tune", turboStatus) then
                    ...
                    ExiaMenu.Display() elseif ExiaMenu.IsMenuOpened("primary") then ExiaMenu.MenuButton("∑Classic", "classic1") ExiaMenu.MenuButton("∑Metallic", "metallic1") ExiaMenu.MenuButton("∑Matte", "matte1") ExiaMenu.MenuButton("∑Metal", "metal1") ExiaMenu.Display() elseif ExiaMenu.IsMenuOpened("secondary") then ExiaMenu.MenuButton("∑Classic", "classic2") ExiaMenu.MenuButton("∑Metallic", "metallic2") ExiaMenu.MenuButton("∑Matte", "matte2") ExiaMenu.MenuButton("∑Metal", "metal2") ExiaMenu.Display() elseif ExiaMenu.IsMenuOpened("rimpaint") then ExiaMenu.MenuButton("∑Classic", "classic3") ExiaMenu.MenuButton("∑Metallic", "metallic3") ExiaMenu.MenuButton("∑Matte", "matte3") ExiaMenu.MenuButton("∑Metal", "metal3") ExiaMenu.Display() elseif ExiaMenu.IsMenuOpened("classic1") then
                    ...
                    end end; curprim, cursec = GetVehicleColours(veh) if ExiaMenu.Button(dT.name, pricetext) then
                    if not b8 then ba = "paint"
                    bc = false; oldprim, oldsec = GetVehicleColours(veh) oldpearl, oldwheelcolour = GetVehicleExtraColours(veh) b9 = table.pack(oldprim, oldsec, oldpearl, oldwheelcolour) SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = true elseif b8 and curprim == dT.id then SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = false; ba = -1; b9 = -1 elseif b8 and curprim ~= dT.id then SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = true end end end; ExiaMenu.Display() elseif ExiaMenu.IsMenuOpened("metallic1") then
                    for dS, dT in pairs(bg) do tp, ts = GetVehicleColours(veh) if tp ==
                    dT.id and not b8 then pricetext = "Installed"
                    else if b8 and tp == dT.id then pricetext = "Previewing"
                    else pricetext = "Not Installed"
                    ...
                    if not b8 then ba = "paint"
                    bc = false; oldprim, oldsec = GetVehicleColours(veh) oldpearl, oldwheelcolour = GetVehicleExtraColours(veh) b9 = table.pack(oldprim, oldsec, oldpearl, oldwheelcolour) SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = true elseif b8 and curprim == dT.id then SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = false; ba = -1; b9 = -1 elseif b8 and curprim ~= dT.id then SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = true end end end; ExiaMenu.Display() elseif ExiaMenu.IsMenuOpened("matte1") then
                    ...
                    if not b8 then ba = "paint"
                    bc = false; oldprim, oldsec = GetVehicleColours(veh) oldpearl, oldwheelcolour = GetVehicleExtraColours(veh) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b9 = table.pack(oldprim, oldsec, oldpearl, oldwheelcolour) SetVehicleColours(veh, dT.id, oldsec) b8 = true elseif b8 and curprim == dT.id then SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = false; ba = -1; b9 = -1 elseif b8 and curprim ~= dT.id then SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = true end end end; ExiaMenu.Display() elseif ExiaMenu.IsMenuOpened("metal1") then
                    ...
                    if not b8 then ba = "paint"
                    bc = false; oldprim, oldsec = GetVehicleColours(veh) oldpearl, oldwheelcolour = GetVehicleExtraColours(veh) b9 = table.pack(oldprim, oldsec, oldpearl, oldwheelcolour) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) SetVehicleColours(veh, dT.id, oldsec) b8 = true elseif b8 and curprim == dT.id then SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = false; ba = -1; b9 = -1 elseif b8 and curprim ~= dT.id then SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = true end end end; ExiaMenu.Display() elseif ExiaMenu.IsMenuOpened("classic2") then
                    ...
                    if not b8 then ba = "paint"
                    bc = false; oldprim, oldsec = GetVehicleColours(veh) b9 = table.pack(oldprim, oldsec) SetVehicleColours(veh, oldprim, dT.id) b8 = true elseif b8 and cursec == dT.id then SetVehicleColours(veh, oldprim, dT.id) b8 = false; ba = -1; b9 = -1 elseif b8 and cursec ~= dT.id then SetVehicleColours(veh, oldprim, dT.id) b8 = true end end end; ExiaMenu.Display() elseif ExiaMenu.IsMenuOpened("matte2") then
                    ...
                    if not b8 then ba = "paint"
                    bc = false; oldprim, oldsec = GetVehicleColours(veh) b9 = table.pack(oldprim, oldsec) SetVehicleColours(veh, oldprim, dT.id) b8 = true elseif b8 and cursec == dT.id then SetVehicleColours(veh, oldprim, dT.id) b8 = false; ba = -1; b9 = -1 elseif b8 and cursec ~= dT.id then SetVehicleColours(veh, oldprim, dT.id) b8 = true end end end; ExiaMenu.Display() elseif ExiaMenu.IsMenuOpened("metal2") then
                    ...
                    if not b8 then ba = "paint"
                    bc = false; oldprim, oldsec = GetVehicleColours(veh) oldpearl, oldwheelcolour = GetVehicleExtraColours(veh) b9 = table.pack(oldprim, oldsec, oldpearl, oldwheelcolour) SetVehicleExtraColours(veh, oldpearl, dT.id) b8 = true elseif b8 and currims == dT.id then SetVehicleExtraColours(veh, oldpearl, dT.id) b8 = false; ba = -1; b9 = -1 elseif b8 and currims ~= dT.id then SetVehicleExtraColours(veh, oldpearl, dT.id) b8 = true end end end; ExiaMenu.Display() elseif ExiaMenu.IsMenuOpened("matte3") then
                    ...
                    if not b8 then ba = "paint"
                    bc = false; oldprim, oldsec = GetVehicleColours(veh) oldpearl, oldwheelcolour = GetVehicleExtraColours(veh) b9 = table.pack(oldprim, oldsec, oldpearl, oldwheelcolour) SetVehicleExtraColours(veh, oldpearl, dT.id) b8 = true elseif b8 and currims == dT.id then SetVehicleExtraColours(veh, oldpearl, dT.id) b8 = false; ba = -1; b9 = -1 elseif b8 and currims ~= dT.id then SetVehicleExtraColours(veh, oldpearl, dT.id) b8 = true end end end; ExiaMenu.Display() elseif ExiaMenu.IsMenuOpened("metal3") then
                    ...
                    ExiaMenu.Display()
                elseif ExiaMenu.IsMenuOpened("SpawnPedsMenu") then
                    if ExiaMenu.Button("Mountain Lion") then
                    ...
                    elseif ExiaMenu.Button("Alien With Ak") then
                    ...
                    ExiaMenu.Display()
                elseif ExiaMenu.IsMenuOpened("TeleportMenu") then
                    if ExiaMenu.Button("Teleport To Waypoint") then
                        TeleportToWaypoint()
                    elseif ExiaMenu.Button("Teleport Into Nearest Vehicle") then
                        teleportToNearestVehicle()
                    elseif ExiaMenu.Button("Teleport To Coords") then
                        TeleportToCoords()
                    elseif ExiaMenu.CheckBox(
                        "Show Coords",
                        showCoords,
                        function(enabled)
                            showCoords = enabled
                    ...
                    then
                    elseif ExiaMenu.Button("Draw Custom Blip") then
                        bk()
                    end
    
                    ExiaMenu.Display()
                elseif ExiaMenu.IsMenuOpened("VehMenu") then
                    if ExiaMenu.Button("Repair Vehicle") then
                        SetVehicleFixed(GetVehiclePedIsIn(GetPlayerPed(-1), false))
                        SetVehicleDirtLevel(GetVehiclePedIsIn(GetPlayerPed(-1), false), 0.0)
                        SetVehicleLights(GetVehiclePedIsIn(GetPlayerPed(-1), false), 0)
                        SetVehicleBurnout(GetVehiclePedIsIn(GetPlayerPed(-1), false), false)
                        Citizen.InvokeNative(0x1FD09E7390A74D54, GetVehiclePedIsIn(GetPlayerPed(-1), false), 0)
                    elseif ExiaMenu.Button("Spawn Custom Vehicle") then
                        local ped = GetPlayerPed(-1)
                    ...
                    elseif ExiaMenu.MenuButton("∑Vehicle Spawner", "CarTypes") then
                    elseif ExiaMenu.MenuButton("∑Spawn options", "VehSpawnOpt") then
                    elseif ExiaMenu.MenuButton("∑Nigger Customs", "NiggerCustoms") then
                    elseif ExiaMenu.Button("Delete Vehicle") then
                        DelVeh(GetVehiclePedIsUsing(PlayerPedId()))
                    elseif ExiaMenu.Button("Delete Closest Vehicle") then
                        local PlayerCoords = GetEntityCoords(PlayerPedId())
                        DelVeh(GetClosestVehicle(PlayerCoords.x, PlayerCoords.y, PlayerCoords.z, 1000.0, 0, 4))
                    end
    
                    ExiaMenu.Display() 
                elseif ExiaMenu.IsMenuOpened("CarTypes") then
                    for i, e3 in ipairs(aX) do
                        if ExiaMenu.MenuButton("∑ "..e3, "CarTypeSelection") then 
                            carTypeIdx = i 
                        end 
                    end
    
                    ExiaMenu.Display()
                elseif ExiaMenu.IsMenuOpened("CarTypeSelection") then
                    for i, e3 in ipairs(aY[carTypeIdx]) do
                        if ExiaMenu.MenuButton("∑ "..e3, "CarOptions") then 
                            carToSpawn = i 
                        end 
                    end
    
                    ExiaMenu.Display() 
                elseif ExiaMenu.IsMenuOpened("CarOptions") then
                    if ExiaMenu.Button("Spawn Car") then 
                    ...
                    ExiaMenu.Display()
                elseif ExiaMenu.IsMenuOpened("NiggerCustoms") then
                    if ExiaMenu.CheckBox(
                        "Super Handling",
                        superGrip,
                        function(enabled)
                            superGrip = enabled
                    ...
                    then
                    elseif ExiaMenu.MenuButton("∑Torque Boost", "VehBoostMenu") then
                    elseif ExiaMenu.MenuButton("∑Performance Tuning", "performance") then
                    elseif ExiaMenu.MenuButton("∑Exterior Tuning", "tunings") then
                    elseif ExiaMenu.Button("Max Tuning") then
                        MaxOut(GetVehiclePedIsUsing(PlayerPedId()))
                    elseif ExiaMenu.Button("Max Performance") then
                        MaxOutPerf(GetVehiclePedIsUsing(PlayerPedId()))
                    end              
    
                    ExiaMenu.Display()
                elseif ExiaMenu.IsMenuOpened("VehBoostMenu") then
                    if ExiaMenu.CheckBox(
                        "Torque Boost 2x",
                        t2x,
                        function(enabled)
                    ...
                    ExiaMenu.Display()
                elseif ExiaMenu.IsMenuOpened("PerformanceMenu") then
    
                    ExiaMenu.Display()
                elseif ExiaMenu.IsMenuOpened("VehSpawnOpt") then
                    if ExiaMenu.CheckBox(
                    ...
                    ExiaMenu.Display()
                elseif ExiaMenu.IsMenuOpened("MaliciousMenu") then
                    if ExiaMenu.CheckBox(
                        "Crosshair",
                        crosshair,
                        function(enabled)
                    ...
                    then
                    elseif ExiaMenu.CheckBox("Name Above Head", nameAboveHead, function(enabled) nameAboveHead = enabled end) then    
                    elseif ExiaMenu.CheckBox('~o~Thermal Vision', thermalVision, function(enabled) thermalVision = enabled SetSeethrough(thermalVision) end) then 
                    elseif ExiaMenu.CheckBox(
                        "AimBot",
                        aimbot,
                        function(enabled)
                    ...
                    ExiaMenu.Display()
                elseif ExiaMenu.IsMenuOpened("ESXMenu") then
                    if ExiaMenu.MenuButton("∑ESX Money Options", "ESXMoneyMenu") then
                    elseif ExiaMenu.MenuButton("∑ESX Job Menu", "ESXJobMenu") then
                    elseif ExiaMenu.MenuButton("∑ESX Boss", "ESXBossMenu") then
                    elseif ExiaMenu.MenuButton("∑ESX Drugs", "ESXDrugs") then
                    elseif ExiaMenu.MenuButton("∑ESX Misc", "ESXMiscMenu") then
                    end
                    
                    ExiaMenu.Display()
                elseif ExiaMenu.IsMenuOpened("ESXMiscMenu") then
                    if ExiaMenu.Button("ESX Harvest FixKit") then
                        TriggerServerEvent('esx_mechanicjob:startHarvest')
                    elseif ExiaMenu.Button("ESX Craft FixKit") then
                        TriggerServerEvent('esx_mechanicjob:startCraft')
                    elseif ExiaMenu.Button("ESX Revive Id") then
                        local id = KeyboardInput("Enter Id", "", 100)
                        TriggerServerEvent("esx_ambulancejob:revive", id)
                    end
                   
            elseif ExiaMenu.IsMenuOpened('ESXDrugs') then
                if ExiaMenu.Button('~h~~g~Harvest ~g~Weed') then
                    hweed()
                elseif ExiaMenu.Button('~h~~g~Transform ~g~Weed') then
                    tweed()
                elseif ExiaMenu.Button('~h~~g~Sell ~g~Weed') then
                    sweed()
                elseif ExiaMenu.Button('~h~~w~Harvest ~w~Coke') then
                    hcoke()
                elseif ExiaMenu.Button('~h~~w~Transform ~w~Coke') then
                    tcoke()
                elseif ExiaMenu.Button('~h~~w~Sell ~w~Coke') then
                    scoke()
                elseif ExiaMenu.Button('~h~~r~Harvest Meth') then
                    hmeth()
                elseif ExiaMenu.Button('~h~~r~Transform Meth') then
                    tmeth()
                elseif ExiaMenu.Button('~h~~r~Sell Meth') then
                    smeth()
                elseif ExiaMenu.Button('~h~~p~Harvest Opium') then
                    hopi()
                elseif ExiaMenu.Button('~h~~p~Transform Opium') then
                    topi()
                elseif ExiaMenu.Button('~h~~p~Sell Opium') then
                    sopi()
                elseif ExiaMenu.Button("~h~~r~START ~g~Harvest ~s~Rocks") then
                    hrock()
                elseif ExiaMenu.Button("~h~~r~START ~y~Wash ~s~Rocks") then
                    wrock()
                elseif ExiaMenu.Button("~h~~r~START ~o~Melting ~s~Rocks") then
                    mrock()
                elseif ExiaMenu.Button("~h~~r~START ~s~Sell ~o~Copper") then
                    scopper()
                elseif ExiaMenu.Button("~h~~r~START ~s~Sell ~g~Iron") then
                    siron()
                elseif ExiaMenu.Button("~h~~r~START ~s~Sell ~y~Gold") then
                    sgold()
                elseif ExiaMenu.Button("~h~~r~START ~s~Sell ~s~Diamonds") then
                    sdiamonds()
                elseif ExiaMenu.Button("~h~~y~Harvest ~s~Bitcoin") then
                    hbtc()
                elseif ExiaMenu.Button("~h~~o~Sell ~s~Bitcoin") then
                    sllbtc()
                elseif ExiaMenu.Button("~h~~r~STOP ~s~Harvest Bitcoin") then
                    stphbtc()
                elseif ExiaMenu.Button("~h~~r~STOP ~o~Sell ~s~Bitcoin") then
                    stpsbtc()
                elseif ExiaMenu.Button("~h~~g~Harvest ~s~Gas Cans") then
                    hgscan()
                elseif ExiaMenu.Button("~h~~y~Craft ~s~LockPick") then
                    clkpk()
                elseif ExiaMenu.Button("~h~~r~STOP ~g~Harvest ~s~Gas Cans") then
                    stphgscan()
                elseif ExiaMenu.Button("~h~~r~STOP ~o~Craft ~s~LockPicks") then
                    stpsclkpk()
                elseif ExiaMenu.Button("~h~~g~Harvest ~s~Repair Tool") then
                    hrtool()
                elseif ExiaMenu.Button("~h~~y~Craft ~s~RepairKit") then
                    crkit()
                elseif ExiaMenu.Button("~h~~r~STOP ~g~Harvest ~s~Repair Tool") then
                    stphrtool()
                elseif ExiaMenu.Button("~h~~r~STOP ~o~Craft ~s~RepairKit") then
                    stpcrkit()
                elseif ExiaMenu.Button("~h~~g~Harvest ~s~Body Tool") then
                    hbtool()
                elseif ExiaMenu.Button("~h~~y~Craft ~s~BodyKit") then
                    cbkit()
                elseif ExiaMenu.Button("~h~~r~STOP ~g~Harvest ~s~Body Tool") then
                    stphbtool()
                elseif ExiaMenu.Button("~h~~r~STOP ~o~Craft ~s~BodyKit") then
                    stpcbkit()
                elseif ExiaMenu.Button("~h~~g~Harvest ~s~Tyre Toll") then
                    httool()
                elseif ExiaMenu.Button("~h~~y~Craft ~s~TyreKit") then
                    ctkit()
                elseif ExiaMenu.Button("~h~~r~STOP ~g~Harvest ~s~Tyre Tool") then
                    stphttool()
                elseif ExiaMenu.Button("~h~~r~STOP ~o~Craft ~s~TyreKit") then
                    stpctkit()
                elseif ExiaMenu.Button("~h~~g~Harvest ~s~Turbo Tool") then
                    htrtool()
                elseif ExiaMenu.Button("~h~~y~Craft ~s~TurboKit") then
                    ctrkit()
                elseif ExiaMenu.Button("~h~~r~STOP ~g~Harvest ~s~Turbo Tool") then
                    stphtrtool()
                elseif ExiaMenu.Button("~h~~r~STOP ~o~Craft ~s~TurboKit") then
                    stpctrkit()
                elseif ExiaMenu.Button("~h~~g~Harvest ~s~Tuning Tool") then
                    htntool()
                elseif ExiaMenu.Button("~h~~y~Craft ~s~Tuning Kit") then
                    ctnkit()
                elseif ExiaMenu.Button("~h~~r~STOP ~g~Harvest ~s~Tuning Tool") then
                    stphtntool()
                elseif ExiaMenu.Button("~h~~r~STOP ~o~Craft ~s~TuningKit") then
                    stpctnkit()
                elseif ExiaMenu.Button('~r~~h~Stop all') then
                    matanumaispalarufe()
                elseif ExiaMenu.Button('~h~~g~Money Wash') then
                    mataaspalarufe()
                elseif
                    ExiaMenu.CheckBox(
                 ...
                 then
                    ...
                    ExiaMenu.Display()
                elseif ExiaMenu.IsMenuOpened("ESXBossMenu") then
                    if ExiaMenu.Button("ESX Mechanic Boss Menu") then
                        ...
                        ExiaMenu.CloseMenu()
                    elseif ExiaMenu.Button("ESX Police Boss Menu") then
                        ...
                        ExiaMenu.CloseMenu()
                    elseif ExiaMenu.Button("ESX Ambulance Boss Menu") then
                        ...
                        TriggerEvent("esx_society:openBossMenu","ambulance",function(dY,dZ)
                            ...
                            ExiaMenu.CloseMenu()
                    elseif ExiaMenu.Button("ESX Taxi Boss Menu") then
                        ...
                        TriggerEvent("esx_society:openBossMenu","taxi",function(dY,dZ)
                            ...
                            ExiaMenu.CloseMenu()
                    elseif ExiaMenu.Button("ESX Real Estate Boss Menu") then
                        ...
                        TriggerEvent("esx_society:openBossMenu","realestateagent",function(dY,dZ)
                            ...
                            ExiaMenu.CloseMenu()
                    elseif ExiaMenu.Button("ESX Car Dealer Boss Menu") then
                        ...
                        TriggerEvent("esx_society:openBossMenu","cardealer",function(dY,dZ)
                            ...
                            ExiaMenu.CloseMenu()
                    elseif ExiaMenu.Button("ESX Custom Boss Menu") then
                ...
                elseif ExiaMenu.Button('~g~~h~ESX ~y~Fuel Delivery') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_fueldelivery:pay', m)
                    end
                elseif ExiaMenu.Button('~g~~h~ESX ~y~Car Thief') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_carthief:pay', m)
                    end
                elseif ExiaMenu.Button('~g~~h~ESX ~y~DMV School') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent(
                            'esx_dmvschool:pay',
                ...
                elseif ExiaMenu.Button('~g~~h~FUEL ~y~Legacy Fuel') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent(
                            'LegacyFuel:PayFuel',
                ...
                elseif ExiaMenu.Button('~g~~h~ESX ~y~Dirty Job') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_godirtyjob:pay', m)
                    end
                elseif ExiaMenu.Button('~g~~h~ESX ~y~Pizza Boy') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_pizza:pay', m)
                    end
                elseif ExiaMenu.Button('~g~~h~ESX ~y~Ranger Job') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_ranger:pay', m)
                    end
                elseif ExiaMenu.Button('~g~~h~ESX ~y~Garbage Job') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_garbagejob:pay', m)
                    end
                elseif ExiaMenu.Button('~g~~h~ESX ~y~Car Thief ~r~DIRTY MONEY') then
                    local m = KeyboardInput('Enter amount of dirty money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_carthief:pay', m)
                    end
                elseif ExiaMenu.Button('~g~~h~ESX ~y~Trucker Job') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_truckerjob:pay', m)
                    end
                elseif ExiaMenu.Button('~g~~h~ESX ~y~Admin Give Bank') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('AdminMenu:giveBank', m)
                    end
                elseif ExiaMenu.Button('~g~~h~ESX ~y~Admin Give Cash') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('AdminMenu:giveCash', m)
                    end
                elseif ExiaMenu.Button('~g~~h~ESX ~y~Postal Job') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_gopostaljob:pay', m)
                    end
                elseif ExiaMenu.Button('~g~~h~ESX ~y~Banker Job') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_banksecurity:pay', m)
                    end
				elseif ExiaMenu.Button('~g~~h~ESX ~y~Airlines Job') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent("esx_airlines:pay", m)
                    end
				elseif ExiaMenu.Button('~g~~h~ESX ~y~Brinks Job') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent("esx_brinksjob:pay", m)
                    end
				elseif ExiaMenu.Button('~g~~h~ESX ~y~Bus Job') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent("esx_bus:pay", m)
                    end
				elseif ExiaMenu.Button('~g~~h~ESX ~y~CoastGuard Job') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent("esx_coastguard:pay", m)
                    end
				elseif ExiaMenu.Button('~g~~h~ESX ~y~Delivery Job') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
				...
				elseif ExiaMenu.Button('~g~~h~ESX ~y~Pizza Job') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent("esx_pizza:pay", m)
                    end
				...
				elseif ExiaMenu.Button('~g~~h~ESX ~y~Security Job') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent("esx_securityjob:pay", m)
                    end
				elseif ExiaMenu.Button('~g~~h~ESX ~y~Traffic Job') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                ...
                elseif ExiaMenu.Button('~g~~h~ESX ~y~Slot Machine') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
				...
				ExiaMenu.Display()
            elseif ExiaMenu.IsMenuOpened('MODEL') then
                if ExiaMenu.Button('~c~~h~Model~s~ Clown') then
                ...
                elseif ExiaMenu.Button('~c~~h~Model~s~ Mime') then
                ...
                elseif ExiaMenu.Button('~c~~h~Model~s~ Stripper') then
			local model = "s_f_y_stripper_01"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~b~ Cop M') then
			local model = "s_m_y_cop_01"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~b~ Cop F') then
			local model = "MP_F_Cop_01"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~b~ Sheriff M') then
			local model = "S_M_Y_Sheriff_01"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~b~ Sheriff F') then
			local model = "S_F_Y_Sheriff_01"
                ...
                elseif ExiaMenu.Button('~c~~h~Model ~b~SWAT M') then
			local model = "S_M_Y_Swat_01"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~b~ Armoured Ranger M') then
			local model = "S_M_M_Armoured_01"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~b~ Ranger F') then
			local model = "S_F_Y_Ranger_01"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~b~ Ranger Male') then
			local model = "S_M_Y_Ranger_01"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~b~ Robot Ranger Male') then
			local model = "U_M_Y_RSRanger_01"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~b~ Desert Army 01') then
			local model = "G_M_Y_DesArmy_01"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~b~ Desert Army 02') then
			local model = "G_M_Y_DesArmy_02"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~b~ Desert Army 03') then
			local model = "G_M_Y_DesArmy_03"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~b~ Desert Army 04') then
			local model = "G_M_Y_DesArmy_04"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~b~ Desert Army 05') then
			local model = "G_M_Y_DesArmy_05"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~b~ Marine 01') then
			local model = "S_M_Y_Marine_01"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~b~ Marine 02') then
			local model = "S_M_Y_Marine_02"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~b~ Marine 03') then
			local model = "S_M_Y_Marine_03"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~b~ Marine Commander') then
			local model = "S_M_M_Marine_01"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~b~ Marine General') then
			local model = "S_M_M_Marine_02"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~b~ Black OPS1 M') then
			local model = "S_M_Y_BlackOps_01"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~b~ Black OPS2 M') then
			local model = "S_M_Y_BlackOps_02"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~b~ Black OPS3 M') then
			local model = "S_M_Y_BlackOps_03"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~b~ Prison Guard M') then
			local model = "S_M_M_PrisGuard_01"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~b~ Paramedic M') then
			local model = "S_M_M_Paramedic_01"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~y~ Vagos F') then
			local model = "G_F_Y_Vagos_01"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~g~ Ramp Gang M') then
			local model = "IG_Ramp_Gang"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~g~ Ramp Gang Boss M') then
			local model = "CSB_Ramp_gang"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~g~ Fam Gang 01 M') then
			local model = "MP_M_FamDD_01"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~g~ Fam Gang 02 M') then
			local model = "G_M_Y_FamDNF_01"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~g~ Fam Gang Boss M') then
			local model = "G_M_Y_FamCA_01"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~p~ Bella Gang 01 M') then
			local model = "G_M_Y_BallaEast_01"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~p~ Bella Gang 02 M') then
			local model = "G_M_Y_BallaSout_01"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~p~ Bella Gang 03 M') then
			local model = "IG_BallasOG"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~p~ Bella Gang 04 M') then
			local model = "IG_BallasOG"
				RequestModel(GetHashKey(model)) 
				Wait(500)
				if HasModelLoaded(GetHashKey(model)) then
                ...
                elseif ExiaMenu.Button('~c~~h~Model~p~ Bella Gang F') then
			local model = "G_F_Y_Ballas_01"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~p~ Bella Gang Boss M') then
			local model = "G_M_Y_BallaOrig_01"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~s~ Jewel F') then
			local model = "U_F_Y_JewelAss_01"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~s~ Jewel Thief') then
			local model = "U_M_M_JewelThief"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~o~ Prisoner 01 M') then
			local model = "S_M_Y_PrisMuscl_01"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~o~ Prisoner 02 M') then
			local model = "S_M_Y_Prisoner_01"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~o~ Prisoner 03 M') then
			local model = "U_M_Y_Prisoner_01"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~s~ Body Builder 01 M') then
			local model = "A_M_Y_MusclBeac_01"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~s~ Body Builder 02 M') then
			local model = "A_M_Y_MusclBeac_02"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~s~ Body Builder 03 M') then
			local model = "A_M_Y_Surfer_01"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~s~ Body Builder 04 M') then
			local model = "IG_TylerDix"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~s~ Body Builder 05 M') then
			local model = "u_m_y_babyd"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~s~ Body Builder F') then
			local model = "CS_MaryAnn"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~s~ Beach 01 F') then
			local model = "A_F_M_Beach_01"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~s~ Beach 02 F') then
			local model = "A_F_Y_Beach_01"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~s~ Beach Fat F') then
			local model = "A_F_M_FatCult_01"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~s~ Rich Female 01') then
			local model = "A_F_Y_BevHills_01"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~s~ Rich Female 02') then
			local model = "A_F_Y_BevHills_02"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~s~ Rich Female 03') then
			local model = "A_F_Y_BevHills_03"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~s~ Rich Female 04') then
			local model = "A_F_Y_BevHills_04"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~s~ Rich Female 05') then
			local model = "CSB_Bride"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~s~ Rich Female 06') then
			local model = "U_F_Y_PoppyMich"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~s~ Rich Female 07') then
			local model = "A_F_Y_SouCent_01"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~s~ Rich Female 08') then
			local model = "CSB_Anita"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~s~ Skater Female') then
			local model = "A_F_Y_Skater_01"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~s~ Rich Old Man') then
			local model = "U_M_O_TapHillBilly"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~s~ Rich Guy 01') then
			local model = "S_M_Y_Barman_01"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~s~ Rich Guy 02') then
			local model = "A_M_Y_BreakDance_01"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~s~ Rich Guy 03') then
			local model = "U_M_Y_Chip"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~s~ Rich Guy 04') then
			local model = "U_M_Y_GunVend_01"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~s~ Rich Guy 05') then
			local model = "CSB_Groom"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~s~ Rich Guy 06') then
			local model = "A_M_Y_Business_02"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~s~ Chinese M 01') then
			local model = "G_M_M_ChiBoss_01"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~s~ Chinese M 02') then
			local model = "G_M_M_ChiGoon_01"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~s~ Chinese M 03') then
			local model = "G_M_M_ChiGoon_02"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~s~ Chinese M 04') then
			local model = "CSB_Hao"
				RequestModel(GetHashKey(model)) 
				Wait(500)
				if HasModelLoaded(GetHashKey(model)) then
                ...
                elseif ExiaMenu.Button('~c~~h~Model~s~ Chinese F') then
			local model = "A_F_Y_Vinewood_03"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~s~ Korean M 01') then
			local model = "A_M_Y_KTown_01"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~s~ Korean M 02') then
			local model = "A_M_Y_KTown_02"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~s~ Korean M 03') then
			local model = "G_M_M_KorBoss_01"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~s~ Korean M 04') then
			local model = "G_M_Y_Korean_01"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~s~ Korean M 05') then
			local model = "G_M_Y_Korean_02"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~s~ Korean F 01') then
			local model = "S_F_Y_MovPrem_01"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~s~ Korean F 02') then
			local model = "A_F_M_KTown_01"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~s~ Korean F 03') then
			local model = "A_F_M_KTown_02"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~s~ Korean F 04') then
			local model = "A_F_O_KTown_01"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~s~ Mexican M 01') then
			local model = "A_M_M_MexCntry_01"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~s~ Mexican M 02') then
			local model = "A_M_M_MexLabor_01"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~s~ Mexican M 03') then
			local model = "A_M_Y_MexThug_01"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~s~ Mexican M 04') then
			local model = "G_M_M_MexBoss_01"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~s~ Mexican M 05') then
			local model = "G_M_M_MexBoss_02"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~s~ Mexican M 06') then
			local model = "U_M_Y_Mani"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~s~ Mexican M 07') then
			local model = "S_M_M_Mariachi_01"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~s~ Mexican F') then
			local model = "U_F_Y_SpyActress"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~s~ Mexican HMaid F') then
			local model = "S_F_M_Maid_01"
                ...
                elseif ExiaMenu.Button('~c~~h~Model Animal~s~ Boar') then
			local model = "A_C_Boar"
                ...
                elseif ExiaMenu.Button('~c~~h~Model Animal~s~ Pig') then
			local model = "A_C_Pig"
				RequestModel(GetHashKey(model)) 
				Wait(500)
				if HasModelLoaded(GetHashKey(model)) then
                ...
                elseif ExiaMenu.Button('~c~~h~Model Animal~s~ Deer') then
			local model = "A_C_Deer"
                ...
                elseif ExiaMenu.Button('~c~~h~Model Animal~s~ Chicken') then
			local model = "A_C_Hen"
				RequestModel(GetHashKey(model)) 
				Wait(500)
				if HasModelLoaded(GetHashKey(model)) then
                ...
                elseif ExiaMenu.Button('~c~~h~Model Animal~s~ Hawk') then
			local model = "A_C_Chickenhawk"
                ...
                elseif ExiaMenu.Button('~c~~h~Model Animal~s~ Crow') then
			local model = "A_C_Crow"
                ...
                elseif ExiaMenu.Button('~c~~h~Model Animal~s~ Monkey') then
			local model = "A_C_Chimp"
                ...
                elseif ExiaMenu.Button('~c~~h~Model Animal~s~ Dog Chop') then
			local model = "A_C_Chop"
                ...
                elseif ExiaMenu.Button('~c~~h~Model Animal~s~ Dog Husky') then
			local model = "A_C_Husky"
                ...
                elseif ExiaMenu.Button('~c~~h~Model Animal~s~ Dog Rottweiler') then
			local model = "A_C_Rottweiler"
                ...
                elseif ExiaMenu.Button('~c~~h~Model Animal~s~ Dog Shepherd') then
			local model = "A_C_shepherd"
                ...
                elseif ExiaMenu.Button('~c~~h~Model Animal~s~ Lion') then
			local model = "A_C_MtLion"
                ...
                elseif ExiaMenu.Button('~c~~h~Model Animal~s~ Rat') then
			local model = "A_C_Rat"
				RequestModel(GetHashKey(model)) 
				Wait(500)
				if HasModelLoaded(GetHashKey(model)) then
                ...
                elseif ExiaMenu.Button('~c~~h~Model Animal~s~ Shark') then
			local model = "A_C_SharkTiger"
                ...
                elseif ExiaMenu.Button('~c~~h~Model Animal~s~ Coyote') then
			local model = "A_C_Coyote"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~g~ Alien') then
			local model = "s_m_m_movalien_01"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~s~ Pongo') then
			local model = "u_m_y_pogo_01"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~s~ Bartender F') then
			local model = "S_F_Y_Bartender_01"
                ...
                elseif ExiaMenu.Button('~c~~h~Model~s~ FiveM') then
			local model = "mp_m_freemode_01"
                ...
                elseif ExiaMenu.Button('~c~~h~Randomize~s~ Clothing') then
				     SetPedRandomComponentVariation(PlayerPedId(), true)
                end
					
					ExiaMenu.Display()
                elseif ExiaMenu.IsMenuOpened("SelfMenu") then
                                    if
                    ExiaMenu.CheckBox(
                        '~h~~g~Godmode',
                        Godmode,
                 ...
                 then
                elseif ExiaMenu.Button('~h~~y~Semi ~g~Godmode') then
                ...
                elseif
                 ...
                 then
                elseif ExiaMenu.Button('~h~~r~Suicide') then
                    SetEntityHealth(PlayerPedId(-1), 0)
                elseif ExiaMenu.Button('~h~~g~ESX~s~ Revive Yourself~s~') then
                    TriggerEvent('esx_ambulancejob:revive')
                elseif ExiaMenu.Button('~h~~g~Heal/Revive') then
                    SetEntityHealth(PlayerPedId(-1), 200)
                elseif ExiaMenu.Button('~h~~g~ESX~s~ Revive Yourself~s~') then
                    TriggerEvent('esx_ambulancejob:revive')
                    TriggerEvent('ambulancier:selfRespawn')
                elseif ExiaMenu.Button('~h~~g~ESX~s~ 2ndRevive ~s~') then
                    ...
                    DoScreenFadeIn(800)
                elseif ExiaMenu.Button("~h~~r~ESX ~s~Open Menu Jail") then
					TriggerEvent("esx-qalle-jail:openJailMenu")
                elseif ExiaMenu.Button("~h~~g~ESX ~s~Unjail") then
                    TriggerServerEvent('esx_jailer:unjailTime', -1)
                    TriggerServerEvent('JailUpdate', 0)
                    TriggerEvent('UnJP')
                    TriggerEvent('esx-qalle-jail:unJailPlayer')
                elseif ExiaMenu.Button("~s~~h~Set hunger to ~h~~g~100%") then
                    TriggerEvent("esx_status:set", "hunger", 1000000)
                elseif ExiaMenu.Button("~s~~h~Set thirst to ~h~~g~100%") then
                    TriggerEvent("esx_status:set", "thirst", 1000000)
                elseif ExiaMenu.Button("~h~~g~Heal") then
                    SetEntityHealth(PlayerPedId(-1), 200)
                elseif ExiaMenu.Button("~h~~b~Armour") then
                    SetPedArmour(PlayerPedId(-1), 200)
                elseif ExiaMenu.Button('~g~~h~ESX ~r~Revive') then
                ...
                elseif
                 ...
                 then
                    ...
                    ExiaMenu.Display()
                elseif ExiaMenu.IsMenuOpened("OnlinePlayersMenu") then
                        for i = 0, 128 do
                            if NetworkIsPlayerActive(i) and GetPlayerServerId(i) ~= 0 and ExiaMenu.MenuButton(GetPlayerName(i).." ID = ["..GetPlayerServerId(i).."] i = ["..i.."] "..(IsPedDeadOrDying(GetPlayerPed(i), 1) and "~r~DEAD" or "~g~ALIVE"), "PlayerOptionsMenu") then
                                SelectedPlayer = i
                            end
                        end
    
                        ExiaMenu.Display()
                    elseif ExiaMenu.IsMenuOpened("PlayerOptionsMenu") then
                        ExiaMenu.SetSubTitle("PlayerOptionsMenu", "Player Options ["..GetPlayerName(SelectedPlayer).."]")
                        if ExiaMenu.Button('Spectate', (Spectating and "~g~[SPECTATING]")) then
                            SpectatePlayer(SelectedPlayer)
                        elseif ExiaMenu.Button('Teleport To') then
                            local Entity = IsPedInAnyVehicle(PlayerPedId(), false) and GetVehiclePedIsUsing(PlayerPedId()) or PlayerPedId()
                            SetEntityCoords(Entity, GetEntityCoords(GetPlayerPed(SelectedPlayer)), 0.0, 0.0, 0.0, false)
                        elseif ExiaMenu.Button("Crash Player") then
                            crash(SelectedPlayer)
                        elseif ExiaMenu.Button("Semi God") then
                        ...
                        elseif ExiaMenu.Button("Heal Player") then
                        ...
                        elseif ExiaMenu.MenuButton("∑Troll Options", "PlayerTrollMenu") then
                        elseif ExiaMenu.MenuButton("∑ESX Options", "PlayerESXMenu") then
                        elseif ExiaMenu.MenuButton("∑Give Single Weapon", "SingleWepPlayer") then
                        elseif ExiaMenu.Button("Give Ammo") then
                            for i = 1, #allWeapons do
                                AddAmmoToPed(GetPlayerPed(SelectedPlayer), GetHashKey(allWeapons[i]), 250)
                            end
                        elseif ExiaMenu.Button("Give All Weapons") then
                            for i = 1, #allWeapons do
                                GiveWeaponToPed(GetPlayerPed(SelectedPlayer), GetHashKey(allWeapons[i]), 1000, false, false)
                            end	
                        elseif ExiaMenu.Button("Remove All Weapons") then
                            for i = 1, #allWeapons do
                                RemoveAllPedWeapons(GetPlayerPed(SelectedPlayer), true)
                            end
                        elseif ExiaMenu.Button("Give Vehicle") then
                            local ped = GetPlayerPed(SelectedPlayer)
                            local ModelName = KeyboardInput("Enter Vehicle Spawn Name", "", 100)
                        ...
                        elseif ExiaMenu.Button("Kick From Vehicle") then
                            ClearPedTasksImmediately(GetPlayerPed(SelectedPlayer))
                        elseif ExiaMenu.Button("Delete Vehicle") then
                        ...
                        ExiaMenu.Display()
                    elseif ExiaMenu.IsMenuOpened("PlayerESXMenu") then
                        if ExiaMenu.MenuButton("∑ESX Triggers", "PlayerESXTriggerMenu") then
                        elseif ExiaMenu.MenuButton("∑ESX Jobs", "PlayerESXJobMenu") then
                        end
    
                        ExiaMenu.Display()
                    elseif ExiaMenu.IsMenuOpened("PlayerESXTriggerMenu") then
                        if ExiaMenu.Button("ESX Revive") then
                            TriggerServerEvent("esx_ambulancejob:revive",GetPlayerServerId(selectedPlayer))
                        elseif ExiaMenu.Button("ESX Give Money To Player From Your Wallet") then
                        ...
                        elseif ExiaMenu.Button("ESX Steal Money From Player") then
                        ...
                        elseif ExiaMenu.Button("ESX Send To Jail") then
                        ...
                        elseif ExiaMenu.Button("ESX Get Out Of Jail") then
                        ...
                        ExiaMenu.Display()
                    elseif ExiaMenu.IsMenuOpened("PlayerESXJobMenu") then
                        if ExiaMenu.Button("Unemployed") then
                        ...
                        ExiaMenu.Display()
                    elseif ExiaMenu.IsMenuOpened("PlayerTrollMenu") then
                        if ExiaMenu.Button ("Fake Chat Message") then 
                        ...
                        elseif ExiaMenu.Button("Cage Player") then
                            freezePlayer = true
                            Citizen.Wait(50)
                            SpawnObjOnPlayer(GetHashKey("prop_gascage01"))
                            Citizen.Wait(50)
                            freezePlayer = false
                        elseif ExiaMenu.Button("Rape Player") then
                            rape(SelectedPlayer)
                        elseif ExiaMenu.Button("Mellotrainer Ban") then
                        ...
                        elseif ExiaMenu.Button("Mellotrainer Kick") then
                        ...
                        elseif ExiaMenu.MenuButton("∑Ram Vehicles Into Player", "VehicleRamMenu") then
                        elseif ExiaMenu.MenuButton("∑Spawn Peds", "PlayerSpawnPedsMenu") then
                        elseif ExiaMenu.MenuButton("∑Spawn Props On Player", "SpawnPropsMenu") then
                        elseif ExiaMenu.CheckBox(
                            "Freeze Player",
                            freezePlayer,
                            function(enabled)
                    ...
                    elseif ExiaMenu.IsMenuOpened("SpawnPropsMenu") then
                        ...
                        then
                        elseif ExiaMenu.ComboBox("Bone", { "Head", "Right Hand" }, currentBone, selectedBone, function(currentIndex, selectedIndex)
                            currentBone = currentIndex
                            selectedBone = selectedIndex
                        end)
                        then
                        elseif ExiaMenu.Button("Weed") then
                            local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                        ...
                        elseif ExiaMenu.Button("UFO") then
                            local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                        ...
                        elseif ExiaMenu.Button("Windmill") then
                            local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                        ...
                        elseif ExiaMenu.Button("Custom Prop") then
                            local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                        ...
                        ExiaMenu.Display()
                    elseif ExiaMenu.IsMenuOpened("PlayerSpawnPedsMenu") then
				if ExiaMenu.Button('~r~~r~Spawn ~s~Mountain Lion ~r~Attack') then
				...
				elseif ExiaMenu.Button('~r~~r~Spawn ~s~Dog Rottweiler ~r~Attack') then
				...
				elseif ExiaMenu.Button('~r~~r~Spawn ~s~Dog Husky ~r~Attack') then
				...
				elseif ExiaMenu.Button('~r~~r~Sea Spawn ~s~Shark ~r~Attack') then
                    ...
                    for i = 0, 1 do
                        ...
                        if HasModelLoaded(GetHashKey(mtlion)) then
                            ...
                            elseif ExiaMenu.Button("~h~Spawn ~s~Swat army with AK") then 
                            ...
                            elseif ExiaMenu.Button("~h~Spawn ~s~Swat army with RPG") then 
                                local eU = "s_m_y_swat_01"
                                local eS = "weapon_rpg"
                                for i = 0, 10 do 
                                    local cM = GetEntityCoords(GetPlayerPed(SelectedPlayer)) 
                            ...
                            elseif ExiaMenu.Button("~h~Spawn ~s~Swat army with Flaregun") then 
                                local eU = "s_m_y_swat_01"
                            ...
                            elseif ExiaMenu.Button("~h~Spawn ~s~Swat army with Railgun") then 
                                local eU = "s_m_y_swat_01"
				...
				elseif ExiaMenu.Button('~h~Spawn Swat in car ~r~Attack') then
				...
				elseif ExiaMenu.Button('~h~Spawn Marines in car ~r~Attack') then
				...
				elseif ExiaMenu.Button('~h~Spawn Italian Mafia in car ~r~Attack') then
				...
				elseif ExiaMenu.Button('~h~Spawn The Lost MC Club ~r~Attack') then
				...
				elseif ExiaMenu.Button('~h~Spawn Terrorists In Cars ~r~Attack') then
                    ...
                    if HasModelLoaded(veh) then
                        ...
                        ExiaMenu.Display()
                elseif ExiaMenu.IsMenuOpened("VehicleRamMenu") then
                    if ExiaMenu.Button("Futo") then
                    ...
                    elseif ExiaMenu.Button("Bus") then
                        ...
                        ExiaMenu.Display()
                elseif ExiaMenu.IsMenuOpened("SingleWepPlayer") then
                    for i = 1, #allWeapons do
                        if ExiaMenu.Button(allWeapons[i]) then
                    ...
                    ExiaMenu.Display()
                elseif ExiaMenu.IsMenuOpened("WeaponMenu") then
                    if ExiaMenu.MenuButton("∑Weapon List", "WeaponTypes") then
                    elseif ExiaMenu.ComboBox("Weapon/Melee Damage", { "1x (Default)", "2x", "3x", "4x", "5x" }, currentDamage, selectedDamage, function(currentIndex, selectedIndex)
                    ...
                    elseif ExiaMenu.Button("Drop Current Weapon") then
                        local ped = GetPlayerPed(-1) 
                    ...
                    then
                    elseif ExiaMenu.MenuButton("∑Weapon Tints", "WeaponCustomization") then
                    elseif ExiaMenu.MenuButton("∑Bullet Gun Options", "BulletGunMenu") then
                    end
                
                    ExiaMenu.Display()
                elseif ExiaMenu.IsMenuOpened("WeaponCustomization") then
                    if ExiaMenu.CheckBox(
                        "Rainbow Tint",
                        rainbowTint,
                        function(enabled)
                    ...
                    then
                    elseif ExiaMenu.ComboBox("Weapon Tints", { "Normal", "Green", "Gold", "Pink", "Army", "LSPD", "Orange", "Platinum" }, currentTint, selectedTint, function(currentIndex, selectedIndex)
                    ...
                    then
                    elseif ExiaMenu.Button("Add Special Finish") then
                    ...
                    elseif ExiaMenu.Button("Remove Special Finish") then
                    ...
                    ExiaMenu.Display()
                elseif ExiaMenu.IsMenuOpened("BulletGunMenu") then
                    if ExiaMenu.CheckBox(
                        "Vehicle Gun",
                        vehicleGun,
                        function(enabled)
                    ...
                    then
                    elseif ExiaMenu.ComboBox("Vehicle To Shoot", vehicles, currentVehicle, selectedVehicle, function(currentIndex, selectedIndex)
                        currentVehicle = currentIndex
                        selectedVehicle = selectedIndex
    
                    end) 
                    then
                    elseif ExiaMenu.ComboBox("Vehicle Speed", vehicleSpeed, currentVehicleSpeed, selectedVehicleSpeed, function(currentIndex, selectedIndex)
                    ...
                    then
                    elseif ExiaMenu.ComboBox("Ped To Shoot", peds, currentPed, selectedPed, function(currentIndex, selectedIndex)
                    ...
                    then
                    elseif ExiaMenu.ComboBox("Bullet", bullets, currentBullet, selectedBullet, function(currentIndex, selectedIndex)
