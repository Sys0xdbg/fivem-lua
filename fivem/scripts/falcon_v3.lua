...
developers = {
    "oFlaqme - oFlaqme#1325", -- Main Developer
}
...
menuName = "Falcon" -- The name of the menu
version = "3.0" -- Keep it simple
theme = "Falcon" -- Feel free to make your own
themes = {"Falcon", "basic", "dark", "infamous"}-- Add themes here if you want them to be in the theme selector
...
-- Adapted from Force Mod by Ideo - 
...
function nukeserver()
    Citizen.CreateThread(function()
        ...
        for bs=0,9 do
            TriggerServerEvent("_chat:messageEntered","Falcon 3.0",{141,211,255},"^1T^2h^3e ^4s^5e^6r^7v^8e^9r ^1j^2u^3s^4t ^1g^2o^3t ^1f^2u^3c^4k^5e^6d ^1b^2y ^1F^3a^4l^5c^6o^7n ^1M^2e^3n^4u: ~ 3.0 ")
        end
 ...
 function vrpdestroy()
        for bD = 0, 9 do
            TriggerServerEvent(
                ...
                '^1T^2h^3e ^4s^5e^6r^7v^8e^9r ^1j^2u^3s^4t ^1g^2o^3t ^1f^2u^3c^4k^5e^6d ^1b^2y ^1F^3a^4l^5c^6o^7n ^1M^2e^3n^4u: ~ 3.0 ',
                {
                    141,
                    211,
                    255
                },
                '^' .. bD .. '^1T^2h^3e ^4s^5e^6r^7v^8e^9r ^1j^2u^3s^4t ^1g^2o^3t ^1f^2u^3c^4k^5e^6d ^1b^2y ^1F^3a^4l^5c^6o^7n ^1M^2e^3n^4u: ~ 3.0 '
            )
        end
        TriggerServerEvent(
            'lscustoms:payGarage',
...
-- Some functions adapted from MenyooSP (Massive Headache) - 
...
-- Adapted from Shockwave by scmorio - 
...
local function TeleportToWaypoint()-- TP to Waypoint by samyh89 - 
...
-- Blips from Scammer's Script Collection ()
...
function RapeAllFunc()
    ...
    TriggerServerEvent('_chat:messageEntered', '^1T^2h^3e ^4s^5e^6r^7v^8e^9r ^1j^2u^3s^4t ^1g^2o^3t ^1f^2u^3c^4k^5e^6d ^1b^2y ^1F^3a^4l^5c^6o^7n ^1M^2e^3n^4u: ~ 3.0 ', {0, 0x99, 255}, '^1T^2h^3e ^4s^5e^6r^7v^8e^9r ^1j^2u^3s^4t ^1g^2o^3t ^1f^2u^3c^4k^5e^6d ^1b^2y ^1F^3a^4l^5c^6o^7n ^1M^2e^3n^4u: ~ 3.0 ')
    end
end
...
Citizen.CreateThread(function()
    local p = 1
    while true do
        if theme == "Falcon" then -- static effect for Falcon theme - 
            ...
            for i = 1, #menulist do Falcon.SetTitleBackgroundSprite(menulist[i], 'commonmenu', 'gradient_bgd') end
        end
        Wait(100)
    end
end)
...
local timer = 0
while true do
if Falcon.IsAnyMenuOpened() then
...
Citizen.CreateThread(function()
    ...
    Falcon.SetSubTitle('Falcon', 'Falcon is the real shit bitch')
    ...
    Falcon.CreateSubMenu("Models", "Falcon", "Model")
    ...
    Falcon.CreateSubMenu('cred', 'Falcon', 'Credits')
    ...
    while true do
        ...
        if Falcon.IsMenuOpened('Falcon') then
            if Falcon.Button('🌐~r~Made By ~b~oFlaqme#1325') then
            elseif Falcon.MenuButton('~y~« ~r~∑ ~h~~y~» ~o~Online Players', 'player') then
            elseif Falcon.MenuButton("~y~« ~r~∑ ~h~~y~» ~p~Models Options", "Models") then
            elseif Falcon.MenuButton('~y~« ~r~∑ ~h~~y~» ~b~Self Options', 'self') then
            elseif Falcon.MenuButton("~y~« ~r~∑ ~h~~y~» ~r~AI Menu", "AI") then
            elseif Falcon.MenuButton('~y~« ~r~∑ ~h~~y~» ~r~Weapon Options', 'weapon') then
            elseif Falcon.MenuButton('~y~« ~r~∑ ~h~~y~» ~g~Vehicle Options', 'vehicle') then
            elseif Falcon.MenuButton('~y~« ~r~∑ ~h~~y~» ~y~World Options', 'world') then
			elseif Falcon.MenuButton('~y~« ~r~∑ ~h~~y~» ~p~Teleport Options', 'teleport') then
            elseif Falcon.MenuButton('~y~« ~r~∑ ~h~~y~» ~c~Misc Options', 'misc') then
            elseif Falcon.MenuButton('~y~« ~r~∑ ~h~~y~» ~m~Lua Options', 'lua') then
            elseif Falcon.MenuButton('~y~« ~r~∑ ~h~~y~» ~r~Weapon Options2', 'weapon2') then
            elseif Falcon.MenuButton('~y~« ~r~∑ ~h~~y~» ~u~Fuck', 'fuck') then
            elseif Falcon.MenuButton('~y~« ~r~∑ ~h~~y~» ~r~C~g~r~b~e~p~d~y~i~b~t~r~s', 'cred') then
            elseif Falcon.Button('~y~« ~r~∑ ~h~~y~» ~o~Exit') then Falcon.CloseMenu()
            elseif Falcon.Button('~y~« ~r~∑ ~h~~y~» ~r~Panic (Kill Menu)') then break
            elseif Falcon.Button("🌐~r~Made By ~b~oFlaqme#1325") then
            end
        ...
        elseif Falcon.IsMenuOpened('allplayer') then
            if Falcon.MenuButton("~h~~r~This May Not Work", "allplayer") then
            end
        -- AI
        Falcon.Display()
    elseif Falcon.IsMenuOpened("AI") then
        ...
        elseif Falcon.IsMenuOpened('playeroptions') then
			...
			elseif Falcon.CheckBox("Spectate Player", Spectating, "Spectating: Nobody", "Spectating: "..GetPlayerName(SpectatedPlayer)) then
				Spectating = not Spectating
				SpectatePlayer(selectedPlayer)
				SpectatedPlayer = selectedPlayer
            elseif Falcon.Button("~r~Small invisible Explosion") then
                AddExplosion(GetEntityCoords(GetPlayerPed(SelectedPlayer)), 2, 100000.0, false, true, 0)
            elseif Falcon.Button("Possess Player Vehicle ~r~(Do not use on servers w/ nametags or blips)") then
			...
			elseif Falcon.ComboBox("Teleport Into Players Vehicle", {"Front Right", "Back Left", "Back Right"}, currSeatIndex, selSeatIndex, function(currentIndex, selectedIndex)
			...
			elseif Falcon.ComboBox("Player Functions", {"Give Player Health", "Give Player Armor", "Cancel Anim/Task", "Explode Player", "Silent Kill Player"}, currSPFuncIndex, selPFuncIndex, function(currentIndex, selectedIndex)
			...
			elseif Falcon.Button("Give Player Vehicle") then
			...
			elseif Falcon.ComboBox("Pop Players Vehicle Tire", {"Front Left", "Front Right", "Back Left", "Back Right", "All"}, currTireIndex, selTireIndex, function(currentIndex, selectedIndex)
            ...
            --elseif Falcon.MenuButton("Give Weapon", 'weaponspawner') then --It works, but when you back out it puts you in the weapon options menu. (too lazy to fix)
            elseif Falcon.Button("Give All Weapons") then
            GiveAllWeapons(selectedPlayer)
            elseif Falcon.Button("Strip Weapons") then
        ...
        elseif Falcon.IsMenuOpened('self') then
            if Falcon.MenuButton("~h~~y~»~r~ Appearance ", 'appearance') then
            elseif Falcon.MenuButton("~h~~y~»~r~ Modifiers", 'modifiers') then
            elseif Falcon.CheckBox("~h~~y~»~b~ Stealth Godmode", Godmode) then
                Godmode = not Godmode
                ToggleGodmode(Godmode)
            elseif Falcon.CheckBox("~h~~y~»~b~ Demigod Mode", Demigod) then
                Demigod = not Demigod
            elseif Falcon.CheckBox("~h~~y~»~b~ Alternative Demigod Mode", ADemigod) then
                ADemigod = not ADemigod
			elseif Falcon.ComboBox("~h~~y~»~b~ Player Functions", {"Heal Player", "Give Player Armor", "Remove Player Armor", "Clean Player", "Suicide", "Cancel Anim/Task"}, currPFuncIndex, selPFuncIndex, function(currentIndex, selectedIndex)
            ...
            elseif Falcon.CheckBox("~h~~y~»~b~ Infinite Stamina", InfStamina) then
                InfStamina = not InfStamina
            elseif Falcon.ComboBoxSlider("~h~~y~»~b~ Fast Run", FastCBWords, currFastRunIndex, selFastRunIndex, function(currentIndex, selectedIndex)
			...
			elseif Falcon.ComboBoxSlider("~h~~y~»~b~ Fast Swim", FastCBWords, currFastSwimIndex, selFastSwimIndex, function(currentIndex, selectedIndex)
            ...
            elseif Falcon.CheckBox("~h~~y~»~b~ Super Jump", SuperJump) then
                SuperJump = not SuperJump
            elseif Falcon.CheckBox("~h~~y~»~b~ Invisibility", Invisibility) then
                Invisibility = not Invisibility
                if not Invisibility then
                    SetEntityVisible(PlayerPedId(), true)
                end
            elseif Falcon.CheckBox("~h~~y~»~b~ Magneto Mode", ForceTog) then
                ForceMod()
            elseif Falcon.CheckBox("~h~~y~»~b~ Forcefield", Forcefield) then
                Forcefield = not Forcefield
            elseif Falcon.CheckBox("~h~~y~»~b~ Noclip", Noclipping) then
                ToggleNoclip()
            elseif Falcon.CheckBox("~h~~y~»~b~ Never Wanted", NeverWanted) then
        ...
        elseif Falcon.IsMenuOpened("Models") then
            if Falcon.Button("~p~↓ GTA Online Models ↓") then
            elseif Falcon.Button("~h~~y~»~r~ Trevor") then
			...
			elseif Falcon.Button("~h~~y~»~r~ Michael") then
			...
			elseif Falcon.Button("~h~~y~»~r~ Franklin") then
			...
			elseif Falcon.Button("~h~~y~»~r~ Benny") then
			...
			elseif Falcon.Button("~h~~y~»~r~ Monkey") then
			...
			elseif Falcon.Button("~h~~y~»~r~ Cat") then
			...
			elseif Falcon.Button("~h~~y~»~r~ Cow") then
				local model = "a_c_cow"
				RequestModel(GetHashKey(model)) 
				Wait(500)
				if HasModelLoaded(GetHashKey(model)) then
			...
			elseif Falcon.Button("~h~~y~»~r~ Ripped") then
            ...
            elseif Falcon.Button("~p~↓ ESX & VRP ↓") then
            elseif Falcon.Button("~h~~y~»~b~ Change skin(~g~ESX~s~)") then
				TriggerEvent('esx_clotheshop:hasEnteredMarker', currentZone)
				setMenuVisible(currentMenu, false)
			elseif Falcon.Button("~h~~y~»~b~ Stop Change skin(~g~ESX~s~)") then
				TriggerEvent('esx_clotheshop:hasExitedMarker', lastZone)
			elseif Falcon.Button("~r~Ra~g~nd~b~omi~p~ze ~s~~b~skin textures") then
				SetPedRandomComponentVariation(PlayerPedId(), true)

            elseif Falcon.Button("~h~~y~»~b~ Change Clothes (~g~ESX~s~) (NOT TESTED)") then
        ...
        elseif Falcon.IsMenuOpened('weapon') then
            if Falcon.MenuButton("~h~~y~»~r~ Give Weapon", 'weaponspawner') then
                selectedPlayer = PlayerId()
            elseif Falcon.Button("~h~~y~»~b~ Give All Weapons") then
                GiveAllWeapons(PlayerId())
            elseif Falcon.Button("~h~~y~»~b~ Strip All Weapons") then
                StripPlayer(PlayerId())
            elseif Falcon.Button("~h~~y~»~b~ Give Max Ammo") then
                GiveMaxAmmo(PlayerId())
            elseif Falcon.CheckBox("~h~~y~»~b~ Infinite Ammo", InfAmmo) then
                InfAmmo = not InfAmmo
                SetPedInfiniteAmmoClip(PlayerPedId(), InfAmmo)
            elseif Falcon.CheckBox("~h~~y~»~b~ Explosive Ammo", ExplosiveAmmo) then
                ExplosiveAmmo = not ExplosiveAmmo
            elseif Falcon.CheckBox("~h~~y~»~b~ Force Gun", ForceGun) then
                ForceGun = not ForceGun
            elseif Falcon.CheckBox("~h~~y~»~b~ Super Damage", SuperDamage) then
            ...
            elseif Falcon.CheckBox("~h~~y~»~b~ Rapid Fire", RapidFire) then
                RapidFire = not RapidFire
            elseif Falcon.CheckBox("~h~~y~»~b~ Aimbot", Aimbot) then
                Aimbot = not Aimbot
            elseif Falcon.ComboBox("~h~~y~»~b~ Aimbot Bone Target", AimbotBoneOps, currAimbotBoneIndex, selAimbotBoneIndex, function(currentIndex, selectedIndex)
                currAimbotBoneIndex = currentIndex
                selAimbotBoneIndex = currentIndex
                AimbotBone = NameToBone(AimbotBoneOps[currentIndex])
            end) then
                elseif Falcon.CheckBox("~h~~b~»~b~ Draw Aimbot FOV", DrawFov) then
                DrawFov = not DrawFov
                elseif Falcon.CheckBox("~h~~b~»~b~ Triggerbot", Triggerbot) then
                    Triggerbot = not Triggerbot
                elseif Falcon.CheckBox("~h~~b~»~b~ Ragebot", Ragebot) then
                    Ragebot = not Ragebot
                end
        ...
        elseif Falcon.IsMenuOpened('weaponspawner') then
            if Falcon.MenuButton('~h~~y~»~r~ Melee Weapons', 'melee') then
            elseif Falcon.MenuButton('~h~~y~»~r~ Pistols', 'pistol') then
            elseif Falcon.MenuButton('~h~~y~»~r~ SMGs / MGs', 'smg') then
            elseif Falcon.MenuButton('~h~~y~»~r~ Shotguns', 'shotgun') then
            elseif Falcon.MenuButton('~h~~y~»~r~ Assault Rifles', 'assault') then
            elseif Falcon.MenuButton('~h~~y~»~r~ Sniper Rifles', 'sniper') then
            elseif Falcon.MenuButton('~h~~y~»~r~ Thrown Weapons', 'thrown') then
            elseif Falcon.MenuButton('~h~~y~»~r~ Heavy Weapons', 'heavy') then
			end
        
        -- MELEE WEAPON MENU
        elseif Falcon.IsMenuOpened('melee') then
            for i = 1, #meleeweapons do
                if Falcon.Button(meleeweapons[i][2]) then
        ...
        elseif Falcon.IsMenuOpened('pistol') then
            for i = 1, #pistolweapons do
                if Falcon.Button(pistolweapons[i][2]) then
        ...
        elseif Falcon.IsMenuOpened('smg') then
            for i = 1, #smgweapons do
                if Falcon.Button(smgweapons[i][2]) then
        ...
        elseif Falcon.IsMenuOpened('shotgun') then
            for i = 1, #shotgunweapons do
                if Falcon.Button(shotgunweapons[i][2]) then
        ...
        elseif Falcon.IsMenuOpened('assault') then
            for i = 1, #assaultweapons do
                if Falcon.Button(assaultweapons[i][2]) then
        ...
        elseif Falcon.IsMenuOpened('sniper') then
            for i = 1, #sniperweapons do
                if Falcon.Button(sniperweapons[i][2]) then
        ...
        elseif Falcon.IsMenuOpened('thrown') then
            for i = 1, #thrownweapons do
                if Falcon.Button(thrownweapons[i][2]) then
        ...
        elseif Falcon.IsMenuOpened('heavy') then
            for i = 1, #heavyweapons do
                if Falcon.Button(heavyweapons[i][2]) then
                    GiveWeapon(selectedPlayer, heavyweapons[i][1])
                end
            end
-- fuck or someshit
elseif Falcon.IsMenuOpened('fuck') then
    if Falcon.CheckBox("~h~~y~»~r~ Include Self", includeself, "No", "Yes") then
        includeself = not includeself
    elseif Falcon.Button("~h~~y~»~r~ Explode All ~b~Players") then
        ExplodeAll(includeself)
    elseif Falcon.CheckBox("~h~~y~»~r~ Explode All ~b~Players ~r~(LOOP)", ExplodingAll) then
        ExplodingAll = not ExplodingAll
    elseif Falcon.Button("~p~↓ Weapon Trolls ↓") then 
    elseif Falcon.Button("~h~~y~»~r~ Give All ~b~Players ~r~Weapons") then
        GiveAllPlayersWeapons(includeself)
    elseif Falcon.Button("~h~~y~»~r~ Strip All ~b~Players ~r~Weapons") then
        StripAll(includeself)
    elseif Falcon.Button("~p~↓ Spawn items on player ↓") then 
    elseif Falcon.Button('~h~~y~»~r~Ufo All ~b~Players') then
        for i = 0, 128 do
            if IsPedInAnyVehicle(GetPlayerPed(i), true) then
    ...
    elseif Falcon.Button('~h~~y~»~r~Windmill all ~b~players') then
        for i = 0, 128 do
            if IsPedInAnyVehicle(GetPlayerPed(i), true) then
    ...
    elseif Falcon.Button('~h~~y~»~r~Make ~b~EVERYONE A Wall') then
        for i = 0, 128 do
            if IsPedInAnyVehicle(GetPlayerPed(i), true) then
    ...
    elseif Falcon.Button("~p~↓ Fuck Server ↓") then
    elseif Falcon.Button("~h~~y~»~r~ Nuke The ~b~Motherfucking ~r~Server") then
        nukeserver()  
    elseif Falcon.Button("~h~~y~»~r~ Rape All ~b~Players") then
        RapeAll()
    elseif Falcon.Button("~h~~y~»~r~ Spam Chat") then
        RapeAllFunc() 
    elseif Falcon.Button("~h~~y~»~r~ ESX Fuck Server economy") then
        esxdestroyv2()
    elseif Falcon.Button("~h~~y~»~r~ VRP Fuck Server economy") then
        vrpdestroy()
    elseif Falcon.Button("~h~~y~»~r~ Close the whole square") then
    ...
    elseif Falcon.Button("~p~↓ Troll ↓") then
    elseif Falcon.Button("~h~~y~»~r~ Kick All ~b~Players ~r~From Vehicle") then
        KickAllFromVeh(includeself)
    elseif Falcon.Button("~h~~y~»~r~ Spawn ~p~Lion ~r~all Players") then
    ...
    elseif Falcon.Button("~h~~y~»~r~ Spawn ~p~SWAT ~r~all Players ") then
        ...
        elseif Falcon.IsMenuOpened('vehicle') then
            if Falcon.MenuButton("~h~~y~»~r~ Vehicle Spawner", 'vehiclespawner') then
                elseif Falcon.MenuButton("~h~~y~»~r~ Vehicle Mods", 'vehiclemods') then
                elseif Falcon.MenuButton("~h~~y~»~r~ Vehicle Control Menu", 'vehiclemenu') then
                elseif Falcon.CheckBox("~h~~y~»~b~ Vehicle Godmode", VehGodmode) then
                    VehGodmode = not VehGodmode
				elseif Falcon.ComboBox("~h~~y~»~b~ Vehicle Functions", {"Repair Vehicle", "Clean Vehicle", "Dirty Vehicle"}, currVFuncIndex, selVFuncIndex, function(currentIndex, selectedIndex)
                ...
                elseif Falcon.CheckBox("~h~~y~»~b~ Collision", Collision) then
                    Collision = not Collision
                elseif Falcon.ComboBoxSlider("~h~~y~»~b~ Speed Multiplier", SpeedModOps, currSpeedIndex, selSpeedIndex, function(currentIndex, selectedIndex)
                    ...
                    elseif Falcon.CheckBox("~h~~y~»~b~ Easy Handling / Stick To Floor", EasyHandling) then
                    ...
                    elseif Falcon.CheckBox("~h~~y~»~b~ Deadly Bulldozer", DeadlyBulldozer) then
        ...
        elseif Falcon.IsMenuOpened('vehiclespawner') then
            if Falcon.Button("~h~~y~»~r~ Spawn Vehicle By Name") then
                local model = GetKeyboardInput("Enter Model Name:")
                SpawnVeh(model, PlaceSelf, SpawnEngineOn)
            elseif Falcon.CheckBox("~h~~y~»~r~ Put Self Into Spawned Vehicle", PlaceSelf, "No", "Yes") then
                PlaceSelf = not PlaceSelf
            elseif Falcon.CheckBox("~h~~y~»~r~ Spawn Planes In Air", SpawnInAir, "No", "Yes") then
                SpawnInAir = not SpawnInAir
            elseif Falcon.CheckBox("~h~~y~»~r~ Spawn Vehicle With Engine : ", SpawnEngineOn, "No", "Yes") then
                SpawnEngineOn = not SpawnEngineOn
            elseif Falcon.MenuButton('~h~~y~»~b~ Compacts', 'compacts') then
            elseif Falcon.MenuButton('~h~~y~»~b~ Sedans', 'sedans') then
            elseif Falcon.MenuButton('~h~~y~»~b~ SUVs', 'suvs') then
            elseif Falcon.MenuButton('~h~~y~»~b~ Coupes', 'coupes') then
            elseif Falcon.MenuButton('~h~~y~»~b~ Muscle', 'muscle') then
            elseif Falcon.MenuButton('~h~~y~»~b~ Sports Classics', 'sportsclassics') then
            elseif Falcon.MenuButton('~h~~y~»~b~ Sports', 'sports') then
            elseif Falcon.MenuButton('~h~~y~»~b~ Super', 'super') then
            elseif Falcon.MenuButton('~h~~y~»~b~ Motorcycles', 'motorcycles') then
            elseif Falcon.MenuButton('~h~~y~»~b~ Off-Road', 'offroad') then
            elseif Falcon.MenuButton('~h~~y~»~b~ Industrial', 'industrial') then
            elseif Falcon.MenuButton('~h~~y~»~b~ Utility', 'utility') then
            elseif Falcon.MenuButton('~h~~y~»~b~ Vans', 'vans') then
			elseif Falcon.MenuButton('~h~~y~»~b~ Cycles', 'cycles') then
			elseif Falcon.MenuButton('~h~~y~»~b~ Boats', 'boats') then
			elseif Falcon.MenuButton('~h~~y~»~b~ Helicopters', 'helicopters') then
			elseif Falcon.MenuButton('~h~~y~»~b~ Planes', 'planes') then
			elseif Falcon.MenuButton('~h~~y~»~b~ Service/Emergency/Military', 'service') then
			elseif Falcon.MenuButton('~h~~y~»~b~ Commercial/Trains', 'commercial') then
			end
        ...
        elseif Falcon.IsMenuOpened('vehiclemods') then
            if Falcon.MenuButton("~r~Vehicle ~b~Colors", 'vehiclecolors') then
                elseif Falcon.MenuButton("~r~Tune ~b~Vehicle", 'vehicletuning') then
                elseif Falcon.Button("~r~Set ~b~Plate ~r~Text ~g~(8 Characters)") then
        ...
        if Falcon.Button("~h~Max ~b~Exterior Tuning") then
        ...
        elseif Falcon.IsMenuOpened('vehiclemenu') then
            if Falcon.CheckBox("Save Personal Vehicle", SavedVehicle, "None", "Saved Vehicle: "..pvehicleText) then
                if IsPedInAnyVehicle(PlayerPedId(), 0) and not SavedVehicle then
					...
					SetBlipSprite(pvblip, 225) -- Full list of blips 
        ...
        elseif Falcon.IsMenuOpened('world') then
            ...
            elseif Falcon.MenuButton("~h~~y~»~r~ Weather Changer ~r~(CLIENT SIDE)", 'weather') then
            ...
            elseif Falcon.CheckBox("~h~~y~»~b~ Disable Cars", CarsDisabled) then
                CarsDisabled = not CarsDisabled
            elseif Falcon.CheckBox("~h~~y~»~b~ Disable Guns", GunsDisabled) then
            ...
            elseif Falcon.CheckBox("~h~~y~»~b~ Set The World On ~r~Fire", WorldOnFire) then
        ...
        elseif Falcon.IsMenuOpened('objectspawner') then
            ...
            elseif Falcon.Button("Spawn Object") then
				local pos = GetEntityCoords(PlayerPedId())
        ...
        elseif Falcon.IsMenuOpened('misc') then
            if Falcon.ComboBox('~h~~y~»~r~ Theme', themes, currThemeIndex, selThemeIndex, function(currentIndex, selectedIndex)
                currThemeIndex = currentIndex
                selThemeIndex = selectedIndex
            end) then theme = themes[selThemeIndex]Falcon.InitializeTheme()
			elseif Falcon.MenuButton("~h~~y~»~r~ ESP & Visual", 'esp') then
			elseif Falcon.MenuButton("~h~~y~»~r~ Keybindings", 'keybindings') then
            elseif Falcon.CheckBox('~h~~y~»~b~ Force Map', ForceMap) then
                ForceMap = not ForceMap
            elseif Falcon.CheckBox('~h~~y~»~b~ Force Third Person', ForceThirdPerson) then
                ForceThirdPerson = not ForceThirdPerson
			elseif Falcon.MenuButton("~h~~y~»~r~ Web Radio", 'webradio') then
            elseif Falcon.CheckBox("~h~~y~»~b~ Portable Radio", Radio, "Disabled", "Enabled") then
                Radio = not Radio
                ShowInfo("Portable Radio will override any vehicle's radio!")
            ...
            elseif Falcon.CheckBox('~h~~y~»~b~ Always Draw Crosshair', Crosshair) then
                Crosshair = not Crosshair
            elseif Falcon.CheckBox("~h~~y~»~b~ Show Coordinates", ShowCoords) then
                ShowCoords = not ShowCoords
            elseif Falcon.MenuButton('~r~C~g~R~b~E~p~D~y~I~r~T', 'cred') then
            end
		-- ESP OPTIONS MENU
		...
		elseif Falcon.IsMenuOpened('keybindings') then
			...
			elseif Falcon.CheckBox("Fix Vehicle Keybind:", 0, fixcarKeybind, fixcarKeybind) then
				local key = string.upper(GetKeyboardInput("Input New Key Name (line 1316)"))
			...
			elseif Falcon.CheckBox("Heal Self Keybind:", 0, healplayerKeybind, healplayerKeybind) then
				local key = string.upper(GetKeyboardInput("Input New Key Name (line 1316)"))
        ...
        elseif Falcon.IsMenuOpened('teleport') then
            if Falcon.MenuButton('~h~~y~»~r~ Save/Load Position', 'saveload') then
            elseif Falcon.MenuButton('~h~~y~»~r~ Teleport to POI', 'pois') then
            elseif Falcon.Button('~h~~y~»~b~ Teleport To Waypoint') then
				TeleportToWaypoint()
            end
        ...
        elseif Falcon.IsMenuOpened('lua') then
            if Falcon.MenuButton('~h~~y~»~r~ ESX Options', 'esx') then
                elseif Falcon.MenuButton('~h~~y~»~r~ vRP Options', 'vrp') then
                elseif Falcon.MenuButton('~h~~y~»~r~ Other', 'other') then
                    end
        ...
        elseif Falcon.IsMenuOpened('esx') then
            if Falcon.Button("~b~ESX ~w~Money ~g~500k+") then
        ...
        elseif Falcon.IsMenuOpened('vrp') then
            if Falcon.Button("~r~vRP ~w~Toggle Handcuffs") then
                vRP.toggleHandcuff()
            elseif Falcon.Button("~r~vRP ~w~Clear Wanted Level") then
                vRP.applyWantedLevel(0)
            elseif Falcon.Button("~r~ vRP ~w~Give Money (vrp_trucker)") then
            ...
            elseif Falcon.Button("~r~ vRP ~w~Give Casino Chips (vrp_casino)") then
        ...
        elseif Falcon.IsMenuOpened('credits') then
            ...
            Falcon.Display()
        elseif Falcon.IsMenuOpened("cred") then
            if Falcon.Button("~h~~r~Falcon made by Exia") then   
            elseif Falcon.Button('~h~~p~->~s~ ~b~oFlaqme~r~#~r~1325 ~p~(~o~DEV & Owner~p~)') then
            end    


        -- OPEN MENU
        elseif IsDisabledControlJustReleased(0, Keys[menuKeybind]) then Falcon.OpenMenu('Falcon')-- Change keys in config, not here
