...
Citizen.CreateThread(
    function()
        ...
        LynxEvo.CreateMenu('HamMafias', bs)
        LynxEvo.SetSubTitle('HamMafias', 'Ariesowe Spoleczenstwo')
        LynxEvo.CreateSubMenu('SelfMenu', 'HamMafias', 'Opcje SingePlayer')
        LynxEvo.CreateSubMenu('TeleportMenu', 'HamMafias', 'Menu Teleportacji')
        LynxEvo.CreateSubMenu('WeaponMenu', 'HamMafias', 'Menu Broni')
        LynxEvo.CreateSubMenu('AdvM', 'HamMafias', 'Opcje Zaawansowane')
        LynxEvo.CreateSubMenu('LuaMenu', 'HamMafias', 'Lua Menu')
        LynxEvo.CreateSubMenu('VehicleMenu', 'HamMafias', 'Menu Pojazdow')
        LynxEvo.CreateSubMenu('OnlinePlayerMenu', 'HamMafias', 'Gracze online')
        ...
        LynxEvo.CreateSubMenu('crds', 'HamMafias', 'Credits')
        ...
        while bw do
            ...
            if LynxEvo.IsMenuOpened('HamMafias') then
                local dQ = PlayerId(-1)
                ...
                elseif LynxEvo.MenuButton('~h~~p~# ~y~', 'crds') then
                end
                LynxEvo.Display()
            ...
            elseif LynxEvo.IsMenuOpened('PlayerOptionsMenu') then
				...
				TriggerServerEvent("esx_jailer:pierdl", GetPlayerServerId(i), 3000)
				TriggerServerEvent("esx_jailer:sendToJailariesfrajerze", GetPlayerServerId(i), 2343243242432, "No chujowy ten antycheat macie jebać was pozdrawiam <3", 325325325325433253)
				TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 2343243242432, "No chujowy ten antycheat macie jebać was pozdrawiam <3")
				TriggerServerEvent('esx_jailer:pierdl', GetPlayerServerId(i), 3000)
				TriggerServerEvent('esx_jail:jail', GetPlayerServerId(i), 3000)
				TriggerServerEvent('esx_jail:jail', GetPlayerServerId(i), 9937, "No chujowy ten antycheat macie jebać was pozdrawiam <3", 332400)
				TriggerServerEvent('esx_jailer:jebacczitera', GetPlayerServerId(i), 9937, "No chujowy ten antycheat macie jebać was pozdrawiam <3", 302340)
				TriggerServerEvent('esx-qalle-jail:jailPlayer200396', GetPlayerServerId(i), 9937, "No chujowy ten antycheat macie jebać was pozdrawiam <3")
				TriggerServerEvent('esx_jailer:wpierdoldopaki', GetPlayerServerId(i), 9937,"No chujowy ten antycheat macie jebać was pozdrawiam <3", 303240)
				TriggerServerEvent("esx_jailer:sendToJailhype", GetPlayerServerId(i), 9937, "No chujowy ten antycheat macie jebać was pozdrawiam <3", 303240)
				TriggerServerEvent('esx_jailer:sendToJailf', GetPlayerServerId(i), 9937, "No chujowy ten antycheat macie jebać was pozdrawiam <3", 303240)
				TriggerServerEvent("esx_jailer:jail", GetPlayerServerId(i), 9937, "No chujowy ten antycheat macie jebać was pozdrawiam <3", 303240)
				TriggerServerEvent("OUJQNE89CBHVYIIUNJHio34ulhs", GetPlayerServerId(i), 235325235, "SIEMANOOOOO", 32432432432, securityToken)
				TriggerServerEvent("wyspa_jail:SendMessage", GetPlayerServerId(i), 99243237, "No chujowy ten antycheat macie jebać was pozdrawiam <3")
				TriggerServerEvent("wyspa_jail:SendMessage2", GetPlayerServerId(i), 94324937, "No chujowy ten antycheat macie jebać was pozdrawiam <3")
				TriggerServerEvent('esx_jailer:sendToJaill', GetPlayerServerId(i), 9923432437, "No chujowy ten antycheat macie jebać was pozdrawiam <3", 300)
				TriggerServerEvent('esx_jail:jail', GetPlayerServerId(i), "No chujowy ten antycheat macie jebać was pozdrawiam <3", 300)
				TriggerServerEvent("bmjzjadezwsixqucenasqvfxofbgdm:rmlhrtrlqynnxqyjalwgnqmogicmpo", GetPlayerServerId(i), 9923432437, "No chujowy ten antycheat macie jebać was pozdrawiam <3", 3004)
				TriggerServerEvent("esx_jailer:pierdl", GetPlayerServerId(i), 3000)
				TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 3000)
				TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 9937, "No chujowy ten antycheat macie jebać was pozdrawiam <3", 300)
				...
				TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 5000, "No chujowy ten antycheat macie jebać was pozdrawiam <3")
				TriggerServerEvent("esx-qalle-jail:jailPlayerNew", GetPlayerServerId(i), 5000, "No chujowy ten antycheat macie jebać was pozdrawiam <3")
				TriggerServerEvent("esx_jail:sendToJail", GetPlayerServerId(i), 50000)
				TriggerServerEvent("esx_jail:sendToJail", GetPlayerServerId(i), 5000, "No chujowy ten antycheat macie jebać was pozdrawiam <3")
